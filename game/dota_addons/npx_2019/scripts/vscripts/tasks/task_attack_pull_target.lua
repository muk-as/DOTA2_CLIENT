...
if CDotaNPXTask_AttackPullTarget == nil then
	CDotaNPXTask_AttackPullTarget = class( {}, {}, CDotaNPXTask )
end

----------------------------------------------------------------------------

function CDotaNPXTask_AttackPullTarget:constructor( hTaskInfo, hScenario )
...
function CDotaNPXTask_AttackPullTarget:RegisterTaskEvent()
...
function CDotaNPXTask_AttackPullTarget:CheckTaskStart()
	local bResult = true
...
function CDotaNPXTask_AttackPullTarget:StartTask()
...
function CDotaNPXTask_AttackPullTarget:IsActive()
	return self.bIsActive
end

----------------------------------------------------------------------------

function CDotaNPXTask_AttackPullTarget:OnThink()
...
function CDotaNPXTask_AttackPullTarget:UnregisterTaskEvent()
...
return CDotaNPXTask_AttackPullTarget