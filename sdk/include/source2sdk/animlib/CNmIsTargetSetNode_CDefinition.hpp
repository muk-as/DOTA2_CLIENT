...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmIsTargetSetNode_CDefinition : public source2sdk::animlib::CNmBoolValueNode_CDefinition
        {
        public:
        ...
        static_assert(sizeof(source2sdk::animlib::CNmIsTargetSetNode_CDefinition) == 0x18);
    };
};
