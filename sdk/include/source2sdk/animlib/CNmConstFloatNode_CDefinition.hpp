...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmConstFloatNode_CDefinition : public source2sdk::animlib::CNmFloatValueNode_CDefinition
        {
        public:
        ...
        static_assert(sizeof(source2sdk::animlib::CNmConstFloatNode_CDefinition) == 0x18);
    };
};
