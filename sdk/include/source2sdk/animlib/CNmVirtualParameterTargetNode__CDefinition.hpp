...
namespace source2sdk::animlib
{
    ...
    #pragma pack(push, 1)
    class CNmVirtualParameterTargetNode__CDefinition : public animlib::CNmTargetValueNode__CDefinition
    {
    public:
    ...
    static_assert(sizeof(CNmVirtualParameterTargetNode__CDefinition) == 0x18);
};
