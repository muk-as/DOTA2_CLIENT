...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmCachedBoolNode_CDefinition : public source2sdk::animlib::CNmBoolValueNode_CDefinition
        {
        public:
            std::int16_t m_nInputValueNodeIdx; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::animlib::NmCachedValueMode_t m_mode; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNmCachedBoolNode::CDefinition because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::animlib::CNmCachedBoolNode_CDefinition) == 0x_);
    };
};
