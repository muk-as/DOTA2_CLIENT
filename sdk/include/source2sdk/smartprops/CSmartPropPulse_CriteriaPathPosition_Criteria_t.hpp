...
namespace source2sdk
{
    namespace smartprops
    {
        ...
        public:
            ...
            source2sdk::smartprops::SmartPropPathPositions_t m_PlaceAtPositions; // 0x0            
            ...
            std::int32_t m_nPlaceEveryNthPosition; // 0x4            
            // metadata: MPropertySuppressExpr "( m_PlaceAtPositions == ALL ) || ( m_PlaceAtPositions == START_AND_END ) || ( m_PlaceAtPositions == CONTROL_POINTS )"
            ...
            std::int32_t m_nNthPositionIndexOffset; // 0x8            
            // metadata: MPropertyDescription "Should this element be placed at the first positions on the path"
            bool m_bAllowAtStart; // 0xc            
            // metadata: MPropertyDescription "Should this element be placed at the last positions on the path"
            bool m_bAllowAtEnd; // 0xd            
            uint8_t _pad000e[0x2];
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::smartprops::CSmartPropPulse_CriteriaPathPosition_Criteria_t, m_PlaceAtPositions) == 0x0);
        static_assert(offsetof(source2sdk::smartprops::CSmartPropPulse_CriteriaPathPosition_Criteria_t, m_nPlaceEveryNthPosition) == 0x4);
        static_assert(offsetof(source2sdk::smartprops::CSmartPropPulse_CriteriaPathPosition_Criteria_t, m_nNthPositionIndexOffset) == 0x8);
        static_assert(offsetof(source2sdk::smartprops::CSmartPropPulse_CriteriaPathPosition_Criteria_t, m_bAllowAtStart) == 0xc);
        static_assert(offsetof(source2sdk::smartprops::CSmartPropPulse_CriteriaPathPosition_Criteria_t, m_bAllowAtEnd) == 0xd);
        
        static_assert(sizeof(source2sdk::smartprops::CSmartPropPulse_CriteriaPathPosition_Criteria_t) == 0x10);
    };
};
