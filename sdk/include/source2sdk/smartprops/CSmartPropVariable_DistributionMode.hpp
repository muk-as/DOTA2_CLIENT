...
namespace source2sdk
{
    namespace smartprops
    {
        ...
        {
        public:
            source2sdk::smartprops::SmartPropDistributionMode_t m_DefaultValue; // 0x28            
        ...
        static_assert(sizeof(source2sdk::smartprops::CSmartPropVariable_DistributionMode) == 0x30);
    };
};
