...
namespace source2sdk
{
    namespace smartprops
    {
        ...
        #pragma pack(push, 1)
        class CSmartPropOperation_SaveSurfaceNormal : public source2sdk::smartprops::CSmartPropOperation
        {
        public:
        ...
        static_assert(sizeof(source2sdk::smartprops::CSmartPropOperation_SaveSurfaceNormal) == 0x_);
    };
};
