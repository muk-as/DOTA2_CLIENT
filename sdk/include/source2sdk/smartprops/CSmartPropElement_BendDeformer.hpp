...
namespace source2sdk
{
    namespace smartprops
    {
        ...
        public:
            ...
            CSmartPropAttributeVector m_vOrigin; // 0x_            
            ...
            CSmartPropAttributeVector m_vSize; // 0x_            
            ...
            CSmartPropAttributeFloat m_flBendAngle; // 0x_            
            ...
            CSmartPropAttributeFloat m_flBendPoint; // 0x_            
            ...
            CSmartPropAttributeFloat m_flBendRadius; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CSmartPropElement_BendDeformer because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::smartprops::CSmartPropElement_BendDeformer) == 0x_);
    };
};
