...
namespace source2sdk
{
    namespace smartprops
    {
        ...
        public:
            ...
            CSmartPropAttributeFloat m_flMinLength; // 0x_            
            ...
            CSmartPropAttributeFloat m_flMaxLength; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CSmartPropSelectionCriteria_LinearLength because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::smartprops::CSmartPropSelectionCriteria_LinearLength) == 0x_);
    };
};
