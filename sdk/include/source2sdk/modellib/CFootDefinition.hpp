...
namespace source2sdk
{
    namespace modellib
    {
        ...
        static_assert(offsetof(source2sdk::modellib::CFootDefinition, m_vBallOffset) == 0x18);
        static_assert(offsetof(source2sdk::modellib::CFootDefinition, m_vHeelOffset) == 0x24);
        static_assert(offsetof(source2sdk::modellib::CFootDefinition, m_flFootLength) == 0x30);
