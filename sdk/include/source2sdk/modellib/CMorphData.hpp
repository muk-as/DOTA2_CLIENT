...
namespace source2sdk
{
    namespace modellib
    {
        ...
        public:
            ...
            char m_morphRectDatas[0x_]; // 0x_            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::modellib::CMorphData, m_name) == 0x_);
        static_assert(offsetof(source2sdk::modellib::CMorphData, m_morphRectDatas) == 0x_);
        
        static_assert(sizeof(source2sdk::modellib::CMorphData) == 0x_);
    };
};
