...
namespace source2sdk
{
    namespace modellib
    {
        ...
        public:
            ...
            CUtlString m_sAttachmentName; // 0x_            
        ...
        static_assert(sizeof(source2sdk::modellib::CBoneConstraintPoseSpaceMorph) == 0x_);
    };
};
