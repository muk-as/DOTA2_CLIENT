...
namespace source2sdk
{
    namespace soundsystem
    {
        ...
        public:
            ...
            char m_EditItems[0x_]; // 0x_            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::soundsystem::SelectedEditItemInfo_t, m_EditItems) == 0x_);
        
        static_assert(sizeof(source2sdk::soundsystem::SelectedEditItemInfo_t) == 0x_);
    };
};
