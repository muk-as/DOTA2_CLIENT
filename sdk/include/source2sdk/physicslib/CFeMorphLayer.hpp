...
namespace source2sdk
{
    namespace physicslib
    {
        ...
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_Name) == 0x0);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_nNameHash) == 0x8);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_Nodes) == 0x10);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_InitPos) == 0x28);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_Gravity) == 0x40);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_GoalStrength) == 0x58);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_GoalDamping) == 0x70);
        
        static_assert(sizeof(source2sdk::physicslib::CFeMorphLayer) == 0x88);
    };
};
