...
namespace source2sdk
{
    namespace physicslib
    {
        ...
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_Name) == 0x_);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_nNameHash) == 0x_);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_Nodes) == 0x_);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_InitPos) == 0x_);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_Gravity) == 0x_);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_GoalStrength) == 0x_);
        static_assert(offsetof(source2sdk::physicslib::CFeMorphLayer, m_GoalDamping) == 0x_);
        
        static_assert(sizeof(source2sdk::physicslib::CFeMorphLayer) == 0x_);
    };
};
