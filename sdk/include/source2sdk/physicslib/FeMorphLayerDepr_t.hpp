...
namespace source2sdk::physicslib
{
    ...
    static_assert(offsetof(FeMorphLayerDepr_t, m_Name) == 0x0);
    static_assert(offsetof(FeMorphLayerDepr_t, m_nNameHash) == 0x8);
    static_assert(offsetof(FeMorphLayerDepr_t, m_Nodes) == 0x10);
    static_assert(offsetof(FeMorphLayerDepr_t, m_InitPos) == 0x28);
    static_assert(offsetof(FeMorphLayerDepr_t, m_Gravity) == 0x40);
    static_assert(offsetof(FeMorphLayerDepr_t, m_GoalStrength) == 0x58);
    static_assert(offsetof(FeMorphLayerDepr_t, m_GoalDamping) == 0x70);
    static_assert(offsetof(FeMorphLayerDepr_t, m_nFlags) == 0x88);
    
    static_assert(sizeof(FeMorphLayerDepr_t) == 0x90);
};
