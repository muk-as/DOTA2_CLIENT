...
namespace source2sdk
{
    namespace mathlib_extended
    {
        ...
        public:
            ...
            uint8_t _pad00a8[0x8];
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::mathlib_extended::CFuseSymbolTable, m_constants) == 0x0);
        static_assert(offsetof(source2sdk::mathlib_extended::CFuseSymbolTable, m_variables) == 0x18);
        static_assert(offsetof(source2sdk::mathlib_extended::CFuseSymbolTable, m_functions) == 0x30);
        static_assert(offsetof(source2sdk::mathlib_extended::CFuseSymbolTable, m_constantMap) == 0x48);
        static_assert(offsetof(source2sdk::mathlib_extended::CFuseSymbolTable, m_variableMap) == 0x68);
        static_assert(offsetof(source2sdk::mathlib_extended::CFuseSymbolTable, m_functionMap) == 0x88);
        
        static_assert(sizeof(source2sdk::mathlib_extended::CFuseSymbolTable) == 0xb0);
    };
};
