...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float shrapnel_damage; // 0x188c            
            std::int32_t fast_tick; // 0x1890            
            std::int32_t m_nTracker; // 0x1894            
            bool bFirst; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Sniper_Shrapnel_Slow) == 0x18a0);
    };
};
