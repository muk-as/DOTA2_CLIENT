...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float scepter_movespeed_bonus_pct; // 0x17fc            
            std::int32_t scepter_blind; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Windrunner_Windrun_Slow) == 0x1808);
    };
};
