...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_BaseNPC_Largo_Frogling : public source2sdk::server::CDOTA_BaseNPC_Additive
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_Largo_Frogling) == 0x_);
    };
};
