...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_MonkeyKingBar : public server::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_attack_speed; // 0x1708        
        int32_t bonus_chance; // 0x170c        
        int32_t bonus_chance_damage; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_MonkeyKingBar) == 0x1730);
};
