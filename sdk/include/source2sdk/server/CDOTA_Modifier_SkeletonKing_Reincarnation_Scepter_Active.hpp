...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t scepter_move_speed_pct; // 0x1888            
            std::int32_t scepter_attack_speed; // 0x188c            
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1890            
            bool m_bPassive; // 0x1894            
            bool m_bKillAtEnd; // 0x1895            
            uint8_t _pad1896[0x2];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_SkeletonKing_Reincarnation_Scepter_Active) == 0x1898);
    };
};
