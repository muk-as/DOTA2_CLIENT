...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t scepter_move_speed_pct; // 0x_            
            std::int32_t scepter_attack_speed; // 0x_            
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x_]; // 0x_            
            bool m_bPassive; // 0x_            
            bool m_bKillAtEnd; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_SkeletonKing_Reincarnation_Scepter_Active) == 0x_);
    };
};
