...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flStunDuration; // 0x_            
            std::int32_t light_strike_array_aoe; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Greevil_Miniboss_Orange_LightStrikeArray_Thinker) == 0x_);
    };
};
