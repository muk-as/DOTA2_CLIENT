...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float vision_aoe; // 0x1888            
            uint8_t _pad188c[0x4]; // 0x188c
            source2sdk::server::CDOTA_Tree* m_Tree; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Treant_EyesInTheForest_Thinker) == 0x18a8);
    };
};
