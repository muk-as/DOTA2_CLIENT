...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t frost_arrows_movement_speed; // 0x17f8            
            std::int32_t shard_max_stacks; // 0x17fc            
            float shard_stack_duration; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_DrowRanger_FrostArrows_Slow) == 0x1808);
    };
};
