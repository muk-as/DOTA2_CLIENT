...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iSlot) == 0x304);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iPosition) == 0x308);
