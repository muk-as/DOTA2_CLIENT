...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iFlags) == 0x2e1);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_nPrimaryAmmoType) == 0x2e2);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_nSecondaryAmmoType) == 0x2e3);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iMaxClip1) == 0x2e4);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iMaxClip2) == 0x2e8);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iDefaultClip1) == 0x2ec);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iDefaultClip2) == 0x2f0);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_bReserveAmmoAsClips) == 0x2f4);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iWeight) == 0x2f8);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_bAutoSwitchTo) == 0x2fc);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_bAutoSwitchFrom) == 0x2fd);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iRumbleEffect) == 0x300);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_flDropSpeed) == 0x304);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iSlot) == 0x308);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iPosition) == 0x30c);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_aShootSounds) == 0x310);
        
        static_assert(sizeof(source2sdk::server::CBasePlayerWeaponVData) == 0x338);
    };
};
