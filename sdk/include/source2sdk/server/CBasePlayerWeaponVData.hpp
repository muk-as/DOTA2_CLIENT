...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iFlags) == 0x3d5);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_nPrimaryAmmoType) == 0x3d6);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_nSecondaryAmmoType) == 0x3d7);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iMaxClip1) == 0x3d8);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iMaxClip2) == 0x3dc);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iDefaultClip1) == 0x3e0);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iDefaultClip2) == 0x3e4);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_bReserveAmmoAsClips) == 0x3e8);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_bTreatAsSingleClip) == 0x3e9);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iWeight) == 0x3ec);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_bAutoSwitchTo) == 0x3f0);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_bAutoSwitchFrom) == 0x3f1);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iRumbleEffect) == 0x3f4);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_flDropSpeed) == 0x3f8);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iSlot) == 0x3fc);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_iPosition) == 0x400);
        static_assert(offsetof(source2sdk::server::CBasePlayerWeaponVData, m_aShootSounds) == 0x408);
        
        static_assert(sizeof(source2sdk::server::CBasePlayerWeaponVData) == 0x430);
    };
};
