...
namespace source2sdk::server
{
    ...
    {
    public:
        Vector m_vCastLoc; // 0x5c8        
        int32_t m_nHeroesKilled; // 0x5d4        
        ...
        char m_hAttackEntities[0x18]; // 0x5d8        
        client::ParticleIndex_t m_nFXMarkerIndex; // 0x5f0        
