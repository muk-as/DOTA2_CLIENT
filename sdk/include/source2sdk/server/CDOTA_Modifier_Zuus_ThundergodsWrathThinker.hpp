...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTargetEntities[0x18]; // 0x18a0            
            std::int32_t m_nFarKills; // 0x18b8            
            std::int32_t m_nKills; // 0x18bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Zuus_ThundergodsWrathThinker because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Zuus_ThundergodsWrathThinker) == 0x18c0);
    };
};
