...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float base_damage; // 0x1878            
            float attack_factor; // 0x187c            
            float power_reduction; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_PhantomAssassin_StiflingDagger_Caster) == 0x1888);
    };
};
