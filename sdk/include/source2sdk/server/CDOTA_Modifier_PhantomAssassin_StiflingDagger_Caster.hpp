...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float base_damage; // 0x17f8            
            float attack_factor; // 0x17fc            
            float power_reduction; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_PhantomAssassin_StiflingDagger_Caster) == 0x1808);
    };
};
