...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bunker_heal_pct; // 0x_            
            float tombstone_grab_radius; // 0x_            
            float tombstone_stun_penalty; // 0x_            
            ...
            char m_hLoadedUnit[0x_]; // 0x_            
            source2sdk::client::ParticleIndex_t m_nBunkerEnterFXIndex; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Undying_Tombstone_Bunker) == 0x_);
    };
};
