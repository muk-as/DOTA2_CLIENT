...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bunker_heal_pct; // 0x1888            
            float tombstone_grab_radius; // 0x188c            
            float tombstone_stun_penalty; // 0x1890            
            ...
            char m_hLoadedUnit[0x4]; // 0x1894            
            source2sdk::client::ParticleIndex_t m_nBunkerEnterFXIndex; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Undying_Tombstone_Bunker) == 0x18a0);
    };
};
