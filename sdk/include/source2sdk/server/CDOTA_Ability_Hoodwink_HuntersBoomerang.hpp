...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t speed; // 0x5bc            
            std::int32_t damage; // 0x5c0            
            float mark_duration; // 0x5c4            
            ...
            char m_vecHitEntities[0x18]; // 0x5d0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Hoodwink_HuntersBoomerang) == 0x5f0);
    };
};
