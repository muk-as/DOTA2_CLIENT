...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t level; // 0x1888            
            std::int32_t armor; // 0x188c            
            std::int32_t mana; // 0x1890            
            float attack_range; // 0x1894            
            float armor_per_attack; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_ForgedSpirit_Stats) == 0x18a0);
    };
};
