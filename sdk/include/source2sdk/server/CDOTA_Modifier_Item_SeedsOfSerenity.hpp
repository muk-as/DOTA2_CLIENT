...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_SeedsOfSerenity : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_SeedsOfSerenity) == 0x1890);
    };
};
