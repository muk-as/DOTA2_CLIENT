...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nChannelFX; // 0x1890            
            std::int32_t m_nChannelCount; // 0x1894            
            source2sdk::client::ParticleIndex_t m_nCountdownFX; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Underlord_Portal_FX) == 0x18a0);
    };
};
