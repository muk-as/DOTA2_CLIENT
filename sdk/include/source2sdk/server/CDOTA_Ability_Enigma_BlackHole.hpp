...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Enigma_BlackHole : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            // CHandle<source2sdk::server::CBaseEntity> m_hThinker2;
            char m_hThinker2[0x4]; // 0x5bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Enigma_BlackHole because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Enigma_BlackHole) == 0x5c0);
    };
};
