...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_Iron_Talon : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Iron_Talon) == 0x1880);
    };
};
