...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nActionCount; // 0x_            
            Vector m_vecStartingPos; // 0x_            
            Vector m_vecDestinationOffset; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_TI9_Shovel_Pudgling) == 0x_);
    };
};
