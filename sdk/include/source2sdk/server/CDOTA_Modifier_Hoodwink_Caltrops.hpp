...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t effect_radius; // 0x1888            
            std::int32_t caltrops_damage; // 0x188c            
            std::int32_t activation_radius; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_Caltrops) == 0x18a0);
    };
};
