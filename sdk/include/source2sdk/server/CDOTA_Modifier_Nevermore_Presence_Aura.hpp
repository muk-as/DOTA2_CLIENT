...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float presence_radius; // 0x_            
            float kill_buff_duration; // 0x_            
            source2sdk::entity2::GameTime_t m_fLastStackChange; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Nevermore_Presence_Aura) == 0x_);
    };
};
