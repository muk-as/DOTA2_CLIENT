...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecKilledPlayers[0x_]; // 0x_            
            source2sdk::entity2::GameTime_t m_flLastSonicWaveCast; // 0x_            
            bool m_bSpeechComplete; // 0x_            
            bool m_bMessageComplete; // 0x_            
            bool m_bIsMeleeAttack; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_QueenOfPain_Arcana) == 0x_);
    };
};
