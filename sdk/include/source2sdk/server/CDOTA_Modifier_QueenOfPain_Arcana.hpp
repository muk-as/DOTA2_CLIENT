...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecHitPlayers[0x28]; // 0x17f8            
            ...
            char m_vecKilledPlayers[0x28]; // 0x1820            
            source2sdk::entity2::GameTime_t m_flLastSonicWaveCast; // 0x1848            
            bool m_bSpeechComplete; // 0x184c            
            bool m_bMessageComplete; // 0x184d            
            bool m_bIsMeleeAttack; // 0x184e            
            uint8_t _pad184f[0x1];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_QueenOfPain_Arcana because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_QueenOfPain_Arcana) == 0x1850);
    };
};
