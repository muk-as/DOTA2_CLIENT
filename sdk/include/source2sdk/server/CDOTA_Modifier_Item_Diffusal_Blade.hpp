...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t feedback_mana_burn; // 0x_            
            std::int32_t feedback_mana_burn_illusion_melee; // 0x_            
            std::int32_t feedback_mana_burn_illusion_ranged; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Diffusal_Blade because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Diffusal_Blade) == 0x_);
    };
};
