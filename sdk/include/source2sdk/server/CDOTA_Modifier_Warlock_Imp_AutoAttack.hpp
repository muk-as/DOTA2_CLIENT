...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float bonus_hp; // 0x188c            
            float bonus_dmg; // 0x1890            
            float bonus_movespeed; // 0x1894            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Warlock_Imp_AutoAttack because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Warlock_Imp_AutoAttack) == 0x1898);
    };
};
