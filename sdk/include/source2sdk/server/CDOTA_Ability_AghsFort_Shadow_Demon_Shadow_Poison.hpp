...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_AghsFort_Shadow_Demon_Shadow_Poison : public server::CDOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Ability_AghsFort_Shadow_Demon_Shadow_Poison) == 0x5e0);
};
