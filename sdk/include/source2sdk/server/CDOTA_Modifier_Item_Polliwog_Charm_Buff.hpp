...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float regen_boost; // 0x1888            
            float water_movespeed; // 0x188c            
            bool m_bInWater; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Polliwog_Charm_Buff) == 0x1898);
    };
};
