...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nNumSteps; // 0x_            
            std::int32_t m_nRadiusStep; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AghsFort_StonehallGeneral_OverwhelmingOdds_Thinker) == 0x_);
    };
};
