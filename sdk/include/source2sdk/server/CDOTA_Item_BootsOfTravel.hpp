...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flTeleportTimeOverride; // 0x_            
            bool m_bPendingSellExcessScrolls; // 0x_            
            bool m_bQueueSellScrolls; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Item_BootsOfTravel) == 0x_);
    };
};
