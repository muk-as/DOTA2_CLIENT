...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EntitiesHit[0x18]; // 0x1898            
            float scepter_speed; // 0x18b0            
            float scepter_radius; // 0x18b4            
            float damage; // 0x18b8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Terrorblade_Metamorphosis_Fear_Thinker) == 0x18c0);
    };
};
