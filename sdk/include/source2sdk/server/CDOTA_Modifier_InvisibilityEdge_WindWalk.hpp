...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_InvisibilityEdge_WindWalk : public server::CDOTA_Modifier_Invisible
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_InvisibilityEdge_WindWalk) == 0x1700);
};
