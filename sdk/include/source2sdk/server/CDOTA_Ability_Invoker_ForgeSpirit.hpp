...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float spirit_damage; // 0x5d0            
            std::int32_t spirit_mana; // 0x5d4            
            std::int32_t spirit_armor; // 0x5d8            
            float spirit_attack_range; // 0x5dc            
            std::int32_t spirit_hp; // 0x5e0            
            std::int32_t spirit_level; // 0x5e4            
            float spirit_duration; // 0x5e8            
            float armor_per_attack; // 0x5ec            
