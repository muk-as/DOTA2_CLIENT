...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nSkeletonWarriors; // 0x1ef0            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnSKArcanaProgressChanged"
            std::int32_t m_vecInitialHeroKillBitmask[5]; // 0x1ef4            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnSKArcanaProgressChanged"
            std::int32_t m_vecInGameHeroKillBitmask[5]; // 0x1f08            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_SkeletonKing) == 0x1f20);
    };
};
