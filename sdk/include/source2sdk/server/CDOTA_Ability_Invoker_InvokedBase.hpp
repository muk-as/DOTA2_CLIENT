...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nQuasLevel; // 0x5c0            
            // metadata: MNetworkEnable
            std::int32_t m_nWexLevel; // 0x5c4            
            // metadata: MNetworkEnable
            std::int32_t m_nExortLevel; // 0x5c8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Invoker_InvokedBase) == 0x5d0);
    };
};
