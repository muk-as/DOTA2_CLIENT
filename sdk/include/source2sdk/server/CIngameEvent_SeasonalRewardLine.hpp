...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CIngameEvent_SeasonalRewardLine : public source2sdk::server::CIngameEvent_Base
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CIngameEvent_SeasonalRewardLine) == 0x_);
    };
};
