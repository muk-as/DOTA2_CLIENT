...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Witch_Blade : public server::CDOTA_Buff_Item
    {
    public:
        ...
        int32_t projectile_speed; // 0x171c        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Witch_Blade) == 0x1738);
};
