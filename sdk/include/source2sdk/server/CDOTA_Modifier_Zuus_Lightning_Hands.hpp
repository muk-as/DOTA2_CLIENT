...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t arc_lightning_damage_pct; // 0x1814            
            std::int32_t arc_lightning_damage_illusion_pct; // 0x1818            
            std::int32_t attack_speed_bonus; // 0x181c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Zuus_Lightning_Hands because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Zuus_Lightning_Hands) == 0x1820);
    };
};
