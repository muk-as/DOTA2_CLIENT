...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float damage_aoe; // 0x187c            
            float damage; // 0x1880            
            float damage_illusions; // 0x1884            
            std::int32_t damage_threshold; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lina_Overheat) == 0x1890);
    };
};
