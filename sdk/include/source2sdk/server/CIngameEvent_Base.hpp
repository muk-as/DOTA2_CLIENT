...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bHasSpentWager[10]; // 0x_            
            bool m_bPendingWagerSpend[10]; // 0x_            
            bool m_bCavernCrawlActive[24]; // 0x_            
            source2sdk::client::CavernCrawlMapVariant_t m_nCavernCrawlMapVariant[24]; // 0x_            
            bool m_bCavernHalfCredit; // 0x_            
            bool m_bBountyReminded[24]; // 0x_            
            bool m_bBountyAnnounced[24]; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            std::uint32_t m_pCavernCrawlWinnings[24]; // 0x_            
            std::uint32_t m_pCavernCrawlPlusShardWinnings[24]; // 0x_            
            ...
            char m_ppVecCavernCrawlMapResult[0x_]; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CIngameEvent_Base) == 0x_);
    };
};
