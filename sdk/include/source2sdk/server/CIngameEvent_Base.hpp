...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_CompendiumChallengeEventID[24]; // 0x504        
        // metadata: MNetworkEnable
        int32_t m_CompendiumChallengeSequenceID[24]; // 0x564        
        // metadata: MNetworkEnable
        int32_t m_CompendiumChallengeCoinReward[24]; // 0x5c4        
        // metadata: MNetworkEnable
        int32_t m_CompendiumChallengeCoinSplash[24]; // 0x624        
        // metadata: MNetworkEnable
        int32_t m_CompendiumChallengePointReward[24]; // 0x684        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnClientPlayerChallengeProgressChanged"
        int32_t m_CompendiumChallengeProgress[24]; // 0x714        
        // metadata: MNetworkEnable
        int32_t m_QueryIDForProgress[24]; // 0x774        
        ...
        int32_t m_CompendiumCoinWager[10]; // 0x840        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnWagerChanged"
        client::itemid_t m_CompendiumTokenWagerItemID[10]; // 0x868        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnWagerChanged"
        int32_t m_CompendiumWagerTokenBonusPct[10]; // 0x8b8        
        // metadata: MNetworkEnable
        int32_t m_CompendiumCoinWagerResults[10]; // 0x8e0        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnWagerChanged"
        int32_t m_CompendiumRankWagers[10]; // 0x908        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnWagerTimeChanged"
        float m_flWagerTimer; // 0x930        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flWagerEndTime; // 0x934        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnClientPlayerChallengeProgressChanged"
        int32_t m_ProgressForQueryID[100]; // 0x1478        
        // metadata: MNetworkEnable
        int32_t m_GoalForQueryID[100]; // 0x1608        
        // metadata: MNetworkEnable
        int32_t m_PlayerQuestRankPreviouslyCompleted[10]; // 0x1798        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnClientPlayerQuestRankChanged"
        int32_t m_PlayerQuestRankCompleted[10]; // 0x17c0        
        // metadata: MNetworkEnable
        client::PlayerID_t m_PlayerBountyTarget[10]; // 0x17e8        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flPlayerBountyTimestamp[10]; // 0x1810        
        // metadata: MNetworkEnable
        int32_t m_PlayerBountyCount[10]; // 0x1838        
        bool m_bHasSpentWager[10]; // 0x1860        
        bool m_bPendingWagerSpend[10]; // 0x186a        
        bool m_bCavernCrawlActive[24]; // 0x1874        
        client::CavernCrawlMapVariant_t m_nCavernCrawlMapVariant[24]; // 0x188c        
        bool m_bCavernHalfCredit; // 0x18a4        
        bool m_bBountyReminded[24]; // 0x18a5        
        bool m_bBountyAnnounced[24]; // 0x18bd        
        [[maybe_unused]] std::uint8_t pad_0x18d5[0x3]; // 0x18d5
        uint32_t m_pCavernCrawlWinnings[24]; // 0x18d8        
        uint32_t m_pCavernCrawlPlusShardWinnings[24]; // 0x1938        
        ...
        int32_t m_event_lobby_updated; // 0x1a58        
        [[maybe_unused]] std::uint8_t pad_0x1a5c[0x44];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CIngameEvent_Base because it is not a standard-layout class
    static_assert(sizeof(CIngameEvent_Base) == 0x1aa0);
};
