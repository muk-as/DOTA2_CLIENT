...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Miniboss_Radiance_Debuff : public client::CDOTA_Buff
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x16e8[0x8]; // 0x16e8
        int32_t aura_damage; // 0x16f0        
        float aura_interval; // 0x16f4        
    ...
    static_assert(sizeof(CDOTA_Modifier_Miniboss_Radiance_Debuff) == 0x1700);
};
