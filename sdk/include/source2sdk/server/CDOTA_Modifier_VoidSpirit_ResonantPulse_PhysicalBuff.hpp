...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nMaxAbsorb; // 0x_            
            bool is_all_barrier; // 0x_            
            bool m_bAllDamageAbsorb; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_VoidSpirit_ResonantPulse_PhysicalBuff) == 0x_);
    };
};
