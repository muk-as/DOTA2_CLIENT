...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x5c0            
            float bonus_linger_duration; // 0x5c4            
            source2sdk::entity2::GameTime_t m_startDecayTime; // 0x5c8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Axe_One_Man_Army) == 0x5d0);
    };
};
