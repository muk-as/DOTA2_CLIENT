...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CUtlSymbolLarge m_forceWorldGroupID; // 0x_            
            CUtlSymbolLarge m_associatedRelayTargetName; // 0x_            
            bool m_fixupNames; // 0x_            
            bool m_bLoadDynamic; // 0x_            
            ...
            char m_associatedRelayEntity[0x_]; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CPointPrefab) == 0x_);
    };
};
