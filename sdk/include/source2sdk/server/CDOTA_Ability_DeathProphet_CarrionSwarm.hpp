...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x5c8            
            float m_fTotalTime; // 0x5cc            
            std::int32_t m_nProjectileHandle; // 0x5d0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_DeathProphet_CarrionSwarm) == 0x5d8);
    };
};
