...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t focal_point_max_multiplier; // 0x_            
            std::int32_t focal_point_start_length_pct; // 0x_            
            std::int32_t focal_point_blind_stack_multiplier; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Phoenix_SunRay) == 0x_);
    };
};
