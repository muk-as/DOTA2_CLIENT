...
namespace source2sdk::server
{
    ...
    {
    public:
        float skewer_radius; // 0x5c8        
        float skewer_speed; // 0x5cc        
        float range; // 0x5d0        
        int32_t tree_radius; // 0x5d4        
    ...
    static_assert(sizeof(CDOTA_Aghsfort_Ability_Creature_Magnus_Push_Skewer) == 0x5e0);
};
