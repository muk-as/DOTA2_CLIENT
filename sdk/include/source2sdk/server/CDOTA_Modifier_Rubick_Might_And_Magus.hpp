...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t magic_resist_pct; // 0x187c            
            std::int32_t m_nTotalBonusDamage; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Rubick_Might_And_Magus) == 0x1888);
    };
};
