...
namespace source2sdk::server
{
    ...
    public:
        ...
        bool m_bFoundFive; // 0x170c        
        bool m_bGrantedKillEater; // 0x170d        
        [[maybe_unused]] std::uint8_t pad_0x170e[0xa];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Enigma_BlackHoleThinker because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Enigma_BlackHoleThinker) == 0x1718);
};
