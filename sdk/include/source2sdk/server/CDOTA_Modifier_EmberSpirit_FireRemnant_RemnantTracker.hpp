...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vActiveRemnants[0x18]; // 0x1888            
            ...
            char m_vTrackingDelayedRemnants[0x18]; // 0x18a0            
            float shard_charge_radius; // 0x18b8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_EmberSpirit_FireRemnant_RemnantTracker) == 0x18c0);
    };
};
