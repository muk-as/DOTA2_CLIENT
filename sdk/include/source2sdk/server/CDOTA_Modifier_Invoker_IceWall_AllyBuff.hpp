...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t ally_speed; // 0x1888            
            float ally_armor; // 0x188c            
            float ally_healing; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Invoker_IceWall_AllyBuff) == 0x1898);
    };
};
