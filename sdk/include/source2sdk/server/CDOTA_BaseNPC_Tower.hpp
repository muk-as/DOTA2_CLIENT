...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnTowerKilled; // 0x19d0            
            ...
            char m_hTowerAttackTarget[0x4]; // 0x19f8            
            // metadata: MNetworkEnable
            ...
            char m_hTowerHighFiveTarget[0x4]; // 0x19fc            
            uint8_t _pad1a00[0x8];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_BaseNPC_Tower because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_Tower) == 0x1a08);
    };
};
