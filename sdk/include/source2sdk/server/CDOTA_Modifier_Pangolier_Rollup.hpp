...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_flLastHeroAttackTime; // 0x_            
            bool m_bIsJumping; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x_            
            float m_flGyroshellDurationRemaining; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Pangolier_Rollup) == 0x_);
    };
};
