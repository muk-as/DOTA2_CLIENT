...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Pangolier_Rollup : public source2sdk::server::CDOTA_Modifier_DebuffImmune
        {
        public:
            ...
            bool m_bHitFirstUpdate; // 0x1894            
            uint8_t _pad1895[0x3]; // 0x1895
            source2sdk::entity2::GameTime_t m_flHitEndTime; // 0x1898            
            float hit_recover_time; // 0x189c            
            source2sdk::entity2::GameTime_t m_flJumpEndTime; // 0x18a0            
            float jump_recover_time; // 0x18a4            
            float m_flTurnBoostProgress; // 0x18a8            
            float m_flFacingTarget; // 0x18ac            
            source2sdk::entity2::GameTime_t m_flLastHeroAttackTime; // 0x18b0            
            bool m_bIsJumping; // 0x18b4            
            uint8_t _pad18b5[0x3]; // 0x18b5
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x18b8            
            float m_flGyroshellDurationRemaining; // 0x18bc            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Pangolier_Rollup) == 0x1920);
    };
};
