...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Shadow_Demon_Shadow_Poison : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char m_hPoisonedUnits[0x_]; // 0x_            
            bool m_bHitDisruptedUnit; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Shadow_Demon_Shadow_Poison) == 0x_);
    };
};
