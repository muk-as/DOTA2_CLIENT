...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float length_buffer; // 0x5cc            
            float range; // 0x5d0            
            std::int32_t m_iDefaultCastRange; // 0x5d4            
            std::int32_t pierces_immunity; // 0x5d8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Lion_Impale) == 0x5f8);
    };
};
