...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t speed; // 0x18b0            
            std::int32_t radius; // 0x18b4            
            std::int32_t damage; // 0x18b8            
            std::int32_t tree_splinter_count; // 0x18bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Shredder_TimberChain because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shredder_TimberChain) == 0x18c0);
    };
};
