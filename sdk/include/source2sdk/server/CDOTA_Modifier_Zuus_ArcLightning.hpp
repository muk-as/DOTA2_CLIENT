...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t arc_damage; // 0x_            
            float jump_delay; // 0x_            
            std::int32_t total_damage_pct; // 0x_            
            std::int32_t m_iCurJumpCount; // 0x_            
            bool trigger_spell_absorb; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Zuus_ArcLightning) == 0x_);
    };
};
