...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float explosion_radius; // 0x1888            
            float explosion_dmg; // 0x188c            
            float explosion_nonhero_reduce; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Warlock_Imp_ExplodeThinker) == 0x1898);
    };
};
