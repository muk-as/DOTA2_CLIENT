...
namespace source2sdk::server
{
    ...
    {
    public:
        float explosion_radius; // 0x1708        
        float explosion_dmg; // 0x170c        
        float explosion_nonhero_reduce; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Warlock_Imp_ExplodeThinker) == 0x1718);
};
