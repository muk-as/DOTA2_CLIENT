...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char hIllusion[0x18]; // 0x5c0            
            float decoy_stun_duration; // 0x5d8            
            float decoy_detonate_radius; // 0x5dc            
            float projectile_speed; // 0x5e0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Hoodwink_Decoy) == 0x600);
    };
};
