...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flDamagePerTick; // 0x1878            
            std::int32_t m_nCurrentTick; // 0x187c            
            std::int32_t m_nTotalTicks; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_QueenOfPain_SonicWave_Damage) == 0x1888);
    };
};
