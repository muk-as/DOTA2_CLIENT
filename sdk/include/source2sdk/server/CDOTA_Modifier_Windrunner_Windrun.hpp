...
namespace source2sdk::server
{
    ...
    public:
        float radius; // 0x16e8        
        int32_t scepter_radius; // 0x16ec        
        int32_t movespeed_bonus_pct; // 0x16f0        
        bool m_bDispellable; // 0x16f4        
        [[maybe_unused]] std::uint8_t pad_0x16f5[0x3]; // 0x16f5
        int32_t physical_damage_pct; // 0x16f8        
        [[maybe_unused]] std::uint8_t pad_0x16fc[0x4];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Windrunner_Windrun because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Windrunner_Windrun) == 0x1700);
};
