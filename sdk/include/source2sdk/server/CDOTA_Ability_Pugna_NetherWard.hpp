...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Pugna_NetherWard : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char vecAbilitiesUsed[0x18]; // 0x5c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Pugna_NetherWard because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Pugna_NetherWard) == 0x5d8);
    };
};
