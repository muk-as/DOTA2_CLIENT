...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_ArcWarden_TempestDouble : public source2sdk::server::CDOTABaseAbility
        {
        public:
            // metadata: MNetworkEnable
            // m_hDoubles has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hDoubles;
            char m_hDoubles[0x4]; // 0x5b8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_ArcWarden_TempestDouble) == 0x5c0);
    };
};
