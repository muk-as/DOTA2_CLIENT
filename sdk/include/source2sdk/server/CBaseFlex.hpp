...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_flexWeight[0x18]; // 0x7b8            
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            Vector m_vLookTargetPosition; // 0x7d0            
            // metadata: MNetworkEnable
            bool m_blinktoggle; // 0x7dc            
            uint8_t _pad07dd[0x53]; // 0x7dd
            source2sdk::entity2::GameTime_t m_flAllowResponsesEndTime; // 0x830            
            source2sdk::entity2::GameTime_t m_flLastFlexAnimationTime; // 0x834            
            source2sdk::client::SceneEventId_t m_nNextSceneEventId; // 0x838            
            bool m_bUpdateLayerPriorities; // 0x83c            
            uint8_t _pad083d[0xb];
        ...
        static_assert(sizeof(source2sdk::server::CBaseFlex) == 0x848);
    };
};
