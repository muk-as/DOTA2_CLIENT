...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t passive_area_damage; // 0x_            
            float passive_area_interval; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Razor_EyeOfTheStorm_Passive) == 0x_);
    };
};
