...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t passive_area_damage; // 0x1888            
            float passive_area_interval; // 0x188c            
            std::int32_t radius; // 0x1890            
            bool m_bHitNext; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Razor_EyeOfTheStorm_Passive) == 0x1898);
    };
};
