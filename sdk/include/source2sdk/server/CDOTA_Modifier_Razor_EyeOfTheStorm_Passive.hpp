...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t passive_area_damage; // 0x1708        
        float passive_area_interval; // 0x170c        
        int32_t radius; // 0x1710        
        bool m_bHitNext; // 0x1714        
    ...
    static_assert(sizeof(CDOTA_Modifier_Razor_EyeOfTheStorm_Passive) == 0x1718);
};
