...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float movement_speed_pct_total; // 0x_            
            float spell_amplification_total; // 0x_            
            float hp_cost_per_second; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Batrider_Displacement_Buff) == 0x_);
    };
};
