...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float hp_per_kill; // 0x1878            
            float mana_per_kill; // 0x187c            
            float hp_regen; // 0x1880            
            float mp_regen; // 0x1884            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Necrolyte_ReapersScythe_RespawnTime) == 0x1888);
    };
};
