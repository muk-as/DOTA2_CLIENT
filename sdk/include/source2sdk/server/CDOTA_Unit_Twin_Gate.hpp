...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Unit_Twin_Gate : public source2sdk::server::CDOTA_BaseNPC_Building
        {
        public:
            ...
            char m_hOtherPortal[0x4]; // 0x1970            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Twin_Gate) == 0x1978);
    };
};
