...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::CEntityIOOutput m_PlayerHasAmmo; // 0x4e8        
        entity2::CEntityIOOutput m_PlayerHasNoAmmo; // 0x510        
        entity2::CEntityIOOutput m_PlayerDied; // 0x538        
    ...
    static_assert(sizeof(CLogicPlayerProxy) == 0x588);
};
