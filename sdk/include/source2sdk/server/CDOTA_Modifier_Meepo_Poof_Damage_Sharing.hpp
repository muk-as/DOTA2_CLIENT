...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t damage_share_percentage; // 0x1708        
        int32_t damage_share_radius; // 0x170c        
