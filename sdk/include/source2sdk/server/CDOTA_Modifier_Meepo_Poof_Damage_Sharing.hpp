...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t damage_share_percentage; // 0x_            
            std::int32_t damage_share_radius; // 0x_            
