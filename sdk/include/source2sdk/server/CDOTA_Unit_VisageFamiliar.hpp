...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::server::CountdownTimer ctTimer; // 0x1910            
            source2sdk::client::ParticleIndex_t m_nFXAmbient; // 0x1928            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_VisageFamiliar) == 0x1930);
    };
};
