...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t electric_vortex_pull_distance; // 0x_            
            float electric_vortex_pull_tether_range; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_StormSpirit_ElectricVortex_Pull) == 0x_);
    };
};
