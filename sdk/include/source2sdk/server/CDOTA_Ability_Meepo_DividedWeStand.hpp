...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nWhichDividedWeStand; // 0x5b8            
            // metadata: MNetworkEnable
            std::int32_t m_nNumDividedWeStand; // 0x5bc            
            // metadata: MNetworkEnable
            ...
            char m_entPrimeDividedWeStand[0x4]; // 0x5c0            
            // metadata: MNetworkEnable
            ...
            char m_entNextDividedWeStand[0x4]; // 0x5c4            
            std::int32_t m_iPendingUpgrades; // 0x5c8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Meepo_DividedWeStand) == 0x5d0);
    };
};
