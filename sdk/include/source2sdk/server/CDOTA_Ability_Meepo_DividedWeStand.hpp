...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_nWhichDividedWeStand; // 0x5c8        
        // metadata: MNetworkEnable
        int32_t m_nNumDividedWeStand; // 0x5cc        
        // metadata: MNetworkEnable
        ...
        char m_entPrimeDividedWeStand[0x4]; // 0x5d0        
        // metadata: MNetworkEnable
        ...
        char m_entNextDividedWeStand[0x4]; // 0x5d4        
        int32_t m_iPendingUpgrades; // 0x5d8        
    ...
    static_assert(sizeof(CDOTA_Ability_Meepo_DividedWeStand) == 0x5e0);
};
