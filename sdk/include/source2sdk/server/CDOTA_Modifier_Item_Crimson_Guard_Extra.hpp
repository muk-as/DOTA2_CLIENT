...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t block_chance_active; // 0x1708        
        int32_t block_damage_active; // 0x170c        
        float max_hp_pct; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Crimson_Guard_Extra) == 0x1718);
};
