...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t block_chance_active; // 0x_            
            std::int32_t block_damage_active; // 0x_            
            float max_hp_pct; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Crimson_Guard_Extra) == 0x_);
    };
};
