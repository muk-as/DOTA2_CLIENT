...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t manacost_reduction_after_blur_pct; // 0x17f8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Phantom_Assassin_Blur_Manacost_Reduction) == 0x1800);
    };
};
