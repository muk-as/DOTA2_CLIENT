...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float radius; // 0x_            
            std::int32_t damage_amplification; // 0x_            
            std::int32_t damage_reduction; // 0x_            
            float root_base_duration; // 0x_            
            float root_per_target; // 0x_            
            float max_root; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Enchantress_Little_Friends_Aura) == 0x_);
    };
};
