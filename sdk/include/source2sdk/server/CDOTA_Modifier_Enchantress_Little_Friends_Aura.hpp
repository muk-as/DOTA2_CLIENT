...
namespace source2sdk::server
{
    ...
    public:
        ...
        float root_base_duration; // 0x1720        
        float root_per_target; // 0x1724        
        float max_root; // 0x1728        
        entity2::GameTime_t m_flLastSeen; // 0x172c        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Enchantress_Little_Friends_Aura) == 0x1730);
};
