...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t maxhp_percent_damage; // 0x17fc            
            std::int32_t every_n_attacks; // 0x1800            
            bool crit_active; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_PudgeMiniboss_HatefulStrike) == 0x1808);
    };
};
