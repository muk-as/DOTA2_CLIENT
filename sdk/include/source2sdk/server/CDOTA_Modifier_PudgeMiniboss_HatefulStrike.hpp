...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t maxhp_percent_damage; // 0x_            
            std::int32_t every_n_attacks; // 0x_            
            bool crit_active; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_PudgeMiniboss_HatefulStrike) == 0x_);
    };
};
