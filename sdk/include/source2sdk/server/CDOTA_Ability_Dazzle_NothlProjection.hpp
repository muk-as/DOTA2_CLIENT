...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Dazzle_NothlProjection : public source2sdk::server::CDOTABaseAbility
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Dazzle_NothlProjection) == 0x5c0);
    };
};
