...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CHandle<server::CBaseEntity> m_hSavedAbility;
        char m_hSavedAbility[0x4]; // 0x1714        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_WitchDoctor_Voodoo_Switcheroo) == 0x1718);
};
