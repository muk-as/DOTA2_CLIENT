...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float fade_delay; // 0x1888            
            float m_flFadeTime; // 0x188c            
            source2sdk::entity2::GameTime_t m_flLastActionTime; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_PersistentInvisibility) == 0x1898);
    };
};
