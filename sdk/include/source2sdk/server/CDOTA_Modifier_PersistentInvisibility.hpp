...
namespace source2sdk::server
{
    ...
    {
    public:
        float fade_delay; // 0x1708        
        float m_flFadeTime; // 0x170c        
        entity2::GameTime_t m_flLastActionTime; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_PersistentInvisibility) == 0x1718);
};
