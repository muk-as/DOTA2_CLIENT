...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nHeal[5]; // 0x1878            
            std::int32_t healing_pct_of_damage; // 0x188c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Omniknight_Innate_HealingHammer) == 0x1890);
    };
};
