...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nHeal[5]; // 0x_            
            std::int32_t healing_pct_of_damage; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Omniknight_Innate_HealingHammer) == 0x_);
    };
};
