...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float bounce_range; // 0x_            
            std::int32_t bounce_count; // 0x_            
            bool m_bIsAltCastState; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            std::int32_t can_bounce_off_of_trees; // 0x_            
            std::int32_t bounces_after_tree_bounce; // 0x_            
            bool bBouncedOffTree; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Hoodwink_AcornShot) == 0x_);
    };
};
