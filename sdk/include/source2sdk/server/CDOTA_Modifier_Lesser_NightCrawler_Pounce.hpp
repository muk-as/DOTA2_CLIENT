...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float pounce_speed; // 0x1828            
            float pounce_acceleration; // 0x182c            
            std::int32_t pounce_radius; // 0x1830            
            std::int32_t pounce_damage; // 0x1834            
            float leash_duration; // 0x1838            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lesser_NightCrawler_Pounce) == 0x1840);
    };
};
