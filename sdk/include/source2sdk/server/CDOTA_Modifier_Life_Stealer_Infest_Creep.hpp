...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bChangedTeams; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            float creep_max_hp_drain_pct_per_second; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Life_Stealer_Infest_Creep) == 0x_);
    };
};
