...
namespace source2sdk::server
{
    ...
    {
    public:
        client::ParticleIndex_t m_nFXStormAmbient1; // 0x1898        
        client::ParticleIndex_t m_nFXStormAmbient2; // 0x189c        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Unit_Brewmaster_PrimalStorm because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Unit_Brewmaster_PrimalStorm) == 0x18a0);
};
