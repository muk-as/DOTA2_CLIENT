...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nVisualTeam; // 0x18b8            
            uint8_t _pad18bc[0x4]; // 0x18bc
            source2sdk::entity2::GameTime_t m_flTransitionTimestamp; // 0x18c0            
            std::int32_t m_nTempViewer; // 0x18c4            
            ...
            char m_hAttackingHeroes[0x18]; // 0x18c8            
            uint8_t _pad18e0[0x8]; // 0x18e0
            source2sdk::client::ParticleIndex_t nShieldFX; // 0x18e8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Miniboss) == 0x18f0);
    };
};
