...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Pudge_Dismember : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char m_hVictim[0x4]; // 0x5b8            
            std::int32_t shard_cast_range; // 0x5bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Pudge_Dismember because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Pudge_Dismember) == 0x5c0);
    };
};
