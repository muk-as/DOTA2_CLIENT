...
namespace source2sdk::server
{
    ...
    public:
        ...
        float bonus_damage_duration; // 0x170c        
        float bonus_damage_from_creep; // 0x1710        
        float bonus_damage_from_hero; // 0x1714        
        bool m_bWasHidden; // 0x1718        
    ...
    static_assert(sizeof(CDOTA_Modifier_AbyssalUnderlord_AtrophyAura_Effect) == 0x1720);
};
