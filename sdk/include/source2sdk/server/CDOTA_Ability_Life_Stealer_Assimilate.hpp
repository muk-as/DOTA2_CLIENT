...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Life_Stealer_Assimilate : public server::CDOTABaseAbility
    {
    public:
        ...
        // CHandle<server::CBaseEntity> m_hLastAssimilation;
        char m_hLastAssimilation[0x4]; // 0x5a0        
    ...
    static_assert(sizeof(CDOTA_Ability_Life_Stealer_Assimilate) == 0x5a8);
};
