...
namespace source2sdk::server
{
    ...
    {
    public:
        float second_attack_delay; // 0x1708        
        float attack_damage_reduction; // 0x170c        
