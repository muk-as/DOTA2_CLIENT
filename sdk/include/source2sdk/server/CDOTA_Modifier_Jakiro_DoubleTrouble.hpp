...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Jakiro_DoubleTrouble : public client::CDOTA_Buff
    {
    public:
        float second_attack_delay; // 0x16e8        
        float attack_damage_reduction; // 0x16ec        
