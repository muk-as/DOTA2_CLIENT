...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Luna_MoonGlaive : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char m_vecMarkedUnits[0x18]; // 0x5b8            
            std::int32_t m_iAttackIndex; // 0x5d0            
