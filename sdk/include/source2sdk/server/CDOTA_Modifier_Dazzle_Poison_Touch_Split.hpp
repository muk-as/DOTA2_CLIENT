...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nAttacksLanded; // 0x1888            
            std::int32_t attacks_to_split; // 0x188c            
            std::int32_t split_radius; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_Poison_Touch_Split) == 0x1898);
    };
};
