...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t max_bounces; // 0x18a8            
            float max_model_scale; // 0x18ac            
            float power_growth_exponent; // 0x18b0            
            Vector m_vLastPos; // 0x18b4            
            Vector m_vDir; // 0x18c0            
            float m_flSpeed; // 0x18cc            
            float m_flDistRemaining; // 0x18d0            
            float m_flTreeTimeRemaining; // 0x18d4            
            std::int32_t m_nTimesBounced; // 0x18d8            
            float m_flModelScale; // 0x18dc            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_Summon_TI11_Balloon_Thinker) == 0x18e8);
    };
};
