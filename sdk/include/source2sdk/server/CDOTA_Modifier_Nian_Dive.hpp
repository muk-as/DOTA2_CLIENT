...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flClawDamageTime; // 0x18cc            
            float m_flPlaybackRate; // 0x18d0            
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x18d4            
            bool m_bPlayedSwipeSound; // 0x18d8            
            uint8_t _pad18d9[0x3]; // 0x18d9
            std::int32_t pounce_distance; // 0x18dc            
            float pounce_speed; // 0x18e0            
            float pounce_acceleration; // 0x18e4            
            std::int32_t pounce_radius; // 0x18e8            
            std::int32_t pounce_damage; // 0x18ec            
            std::int32_t stun_radius; // 0x18f0            
            float stun_duration; // 0x18f4            
            float leash_duration; // 0x18f8            
            float initial_delay; // 0x18fc            
            float landing_delay; // 0x1900            
            float vertical_adjust; // 0x1904            
            float vertical_adjust_max_distance; // 0x1908            
            float vertical_adjust_min_distance; // 0x190c            
            std::int32_t claw_damage; // 0x1910            
            std::int32_t claw_damage_radius; // 0x1914            
            float claw_damage_delay; // 0x1918            
            float claw_damage_duration; // 0x191c            
            ...
            char m_vHitEntities[0x18]; // 0x1920            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Nian_Dive because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Nian_Dive) == 0x1938);
    };
};
