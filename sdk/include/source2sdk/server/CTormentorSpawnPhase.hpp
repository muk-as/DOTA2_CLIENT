...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CTormentorSpawnPhase, m_eTormentorLocation) == 0x8);
        static_assert(offsetof(source2sdk::server::CTormentorSpawnPhase, m_eTormentorSpawnPhase) == 0xc);
        static_assert(offsetof(source2sdk::server::CTormentorSpawnPhase, m_flTormentorPhaseStartTime) == 0x10);
        static_assert(offsetof(source2sdk::server::CTormentorSpawnPhase, m_flTormentorPhaseEndTime) == 0x14);
        
        static_assert(sizeof(source2sdk::server::CTormentorSpawnPhase) == 0x18);
    };
};
