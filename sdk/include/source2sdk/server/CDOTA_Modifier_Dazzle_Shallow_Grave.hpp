...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bHasPostedEvent; // 0x1888            
            uint8_t _pad1889[0x3]; // 0x1889
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x188c            
            float fx_halo_height; // 0x1890            
            float m_flExpirationHeal; // 0x1894            
            std::int32_t heal_amplify; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_Shallow_Grave) == 0x18a0);
    };
};
