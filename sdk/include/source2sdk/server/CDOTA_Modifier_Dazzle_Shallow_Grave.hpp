...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bHasPostedEvent; // 0x17f8            
            uint8_t _pad17f9[0x3]; // 0x17f9
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x17fc            
            float fx_halo_height; // 0x1800            
            float m_flExpirationHeal; // 0x1804            
            std::int32_t heal_amplify; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_Shallow_Grave) == 0x1810);
    };
};
