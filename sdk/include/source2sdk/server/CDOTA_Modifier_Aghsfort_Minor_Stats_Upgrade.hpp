...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_primary_stat; // 0x187c            
            std::int32_t bonus_movespeed; // 0x1880            
            std::int32_t bonus_hp_regen; // 0x1884            
            std::int32_t bonus_armor; // 0x1888            
            std::int32_t bonus_attack_damage; // 0x188c            
            std::int32_t bonus_cast_range; // 0x1890            
            ...
            std::int32_t bonus_heal_amp; // 0x18a4            
            std::int32_t bonus_mana_regen; // 0x18a8            
            std::int32_t bonus_evasion; // 0x18ac            
            std::int32_t bonus_magic_resist; // 0x18b0            
            std::int32_t bonus_lifesteal; // 0x18b4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Aghsfort_Minor_Stats_Upgrade because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Aghsfort_Minor_Stats_Upgrade) == 0x18b8);
    };
};
