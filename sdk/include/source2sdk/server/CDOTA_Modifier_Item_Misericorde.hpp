...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Misericorde : public server::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_damage; // 0x1708        
        int32_t missing_hp; // 0x170c        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Misericorde) == 0x1718);
};
