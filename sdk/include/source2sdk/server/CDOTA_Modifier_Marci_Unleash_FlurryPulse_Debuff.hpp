...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float pulse_move_slow_pct; // 0x17f8            
            float pulse_attack_slow_pct; // 0x17fc            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Marci_Unleash_FlurryPulse_Debuff) == 0x1800);
    };
};
