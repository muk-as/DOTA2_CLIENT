...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t gold_steal; // 0x170c        
        client::ParticleIndex_t m_nFXIndexA; // 0x1710        
        client::ParticleIndex_t m_nFXIndexB; // 0x1714        
    ...
    static_assert(sizeof(CDOTA_Modifier_BountyHunter_Jinada) == 0x1730);
};
