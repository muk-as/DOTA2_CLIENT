...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t attack_speed_per_unit; // 0x17fc            
            std::int32_t magic_resist; // 0x1800            
            std::int32_t nTotalUnits; // 0x1804            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Beastmaster_InnerBeast because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Beastmaster_InnerBeast) == 0x1808);
    };
};
