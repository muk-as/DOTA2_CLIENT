...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t attack_speed_per_unit; // 0x170c        
        int32_t magic_resist; // 0x1710        
        int32_t nTotalUnits; // 0x1714        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Beastmaster_InnerBeast because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Beastmaster_InnerBeast) == 0x1718);
};
