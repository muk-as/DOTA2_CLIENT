...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hRiftIllusion[0x4]; // 0x5d8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_ChaosKnight_Reality_Rift) == 0x5e0);
    };
};
