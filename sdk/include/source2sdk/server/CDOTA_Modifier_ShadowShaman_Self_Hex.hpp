...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_ShadowShaman_Self_Hex : public server::CDOTA_Modifier_Hexed
    {
    public:
        int32_t movespeed_bonus_pct; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_ShadowShaman_Self_Hex) == 0x16f0);
};
