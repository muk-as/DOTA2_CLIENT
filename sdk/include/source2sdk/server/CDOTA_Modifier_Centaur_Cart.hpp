...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bWasMoving; // 0x_            
            bool m_bSpawnDone; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            Vector m_vecOldForward; // 0x_            
            std::int32_t break_distance; // 0x_            
            Vector m_vecPreviousLocation; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Centaur_Cart) == 0x_);
    };
};
