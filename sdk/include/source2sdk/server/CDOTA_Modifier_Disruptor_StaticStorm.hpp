...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t movement_speed_reduction; // 0x170c        
        int32_t attack_speed_reduction; // 0x1710        
        bool m_bHasScepter; // 0x1714        
    ...
    static_assert(sizeof(CDOTA_Modifier_Disruptor_StaticStorm) == 0x1718);
};
