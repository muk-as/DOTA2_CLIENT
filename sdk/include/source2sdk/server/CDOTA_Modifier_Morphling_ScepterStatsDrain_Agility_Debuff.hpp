...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Morphling_ScepterStatsDrain_Agility_Debuff : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Morphling_ScepterStatsDrain_Agility_Debuff) == 0x16f0);
};
