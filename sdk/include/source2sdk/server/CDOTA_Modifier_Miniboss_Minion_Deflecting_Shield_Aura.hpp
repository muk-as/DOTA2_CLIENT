...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CHandle<source2sdk::server::CBaseEntity> m_hOwningItem;
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Miniboss_Minion_Deflecting_Shield_Aura) == 0x1888);
    };
};
