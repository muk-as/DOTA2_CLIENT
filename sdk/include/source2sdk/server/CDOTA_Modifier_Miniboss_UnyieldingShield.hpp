...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float regen_per_second; // 0x17fc            
            float regen_bonus_per_interval; // 0x1800            
            bool smaller_shield; // 0x1804            
            uint8_t _pad1805[0x3]; // 0x1805
            std::int32_t m_nDamageAbsorbed; // 0x1808            
            source2sdk::entity2::GameTime_t m_timeLastTick; // 0x180c            
            source2sdk::client::ParticleIndex_t nFXIndex; // 0x1810            
            std::int32_t m_nVisualTeam; // 0x1814            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Miniboss_UnyieldingShield because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Miniboss_UnyieldingShield) == 0x1818);
    };
};
