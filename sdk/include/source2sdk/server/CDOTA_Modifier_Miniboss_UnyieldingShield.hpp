...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float regen_per_second; // 0x188c            
            float regen_bonus_per_interval; // 0x1890            
            bool smaller_shield; // 0x1894            
            ...
            std::int32_t m_nVisualTeam; // 0x18a4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Miniboss_UnyieldingShield because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Miniboss_UnyieldingShield) == 0x18a8);
    };
};
