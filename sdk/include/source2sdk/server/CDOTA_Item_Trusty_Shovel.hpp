...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            Vector m_vChannelPos; // 0x688            
            bool m_bIsUnderwater; // 0x694            
            uint8_t _pad0695[0x3]; // 0x695
            source2sdk::client::ParticleIndex_t m_nPhaseStartFXIndex; // 0x698            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Item_Trusty_Shovel) == 0x6a0);
    };
};
