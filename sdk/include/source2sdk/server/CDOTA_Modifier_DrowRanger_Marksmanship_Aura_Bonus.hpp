...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t trueshot_agi_bonus_base; // 0x_            
            std::int32_t trueshot_agi_bonus_per_level; // 0x_            
            float trueshot_agi_bonus_allies_pct; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_DrowRanger_Marksmanship_Aura_Bonus) == 0x_);
    };
};
