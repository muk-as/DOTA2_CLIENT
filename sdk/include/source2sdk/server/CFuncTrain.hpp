...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hEnemy[0x_]; // 0x_            
            float m_flBlockDamage; // 0x_            
            source2sdk::entity2::GameTime_t m_flNextBlockTime; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            CUtlSymbolLarge m_iszLastTarget; // 0x_            
            
            // Datamap fields:
            // void CFuncTrainWait; // 0x_
            // void CFuncTrainNext; // 0x_
        ...
        static_assert(sizeof(source2sdk::server::CFuncTrain) == 0x_);
    };
};
