...
namespace source2sdk::server
{
    ...
    {
    public:
        client::ParticleIndex_t m_nTargetFXIndex; // 0x5c8        
        Vector m_vEndpoint; // 0x5cc        
        float landing_radius; // 0x5d8        
        float push_length; // 0x5dc        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Ability_Tusk_WalrusKick because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Ability_Tusk_WalrusKick) == 0x5e0);
};
