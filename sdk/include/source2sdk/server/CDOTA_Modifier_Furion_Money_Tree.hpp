...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t nTargetHeroLevel; // 0x_            
            ...
            char m_hObstruction[0x_]; // 0x_            
            source2sdk::entity2::GameTime_t m_timeLastGoldBagSpawn; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Furion_Money_Tree) == 0x_);
    };
};
