...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bRealityApplied; // 0x1888            
            uint8_t _pad1889[0x3]; // 0x1889
            std::int32_t destroy_if_target_is_dead; // 0x188c            
            source2sdk::entity2::GameTime_t m_fStartAttackTime; // 0x1890            
            ...
            char hTarget[0x4]; // 0x1894            
            bool m_bTargetIsAlive; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Spectre_Haunt) == 0x18a0);
    };
};
