...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flLandDamage; // 0x18a0            
            float spell_lifesteal; // 0x18a4            
            float spell_amp; // 0x18a8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Invoker_Tornado) == 0x18b0);
    };
};
