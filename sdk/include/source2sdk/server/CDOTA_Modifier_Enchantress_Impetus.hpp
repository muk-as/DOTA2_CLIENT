...
namespace source2sdk::server
{
    ...
    {
    public:
        float distance_damage_pct; // 0x1708        
        int32_t distance_cap; // 0x170c        
        float creep_multiplier; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Enchantress_Impetus) == 0x1730);
};
