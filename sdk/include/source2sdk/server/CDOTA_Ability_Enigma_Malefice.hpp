...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float tick_rate; // 0x5b8            
            std::int32_t stun_instances; // 0x5bc            
            float m_flDuration; // 0x5c0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Enigma_Malefice) == 0x5c8);
    };
};
