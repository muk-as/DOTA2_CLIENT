...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t familiar_speed; // 0x17f8            
            std::int32_t m_nFXIndex; // 0x17fc            
            std::int32_t m_nFXIndexB; // 0x1800            
            uint8_t _pad1804[0x4]; // 0x1804
            source2sdk::server::CountdownTimer m_ctTimer; // 0x1808            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Visage_SummonFamiliars_DamageCharge) == 0x1820);
    };
};
