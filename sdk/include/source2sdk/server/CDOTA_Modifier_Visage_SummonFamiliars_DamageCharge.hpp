...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t familiar_speed; // 0x_            
            std::int32_t m_nFXIndex; // 0x_            
            std::int32_t m_nFXIndexB; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Visage_SummonFamiliars_DamageCharge) == 0x_);
    };
};
