...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t mana_drain; // 0x188c            
            float m_flIntervalRate; // 0x1890            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1894            
            bool m_bBlasted; // 0x1898            
            uint8_t _pad1899[0x3]; // 0x1899
            float post_gaze_debuff_duration_multiplier; // 0x189c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Lich_Sinister_Gaze because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lich_Sinister_Gaze) == 0x18a0);
    };
};
