...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t mana_drain; // 0x17fc            
            float m_flIntervalRate; // 0x1800            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1804            
            bool m_bBlasted; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lich_Sinister_Gaze) == 0x1810);
    };
};
