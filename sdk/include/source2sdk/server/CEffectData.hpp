...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CEffectData, m_vOrigin) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_vStart) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_vNormal) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_vAngles) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_hEntity) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_hOtherEntity) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_flScale) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_flMagnitude) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_flRadius) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nSurfaceProp) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nEffectIndex) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nDamageType) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nPenetrate) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nMaterial) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nHitBox) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nColor) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_fFlags) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nAttachmentIndex) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nAttachmentName) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_iEffectName) == 0x_);
        static_assert(offsetof(source2sdk::server::CEffectData, m_nExplosionType) == 0x_);
        
        static_assert(sizeof(source2sdk::server::CEffectData) == 0x_);
    };
};
