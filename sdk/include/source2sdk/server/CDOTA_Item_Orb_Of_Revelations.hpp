...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::server::CountdownTimer m_ViewerTimer; // 0x688            
            std::int32_t m_iProjectile; // 0x6a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Item_Orb_Of_Revelations) == 0x6a8);
    };
};
