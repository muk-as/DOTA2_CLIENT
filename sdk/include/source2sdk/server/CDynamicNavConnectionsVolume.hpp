...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CUtlSymbolLarge m_iszConnectionTarget; // 0x_            
            ...
            char m_vecConnections[0x_]; // 0x_            
            CGlobalSymbol m_sTransitionType; // 0x_            
            bool m_bConnectionsEnabled; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            float m_flTargetAreaSearchRadius; // 0x_            
            float m_flUpdateDistance; // 0x_            
            float m_flMaxConnectionDistance; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDynamicNavConnectionsVolume because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDynamicNavConnectionsVolume) == 0x_);
    };
};
