...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float shadow_wave_cdr; // 0x17f8            
            float healing_amp; // 0x17fc            
            source2sdk::entity2::GameTime_t m_flLastThinkTime; // 0x1800            
            float leash_start; // 0x1804            
            float base_leash_pull; // 0x1808            
            float leash_increase; // 0x180c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_NothlProjection_SoulClone) == 0x1818);
    };
};
