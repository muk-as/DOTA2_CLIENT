...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bPlayerFireOnly; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::entity2::CEntityIOOutput m_OnDetectedBulletFire; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CTriggerDetectBulletFire because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CTriggerDetectBulletFire) == 0x_);
    };
};
