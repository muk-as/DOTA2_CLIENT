...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Aghsfort_Elemental_Wisp_Tether : public server::CDOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Ability_Aghsfort_Elemental_Wisp_Tether) == 0x5d0);
};
