...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bFoundUnit; // 0x18b1            
            uint8_t _pad18b2[0x2]; // 0x18b2
            std::int32_t pounce_distance; // 0x18b4            
            std::int32_t pounce_distance_scepter; // 0x18b8            
            float pounce_speed; // 0x18bc            
            float pounce_acceleration; // 0x18c0            
            std::int32_t pounce_radius; // 0x18c4            
            std::int32_t pounce_damage; // 0x18c8            
            float leash_duration; // 0x18cc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Slark_Pounce because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Slark_Pounce) == 0x18d0);
    };
};
