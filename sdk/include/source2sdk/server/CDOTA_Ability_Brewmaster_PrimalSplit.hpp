...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hFourth[0x4]; // 0x5d4        
        entity2::GameTime_t m_fHurlBoulder_CooldownTime; // 0x5d8        
        entity2::GameTime_t m_fHDispelMagic_CooldownTime; // 0x5dc        
        entity2::GameTime_t m_fCyclone_CooldownTime; // 0x5e0        
        entity2::GameTime_t m_fWindWalk_CooldownTime; // 0x5e4        
        entity2::GameTime_t m_fAstralPulse_CooldownTime; // 0x5e8        
    ...
    static_assert(sizeof(CDOTA_Ability_Brewmaster_PrimalSplit) == 0x5f0);
};
