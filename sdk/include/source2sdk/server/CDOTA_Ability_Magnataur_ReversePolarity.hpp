...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vPullLocation; // 0x5bc            
            float push_radius; // 0x5c8            
            float max_knockback_distance; // 0x5cc            
            float pull_radius; // 0x5d0            
            float flEffectRadius; // 0x5d4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Magnataur_ReversePolarity because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Magnataur_ReversePolarity) == 0x5d8);
    };
};
