...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vPullLocation; // 0x5c4            
            float push_radius; // 0x5d0            
            float max_knockback_distance; // 0x5d4            
            float pull_radius; // 0x5d8            
            float flEffectRadius; // 0x5dc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Magnataur_ReversePolarity because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Magnataur_ReversePolarity) == 0x5e0);
    };
};
