...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float whirling_radius; // 0x5b8            
            std::int32_t whirling_damage; // 0x5bc            
            float whirling_tick; // 0x5c0            
            float duration; // 0x5c4            
            std::int32_t tree_damage_scale; // 0x5c8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Shredder_WhirlingDeath) == 0x5d0);
    };
};
