...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float radius; // 0x_            
            float rock_search_aoe; // 0x_            
            float unit_distance; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_EarthSpirit_BoulderSmash) == 0x_);
    };
};
