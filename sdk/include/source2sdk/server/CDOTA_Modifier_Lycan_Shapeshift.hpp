...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float kill_duration_extension; // 0x188c            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1890            
            std::int32_t m_iOriginalAttackCapability; // 0x1894            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Lycan_Shapeshift because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lycan_Shapeshift) == 0x1898);
    };
};
