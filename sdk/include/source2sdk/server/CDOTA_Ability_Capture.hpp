...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Capture : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            source2sdk::client::CDOTA_Buff* m_pMyBuff; // 0x5c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Capture because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Capture) == 0x5c8);
    };
};
