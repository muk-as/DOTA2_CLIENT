...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CHandle<source2sdk::server::CBaseEntity> m_hMinion;
            char m_hMinion[0x4]; // 0x1878            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Miniboss_Minion_Summoner_Buff) == 0x1880);
    };
};
