...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_VindicatorsAxe : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
            std::int32_t bonus_attack_speed; // 0x17f8            
            std::int32_t bonus_damage; // 0x17fc            
            std::int32_t bonus_armor; // 0x1800            
            std::int32_t bonus_slow_resist; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_VindicatorsAxe) == 0x1810);
    };
};
