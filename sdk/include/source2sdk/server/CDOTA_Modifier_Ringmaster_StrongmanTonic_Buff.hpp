...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float effect_strength_max_duration; // 0x188c            
            float strength_bonus; // 0x1890            
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x1894            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Ringmaster_StrongmanTonic_Buff) == 0x1898);
    };
};
