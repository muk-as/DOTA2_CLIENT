...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float interval_scepter; // 0x1888            
            bool bInBufferTime; // 0x188c            
            uint8_t _pad188d[0x3]; // 0x188d
            std::int32_t damage; // 0x1890            
            source2sdk::entity2::GameTime_t m_flLastApplyTime; // 0x1894            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Mirana_Starfall_Scepter_Thinker) == 0x1898);
    };
};
