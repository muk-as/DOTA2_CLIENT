...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nWardIndex; // 0x_            
            float m_flPositioningAngle; // 0x_            
            float m_flTargetPreviousYaw; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Venomancer_Plague_Carrier) == 0x_);
    };
};
