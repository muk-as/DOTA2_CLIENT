...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CHandle<source2sdk::server::CDOTA_BaseNPC> m_hAttachTarget;
            char m_hAttachTarget[0x4]; // 0x17f8            
            std::int32_t m_nWardIndex; // 0x17fc            
            float m_flPositioningAngle; // 0x1800            
            float m_flTargetPreviousYaw; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Venomancer_Plague_Carrier) == 0x1810);
    };
};
