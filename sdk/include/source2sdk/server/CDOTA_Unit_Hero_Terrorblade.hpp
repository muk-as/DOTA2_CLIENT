...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad1ed4[0x4]; // 0x1ed4
            CUtlString m_szResponseCriteria; // 0x1ed8            
            // metadata: MNetworkEnable
            std::uint32_t m_nArcanaColor; // 0x1ee0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_Terrorblade) == 0x1ee8);
    };
};
