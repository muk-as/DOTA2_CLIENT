...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Warlock_Shadow_Word : public client::CDOTA_Buff
    {
    public:
        float tick_interval; // 0x16e8        
        int32_t damage; // 0x16ec        
        int32_t shard_movement_speed_pct; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Warlock_Shadow_Word) == 0x1700);
};
