...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t tick_count; // 0x1878            
            std::int32_t beam_radius; // 0x187c            
            std::int32_t m_nTickCount; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Nian_EruptionPendingThinker) == 0x1898);
    };
};
