...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Bloodseeker_Thirst) == 0x_);
    };
};
