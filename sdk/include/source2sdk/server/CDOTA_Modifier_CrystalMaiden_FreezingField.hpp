...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hHitHeroes[0x18]; // 0x1860            
            bool m_bHitInvisibleHero; // 0x1878            
            bool m_bColdComfortActive; // 0x1879            
            uint8_t _pad187a[0x2]; // 0x187a
            std::int32_t can_move; // 0x187c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_CrystalMaiden_FreezingField because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_CrystalMaiden_FreezingField) == 0x1880);
    };
};
