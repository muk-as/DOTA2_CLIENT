...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float spell_amplification_per_level; // 0x_            
            float damage_reflected_to_self; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_QueenOfPain_Masochist) == 0x_);
    };
};
