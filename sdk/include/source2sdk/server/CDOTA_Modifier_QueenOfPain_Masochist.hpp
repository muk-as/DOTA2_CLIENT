...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float spell_amplification_per_level; // 0x17fc            
            float damage_reflected_to_self; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_QueenOfPain_Masochist) == 0x1808);
    };
};
