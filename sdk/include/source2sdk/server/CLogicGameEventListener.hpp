...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::CEntityIOOutput m_OnEventFired; // 0x_            
            CUtlSymbolLarge m_iszGameEventName; // 0x_            
            CUtlSymbolLarge m_iszGameEventItem; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CLogicGameEventListener) == 0x_);
    };
};
