...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Seasonal_TI9_Banner : public server::CDOTABaseAbility
    {
    public:
