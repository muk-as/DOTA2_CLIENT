...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t stacks_per_hero_attack; // 0x1800            
            source2sdk::entity2::GameTime_t m_flStackDieTime; // 0x1804            
            source2sdk::client::ParticleIndex_t m_pFXIndex[4]; // 0x1808            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Shredder_Reactive_Armor because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shredder_Reactive_Armor) == 0x1818);
    };
};
