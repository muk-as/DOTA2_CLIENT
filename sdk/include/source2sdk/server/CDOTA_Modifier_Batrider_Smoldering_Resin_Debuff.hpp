...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t tick_attack_damage_pct; // 0x1800            
            std::int32_t total_ticks; // 0x1804            
            ...
            char m_nDamageQueue[0x18]; // 0x1808            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Batrider_Smoldering_Resin_Debuff) == 0x1820);
    };
};
