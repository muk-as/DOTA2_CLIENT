...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t tick_attack_damage_pct; // 0x1710        
        int32_t total_ticks; // 0x1714        
        ...
        char m_nDamageQueue[0x18]; // 0x1718        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Batrider_Smoldering_Resin_Debuff) == 0x1730);
};
