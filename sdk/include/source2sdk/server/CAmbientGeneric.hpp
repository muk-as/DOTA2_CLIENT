...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::soundsystem::soundlevel_t m_iSoundLevel; // 0x4e0            
            source2sdk::server::dynpitchvol_t m_dpv; // 0x4e4            
            bool m_fActive; // 0x548            
            bool m_fLooping; // 0x549            
            uint8_t _pad054a[0x6]; // 0x54a
        ...
        static_assert(sizeof(source2sdk::server::CAmbientGeneric) == 0x570);
    };
};
