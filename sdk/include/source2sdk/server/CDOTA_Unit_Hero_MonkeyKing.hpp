...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::uint32_t m_nTreeDisguise; // 0x1ef0            
            // metadata: MNetworkEnable
            std::uint32_t m_nPerchedTree; // 0x1ef4            
            Vector m_vLastPos; // 0x1ef8            
            bool m_bIsOnCloud; // 0x1f04            
            uint8_t _pad1f05[0x3]; // 0x1f05
            float m_fTotalDistOnCloud; // 0x1f08            
            float m_fTotalDistoffCloud; // 0x1f0c            
            float m_fBackOnCloudThresh; // 0x1f10            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_MonkeyKing) == 0x1f18);
    };
};
