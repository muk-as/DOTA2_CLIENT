...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hWard[0x4]; // 0x5c0            
            std::int32_t bonus_accuracy; // 0x5c4            
            std::int32_t m_iDamage; // 0x5c8            
            std::int32_t m_iBounceRadius; // 0x5cc            
            std::int32_t m_iProjectileSpeed; // 0x5d0            
            source2sdk::entity2::GameTime_t m_fWardExpireTime; // 0x5d4            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_WitchDoctor_DeathWard) == 0x5f8);
    };
};
