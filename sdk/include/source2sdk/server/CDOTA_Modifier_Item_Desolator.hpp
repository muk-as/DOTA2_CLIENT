...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Desolator : public server::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_damage; // 0x1708        
        int32_t bonus_damage_per_kill; // 0x170c        
        int32_t bonus_damage_per_assist; // 0x1710        
        int32_t max_damage; // 0x1714        
        float corruption_duration; // 0x1718        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Desolator) == 0x1738);
};
