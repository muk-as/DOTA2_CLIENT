...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CHandle<source2sdk::server::CDOTABaseAbility> m_hSummonFamiliarsSourceAbility;
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Visage_Familiar_Innate) == 0x1880);
    };
};
