...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Ballista : public server::CDOTA_Buff_Item
    {
    public:
        int32_t attack_range_bonus; // 0x16e8        
        float knockback_distance; // 0x16ec        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Ballista) == 0x16f8);
};
