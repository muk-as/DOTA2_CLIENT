...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Sand_King_Scorpion_Strike : public server::CDOTABaseAbility
    {
    public:
        ...
        // CUtlVector<CHandle<server::CBaseEntity>> hEntitiesToIgnore;
        char hEntitiesToIgnore[0x18]; // 0x5a0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Ability_Sand_King_Scorpion_Strike because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Ability_Sand_King_Scorpion_Strike) == 0x5b8);
};
