...
namespace source2sdk::server
{
    ...
    public:
        ...
        float knockback_distance; // 0x16fc        
        float knockback_duration; // 0x1700        
        float effective_distance; // 0x1704        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Huskar_Inner_Fire_Knockback because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Huskar_Inner_Fire_Knockback) == 0x1708);
};
