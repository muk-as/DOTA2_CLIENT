...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char hMegameepoFrame[0x4]; // 0x5bc            
            ...
            char hListOfMeepos[0x18]; // 0x5c0            
            bool m_bHasSwappedAbilities; // 0x5d8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Meepo_MegaMeepo) == 0x5e0);
    };
};
