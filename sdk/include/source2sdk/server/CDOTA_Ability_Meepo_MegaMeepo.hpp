...
namespace source2sdk::server
{
    ...
    public:
        ...
        char hMegameepoFrame[0x4]; // 0x5cc        
        ...
        char hListOfMeepos[0x18]; // 0x5d0        
        bool m_bHasSwappedAbilities; // 0x5e8        
    ...
    static_assert(sizeof(CDOTA_Ability_Meepo_MegaMeepo) == 0x5f0);
};
