...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnArrivedAt; // 0x_            
            source2sdk::server::RotatorTargetSpace_t m_eSpace; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CRotatorTarget) == 0x_);
    };
};
