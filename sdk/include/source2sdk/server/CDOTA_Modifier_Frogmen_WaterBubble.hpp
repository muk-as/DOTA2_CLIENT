...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float heal_pct; // 0x1894            
            source2sdk::entity2::GameTime_t m_flLastTickTime; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Frogmen_WaterBubble) == 0x18a0);
    };
};
