...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t heal_reduction_pct; // 0x188c            
            float heal_regen_to_damage; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Necrolyte_Heartstopper_Aura_Effect) == 0x1898);
    };
};
