...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Primal_Companion : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            // CHandle<source2sdk::server::CDOTA_BaseNPC> m_hCurrentBrewling;
            char m_hCurrentBrewling[0x4]; // 0x5c0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Primal_Companion) == 0x5c8);
    };
};
