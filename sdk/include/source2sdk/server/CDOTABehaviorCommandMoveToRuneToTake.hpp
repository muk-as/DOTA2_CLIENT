...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CDOTABehaviorCommandMoveToRuneToTake, m_MoveTo) == 0x68);
        static_assert(offsetof(source2sdk::server::CDOTABehaviorCommandMoveToRuneToTake, m_hRune) == 0x148);
        
        static_assert(sizeof(source2sdk::server::CDOTABehaviorCommandMoveToRuneToTake) == 0x150);
    };
};
