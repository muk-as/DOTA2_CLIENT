...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float damage_reduction; // 0x5c8            
            float damage_reduction_duration; // 0x5cc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_VengefulSpirit_Nether_Swap because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_VengefulSpirit_Nether_Swap) == 0x5d0);
    };
};
