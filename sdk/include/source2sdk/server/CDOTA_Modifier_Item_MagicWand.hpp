...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_MagicWand : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_MagicWand) == 0x1880);
    };
};
