...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::CSoundPatch* m_pSoundPatch; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::client::ParticleIndex_t m_nCurvePathFXIndex; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Puck_IllusoryOrb because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Puck_IllusoryOrb) == 0x_);
    };
};
