...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecAbilities[0x18]; // 0x1800            
            bool m_bUsesTwoSlots; // 0x1818            
            uint8_t _pad1819[0x3]; // 0x1819
            std::int32_t stolen_debuff_amp; // 0x181c            
            float stolen_mana_reduction; // 0x1820            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Rubick_SpellSteal) == 0x1828);
    };
};
