...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::TierNeutralInfo_t, m_nTier) == 0x_);
        static_assert(offsetof(source2sdk::server::TierNeutralInfo_t, m_nAbilityID) == 0x_);
        
        static_assert(sizeof(source2sdk::server::TierNeutralInfo_t) == 0x_);
    };
};
