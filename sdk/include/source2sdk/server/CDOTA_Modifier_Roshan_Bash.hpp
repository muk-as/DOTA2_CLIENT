...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t last_attack_time; // 0x1804            
            ...
            char m_ProcAttackRecords[0x18]; // 0x1808            
            source2sdk::entity2::GameTime_t apply_activity_modifier_until; // 0x1820            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Roshan_Bash) == 0x1828);
    };
};
