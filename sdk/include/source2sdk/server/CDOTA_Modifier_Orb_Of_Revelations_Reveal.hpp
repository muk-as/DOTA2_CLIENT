...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Orb_Of_Revelations_Reveal : public client::CDOTA_Buff
    {
    public:
        int32_t movespeed; // 0x16e8        
        bool m_bCastOnInvisibleHero; // 0x16ec        
    ...
    static_assert(sizeof(CDOTA_Modifier_Orb_Of_Revelations_Reveal) == 0x16f0);
};
