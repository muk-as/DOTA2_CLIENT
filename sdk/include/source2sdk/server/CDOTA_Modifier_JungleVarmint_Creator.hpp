...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CHandle<source2sdk::server::CBaseEntity> m_hVarmint;
            char m_hVarmint[0x4]; // 0x17f8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_JungleVarmint_Creator) == 0x1800);
    };
};
