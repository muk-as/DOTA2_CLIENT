...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t stun_radius; // 0x1890            
            float dive_distance; // 0x1894            
            float initial_rise_time; // 0x1898            
            float right_swipe_time; // 0x189c            
            float left_swipe_time; // 0x18a0            
            float knockdown_duration; // 0x18a4            
            float stun_duration; // 0x18a8            
            std::int32_t m_nTickCounter; // 0x18ac            
