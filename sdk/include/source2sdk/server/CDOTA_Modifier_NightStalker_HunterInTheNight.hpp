...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_movement_speed_pct_night; // 0x17f8            
            std::int32_t bonus_attack_speed_night; // 0x17fc            
            std::int32_t bonus_status_resist_night; // 0x1800            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1804            
            bool m_bIsDay; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_NightStalker_HunterInTheNight) == 0x1810);
    };
};
