...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t disable_vision; // 0x1880            
            float invisible_damage_pers; // 0x1884            
            float invisible_damage_tickrate; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_NightStalker_Void) == 0x1890);
    };
};
