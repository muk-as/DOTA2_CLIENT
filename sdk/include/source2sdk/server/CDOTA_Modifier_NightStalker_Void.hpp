...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t disable_vision; // 0x1710        
        float vision_penalty; // 0x1714        
        float invisible_damage_pers; // 0x1718        
        float invisible_damage_tickrate; // 0x171c        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_NightStalker_Void because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_NightStalker_Void) == 0x1720);
};
