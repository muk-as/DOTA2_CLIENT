...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecTrinketChoices) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecEnhancementChoices) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecSelectedTrinkets) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecSelectedEnhancements) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecTimesCrafted) == 0x_);
        
        static_assert(sizeof(source2sdk::server::PlayerNeutralChoices_t) == 0x_);
    };
};
