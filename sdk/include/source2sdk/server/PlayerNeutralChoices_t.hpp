...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecEnhancementChoices) == 0x6c);
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecSelectedTrinkets) == 0xd0);
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecSelectedEnhancements) == 0xe4);
        static_assert(offsetof(source2sdk::server::PlayerNeutralChoices_t, m_vecTimesCrafted) == 0xf8);
        
        static_assert(sizeof(source2sdk::server::PlayerNeutralChoices_t) == 0x110);
    };
};
