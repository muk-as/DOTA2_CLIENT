...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t pit_damage; // 0x_            
            float radius; // 0x_            
            float pit_interval; // 0x_            
            float ensnare_duration; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AbyssalUnderlord_PitOfMalice_Thinker) == 0x_);
    };
};
