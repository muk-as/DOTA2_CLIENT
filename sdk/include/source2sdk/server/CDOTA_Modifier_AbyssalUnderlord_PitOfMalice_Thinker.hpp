...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t pit_damage; // 0x17f8            
            float radius; // 0x17fc            
            float pit_interval; // 0x1800            
            float ensnare_duration; // 0x1804            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AbyssalUnderlord_PitOfMalice_Thinker) == 0x1808);
    };
};
