...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t pit_damage; // 0x1708        
        float radius; // 0x170c        
        float pit_interval; // 0x1710        
        float ensnare_duration; // 0x1714        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_AbyssalUnderlord_PitOfMalice_Thinker) == 0x1718);
};
