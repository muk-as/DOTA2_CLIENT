...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bHitInvisibleHeroes; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::client::ParticleIndex_t m_nMarkerIndex; // 0x_            
            bool m_bIsTrackingMissile; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Gyrocopter_Call_Down) == 0x_);
    };
};
