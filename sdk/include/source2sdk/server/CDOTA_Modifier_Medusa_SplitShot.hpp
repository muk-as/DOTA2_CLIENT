...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t damage_modifier; // 0x1878            
            std::int32_t range; // 0x187c            
            std::int32_t arrow_count; // 0x1880            
            std::int32_t projectile_speed; // 0x1884            
            source2sdk::client::ParticleIndex_t m_nSplitShotBowFXIndex; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Medusa_SplitShot) == 0x18c8);
    };
};
