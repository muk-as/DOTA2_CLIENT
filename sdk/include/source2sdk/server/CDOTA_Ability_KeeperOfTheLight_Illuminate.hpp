...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_fStartTime; // 0x5cc        
        int32_t m_iProjectile; // 0x5d0        
        client::ParticleIndex_t m_nFXIndex; // 0x5d4        
        client::ParticleIndex_t m_nFXIndexB; // 0x5d8        
        Vector m_vPos; // 0x5dc        
        int32_t total_damage; // 0x5e8        
        bool m_bStarted; // 0x5ec        
    ...
    static_assert(sizeof(CDOTA_Ability_KeeperOfTheLight_Illuminate) == 0x5f0);
};
