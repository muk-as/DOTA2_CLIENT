...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float frostbite_radius; // 0x1878            
            float anim_delay; // 0x187c            
            bool m_bActivated; // 0x1880            
            uint8_t _pad1881[0x3]; // 0x1881
            std::int32_t clone_health; // 0x1884            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Crystal_Maiden_Crystal_Clone_Statue) == 0x1890);
    };
};
