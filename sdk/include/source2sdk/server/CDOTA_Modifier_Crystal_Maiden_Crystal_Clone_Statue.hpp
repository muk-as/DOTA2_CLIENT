...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float frostbite_radius; // 0x_            
            float anim_delay; // 0x_            
            bool m_bActivated; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            std::int32_t clone_health; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Crystal_Maiden_Crystal_Clone_Statue) == 0x_);
    };
};
