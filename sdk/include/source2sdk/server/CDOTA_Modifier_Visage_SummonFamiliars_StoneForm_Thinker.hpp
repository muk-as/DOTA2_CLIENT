...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float stun_damage; // 0x_            
            float stun_delay; // 0x_            
            float stun_duration; // 0x_            
            float stone_duration; // 0x_            
            std::int32_t m_iIntervalCount; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Visage_SummonFamiliars_StoneForm_Thinker) == 0x_);
    };
};
