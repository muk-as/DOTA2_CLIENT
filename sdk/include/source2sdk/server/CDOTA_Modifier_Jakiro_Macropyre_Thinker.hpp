...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float path_radius; // 0x1898            
            float cast_range; // 0x189c            
            float linger_duration; // 0x18a0            
            bool m_bTestedGem; // 0x18a4            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Jakiro_Macropyre_Thinker) == 0x18a8);
    };
};
