...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_nActivityOverride; // 0x504        
        ...
        entity2::CEntityIOOutput m_OnAllUnitsKilled; // 0x528        
        entity2::CEntityIOOutput m_OnUnitKilled; // 0x550        
        entity2::CEntityIOOutput m_OnHealthLow; // 0x578        
    ...
    static_assert(sizeof(CDOTA_ScriptedSpawner) == 0x5c8);
};
