...
namespace source2sdk::server
{
    ...
    {
    public:
        client::ParticleIndex_t m_nSpellStartFXIndex; // 0x5c8        
        client::ParticleIndex_t m_nPhaseStartFXIndex; // 0x5cc        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Ability_Nyx_Assassin_Burrow because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Ability_Nyx_Assassin_Burrow) == 0x5d0);
};
