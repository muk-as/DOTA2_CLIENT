...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t poison_movement_speed_melee; // 0x_            
            std::int32_t poison_movement_speed_range; // 0x_            
            float poison_duration; // 0x_            
            float poison_damage; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Orb_of_Pestilence) == 0x_);
    };
};
