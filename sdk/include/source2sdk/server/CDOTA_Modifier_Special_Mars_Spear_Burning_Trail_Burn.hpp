...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t shard_dps; // 0x17f8            
            std::int32_t shard_move_slow_pct; // 0x17fc            
            float shard_interval; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Special_Mars_Spear_Burning_Trail_Burn) == 0x1808);
    };
};
