...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Medusa_VenomedVolley : public client::CDOTA_Buff
    {
    public:
        ...
        bool m_bLastPrimaryIsVenomed; // 0x1708        
    ...
    static_assert(sizeof(CDOTA_Modifier_Medusa_VenomedVolley) == 0x1710);
};
