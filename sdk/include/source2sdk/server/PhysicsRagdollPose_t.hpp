...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PhysicsRagdollPose_t, m_Transforms) == 0x_);
        static_assert(offsetof(source2sdk::server::PhysicsRagdollPose_t, m_hOwner) == 0x_);
        static_assert(offsetof(source2sdk::server::PhysicsRagdollPose_t, m_bSetFromDebugHistory) == 0x_);
        
        static_assert(sizeof(source2sdk::server::PhysicsRagdollPose_t) == 0x_);
    };
};
