...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CEconItemAttribute, m_iAttributeDefinitionIndex) == 0x_);
        static_assert(offsetof(source2sdk::server::CEconItemAttribute, m_flValue) == 0x_);
        
        static_assert(sizeof(source2sdk::server::CEconItemAttribute) == 0x_);
    };
};
