...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nMoveSlowPct; // 0x17f8            
            float m_fBurnDamagePerTick; // 0x17fc            
            std::int32_t move_slow_pct; // 0x1800            
            float burn_interval; // 0x1804            
            std::int32_t burn_damage; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Snapfire_Magma_Burn_Slow) == 0x1810);
    };
};
