...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nMoveSlowPct; // 0x1878            
            float m_fBurnDamagePerTick; // 0x187c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Snapfire_Magma_Burn_Slow) == 0x1890);
    };
};
