...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float move_speed_per_instance; // 0x_            
            std::int32_t attack_speed_per_instance; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Invoker_WexInstance) == 0x_);
    };
};
