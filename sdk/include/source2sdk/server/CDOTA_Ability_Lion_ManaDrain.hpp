...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Lion_ManaDrain : public source2sdk::server::CDOTABaseAbility
        {
        public:
