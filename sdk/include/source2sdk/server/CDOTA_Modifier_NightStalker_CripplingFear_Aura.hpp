...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x_            
            std::int32_t death_refresh; // 0x_            
            float mana_pct_cost; // 0x_            
            float mana_interval; // 0x_            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x_            
            float base_duration; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_NightStalker_CripplingFear_Aura) == 0x_);
    };
};
