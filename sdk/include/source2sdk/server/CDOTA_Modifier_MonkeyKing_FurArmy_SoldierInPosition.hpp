...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t outer_attack_buffer; // 0x_            
            // m_hThinker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hThinker;
            char m_hThinker[0x_]; // 0x_            
            bool m_bDisarmed; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::entity2::GameTime_t m_flNextAttackTime; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_MonkeyKing_FurArmy_SoldierInPosition) == 0x_);
    };
};
