...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t speed_penalty; // 0x1888            
            std::int32_t forward_angle; // 0x188c            
            float vuln_duration; // 0x1890            
            float parry_window_duration; // 0x1894            
            float parry_stun_duration; // 0x1898            
            ...
            char m_vecParriedEnemies[0x18]; // 0x18a0            
            Vector m_vFacing; // 0x18b8            
            float m_flFacingTarget; // 0x18c4            
            float m_flLastOverheadTime; // 0x18c8            
            ...
            char m_hVulnAttackTarget[0x4]; // 0x18d0            
            bool m_bAttackingVuln; // 0x18d4            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kez_ShodoSai_Parry) == 0x18d8);
    };
};
