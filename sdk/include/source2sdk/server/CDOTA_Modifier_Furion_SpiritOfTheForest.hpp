...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t damage_per_tree_pct; // 0x16e8        
        int32_t radius; // 0x16ec        
        float multiplier; // 0x16f0        
        int32_t radius_treant; // 0x16f4        
        int32_t m_nTreeAmount; // 0x16f8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Furion_SpiritOfTheForest) == 0x1700);
};
