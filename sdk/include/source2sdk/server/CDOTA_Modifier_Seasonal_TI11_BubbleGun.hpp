...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float think_interval; // 0x17f8            
            std::int32_t max_charges; // 0x17fc            
            std::int32_t m_nChargesUsed; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_TI11_BubbleGun) == 0x1808);
    };
};
