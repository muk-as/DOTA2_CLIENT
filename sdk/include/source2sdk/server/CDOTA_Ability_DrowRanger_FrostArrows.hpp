...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t shard_burst_damage_per_stack; // 0x5b8            
            float shard_burst_slow_duration; // 0x5bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_DrowRanger_FrostArrows because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_DrowRanger_FrostArrows) == 0x5c0);
    };
};
