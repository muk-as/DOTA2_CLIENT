...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hThinker[0x4]; // 0x16e8        
        client::ParticleIndex_t m_nFissureEffectIndex; // 0x16ec        
        int32_t m_nViewerID; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Earthshaker_Spirit_Cairn) == 0x16f8);
};
