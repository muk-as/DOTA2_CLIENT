...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFissureEffectIndex; // 0x188c            
            std::int32_t m_nViewerID; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Earthshaker_Spirit_Cairn) == 0x1898);
    };
};
