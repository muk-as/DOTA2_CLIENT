...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t perched_jump_distance; // 0x5c0            
            std::int32_t ground_jump_distance; // 0x5c4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_MonkeyKing_TreeDance because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_MonkeyKing_TreeDance) == 0x5c8);
    };
};
