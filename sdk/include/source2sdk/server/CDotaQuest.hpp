...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nQuestType; // 0x6e0            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_pnTextReplaceValuesCDotaQuest[4]; // 0x808            
            // metadata: MNetworkEnable
            char m_pszTextReplaceString[64]; // 0x818            
            // metadata: MNetworkEnable
            std::int32_t m_nTextReplaceValueVersion; // 0x858            
            std::int32_t m_nQuestCompleteFadeAlpha; // 0x85c            
        ...
        static_assert(sizeof(source2sdk::server::CDotaQuest) == 0x960);
    };
};
