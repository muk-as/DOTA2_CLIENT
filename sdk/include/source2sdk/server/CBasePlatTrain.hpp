...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_volume; // 0x840            
            float m_flTWidth; // 0x844            
            float m_flTLength; // 0x848            
            uint8_t _pad084c[0x4];
            
            // Datamap fields:
            // void m_pMovementSound; // 0x838
        ...
        static_assert(sizeof(source2sdk::server::CBasePlatTrain) == 0x850);
    };
};
