...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DamageLevelTakenByHitGroup[0x_]; // 0x_            
            // metadata: MNetworkEnable
        ...
        static_assert(offsetof(source2sdk::server::CDestructiblePartsSystemComponent, __m_pChainEntity) == 0x_);
        static_assert(offsetof(source2sdk::server::CDestructiblePartsSystemComponent, m_DamageLevelTakenByHitGroup) == 0x_);
        static_assert(offsetof(source2sdk::server::CDestructiblePartsSystemComponent, m_hOwner) == 0x_);
        static_assert(offsetof(source2sdk::server::CDestructiblePartsSystemComponent, m_nLastHitDamageLevel) == 0x_);
        
        static_assert(sizeof(source2sdk::server::CDestructiblePartsSystemComponent) == 0x_);
    };
};
