...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_AghsFort_Creature_Phoenix_Supernova : public source2sdk::server::CDOTABaseAbility
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_AghsFort_Creature_Phoenix_Supernova) == 0x5c0);
    };
};
