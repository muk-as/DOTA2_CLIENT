...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_AghsFort_Creature_Phoenix_Supernova : public server::CDOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Ability_AghsFort_Creature_Phoenix_Supernova) == 0x5a8);
};
