...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t trail_damage_per_second; // 0x1878            
            std::int32_t trail_damage_radius; // 0x187c            
