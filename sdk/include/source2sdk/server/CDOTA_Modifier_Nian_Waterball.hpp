...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t trail_damage_per_second; // 0x1708        
        int32_t trail_damage_radius; // 0x170c        
