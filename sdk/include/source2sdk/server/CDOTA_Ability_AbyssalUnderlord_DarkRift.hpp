...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_AbyssalUnderlord_DarkRift : public source2sdk::server::CDOTABaseAbility
        {
        public:
            float teleport_delay; // 0x5c0            
            ...
            char m_hTeleportTarget[0x4]; // 0x5c4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_AbyssalUnderlord_DarkRift because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_AbyssalUnderlord_DarkRift) == 0x5c8);
    };
};
