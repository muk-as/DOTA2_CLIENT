...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float cursed_damage; // 0x_            
            float cursed_damage_pct; // 0x_            
            float curse_cooldown; // 0x_            
            float curse_cooldown_creep; // 0x_            
            float curse_delay; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_SkeletonKing_SpectralBladeIntrinsic) == 0x_);
    };
};
