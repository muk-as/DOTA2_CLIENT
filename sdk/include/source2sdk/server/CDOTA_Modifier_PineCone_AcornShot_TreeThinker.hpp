...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_PineCone_AcornShot_TreeThinker : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_PineCone_AcornShot_TreeThinker) == 0x1710);
};
