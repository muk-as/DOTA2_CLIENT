...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float sidegunner_radius; // 0x17f8            
            float sidegunner_fire_rate; // 0x17fc            
            float m_flRotation; // 0x1800            
            ...
            char m_hIdealTarget[0x4]; // 0x1804            
            ...
            char m_hSecondaryTarget[0x4]; // 0x1808            
            float m_flLastFireTime; // 0x180c            
            ...
            char m_hOwningAbility[0x4]; // 0x1814            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Gyrocopter_Side_Gunner because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Gyrocopter_Side_Gunner) == 0x1818);
    };
};
