...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hOtherPortal[0x4]; // 0x18b4            
            Vector m_vStartPosition; // 0x18b8            
            float m_flTotalTime; // 0x18c4            
            float m_flElapsedTimePortion; // 0x18c8            
            float animation_rate; // 0x18cc            
            std::int32_t stop_distance; // 0x18d0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Underlord_Portal_Warp_Channel) == 0x18d8);
    };
};
