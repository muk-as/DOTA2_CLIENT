...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hOtherPortal[0x4]; // 0x1728        
        Vector m_vStartPosition; // 0x172c        
        float m_flTotalTime; // 0x1738        
        float m_flElapsedTimePortion; // 0x173c        
        float animation_rate; // 0x1740        
        int32_t stop_distance; // 0x1744        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Underlord_Portal_Warp_Channel) == 0x1748);
};
