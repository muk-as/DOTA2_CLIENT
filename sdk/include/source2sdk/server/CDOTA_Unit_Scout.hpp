...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flRespawnTime; // 0x18c0            
            // metadata: MNetworkEnable
            source2sdk::client::ScoutState_t m_nScoutState; // 0x18c4            
            // metadata: MNetworkEnable
            ...
            char m_hScoutStateEntity[0x4]; // 0x18c8            
            uint8_t _pad18cc[0x4]; // 0x18cc
            CUtlString m_strScoutModel; // 0x18d0            
            Vector m_vSpawnLocation; // 0x18d8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Scout) == 0x18e8);
    };
};
