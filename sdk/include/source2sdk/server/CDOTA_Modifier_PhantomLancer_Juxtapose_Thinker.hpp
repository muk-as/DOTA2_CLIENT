...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t scepter_bonus_illusions; // 0x_            
            ...
            std::int32_t m_iIllusionsSoFar; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_PhantomLancer_Juxtapose_Thinker) == 0x_);
    };
};
