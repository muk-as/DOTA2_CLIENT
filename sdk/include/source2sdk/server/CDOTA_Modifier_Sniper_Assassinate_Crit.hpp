...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t scepter_crit_damage; // 0x1888            
            std::int32_t scatter_damage_pct; // 0x188c            
            bool is_secondary; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Sniper_Assassinate_Crit) == 0x1898);
    };
};
