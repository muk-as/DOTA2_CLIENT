...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t scepter_crit_damage; // 0x17f8            
            std::int32_t scatter_damage_pct; // 0x17fc            
            bool is_secondary; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Sniper_Assassinate_Crit) == 0x1808);
    };
};
