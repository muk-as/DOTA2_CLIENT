...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t incoming_hero_damage_penalty; // 0x_            
            std::int32_t incoming_basic_damage_penalty; // 0x_            
            std::int32_t incoming_controlled_unit_penalty; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Creep_Siege because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Creep_Siege) == 0x_);
    };
};
