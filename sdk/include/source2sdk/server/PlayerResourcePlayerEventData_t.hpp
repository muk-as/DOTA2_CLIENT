...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iEventID) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iEventLevel) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iEventPoints) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iEventPremiumPoints) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iEventEffectsMask) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_bIsEventOwned) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iFavoriteTeam) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iFavoriteTeamQuality) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iAvailableSalutes) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iSaluteAmountIndex) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iEventWagerStreak) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iEventTeleportFXLevel) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_nCandyPointsReason) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_vecPeriodicResources) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteSaluteAmounts) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteEventArcanaPeriodicResourceRemaining) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteEventArcanaPeriodicResourceMax) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteEventWagerTokensRemaining) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteEventWagerTokensMax) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteEventBountiesRemaining) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteRankWagersAvailable) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteRankWagersMax) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteEventPointAdjustmentsRemaining) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerEventData_t, m_iObsoleteEventRanks) == 0x_);
        
        static_assert(sizeof(source2sdk::server::PlayerResourcePlayerEventData_t) == 0x_);
    };
};
