...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t berserk_bonus_armor; // 0x16f0        
        int32_t hp_regen; // 0x16f4        
        int32_t reflection_pct; // 0x16f8        
        int32_t melee_bonus; // 0x16fc        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Terrorblade_Demon_Zeal because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Terrorblade_Demon_Zeal) == 0x1700);
};
