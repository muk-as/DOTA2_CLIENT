...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::PlayerID_t m_nOriginalControllingUnit; // 0x_            
            bool m_bUnitWasLaunched; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            float max_time_in_belly; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Snapfire_GobbleUp_BellyHasUnit) == 0x_);
    };
};
