...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float double_shot_chance; // 0x_            
            float target_search_bonus_range; // 0x_            
            std::int32_t bonus_damage; // 0x_            
            float dead_shot_cooldown_reduction_on_proc; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Muerta_Gunslinger) == 0x_);
    };
};
