...
namespace source2sdk::server
{
    ...
    {
    public:
        float double_shot_chance; // 0x16e8        
        float target_search_bonus_range; // 0x16ec        
