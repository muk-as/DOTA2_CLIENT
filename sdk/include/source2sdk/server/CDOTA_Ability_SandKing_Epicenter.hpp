...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXEpicenterIndex; // 0x5b8            
            std::int32_t m_iExplosionQuadrant; // 0x5bc            
            std::int32_t m_iExplosionDistance; // 0x5c0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_SandKing_Epicenter) == 0x5c8);
    };
};
