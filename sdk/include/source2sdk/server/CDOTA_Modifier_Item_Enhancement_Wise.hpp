...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bonus_xpm; // 0x1888            
            float max_mana_pct; // 0x188c            
            float m_flExperiencePerSecond; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Enhancement_Wise) == 0x1898);
    };
};
