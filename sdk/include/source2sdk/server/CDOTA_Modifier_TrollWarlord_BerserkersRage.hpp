...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_hp_pct; // 0x17fc            
            std::int32_t bonus_armor; // 0x1800            
            std::int32_t ensnare_chance; // 0x1804            
            float ensnare_duration; // 0x1808            
            std::int32_t maim_chance; // 0x180c            
            std::int32_t maim_damage; // 0x1810            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TrollWarlord_BerserkersRage) == 0x1818);
    };
};
