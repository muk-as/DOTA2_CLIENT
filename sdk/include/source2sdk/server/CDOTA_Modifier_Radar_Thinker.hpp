...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bEverFound; // 0x188c            
            bool m_bBonus; // 0x188d            
            uint8_t _pad188e[0x2]; // 0x188e
            source2sdk::client::ParticleIndex_t m_nScanParticleIndex; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Radar_Thinker) == 0x1898);
    };
};
