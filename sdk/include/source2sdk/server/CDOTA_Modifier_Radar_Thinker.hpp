...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bEverFound; // 0x17fc            
            bool m_bBonus; // 0x17fd            
            uint8_t _pad17fe[0x2]; // 0x17fe
            source2sdk::client::ParticleIndex_t m_nScanParticleIndex; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Radar_Thinker) == 0x1808);
    };
};
