...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Hurricane_Pike_Range : public client::CDOTA_Buff
    {
    public:
        // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CHandle<server::CBaseEntity> m_hTarget;
        char m_hTarget[0x4]; // 0x16e8        
        int32_t max_attacks; // 0x16ec        
        int32_t m_iNumAttacks; // 0x16f0        
        bool bActive; // 0x16f4        
    ...
    static_assert(sizeof(CDOTA_Modifier_Hurricane_Pike_Range) == 0x1700);
};
