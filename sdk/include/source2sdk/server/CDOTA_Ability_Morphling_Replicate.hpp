...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Morphling_Replicate : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char m_hScepterIllusion[0x4]; // 0x5bc            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Morphling_Replicate) == 0x5c8);
    };
};
