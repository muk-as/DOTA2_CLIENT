...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Medusa_Mystic_Snake_AttackBuff : public client::CDOTA_Buff
    {
    public:
        int32_t m_nProcDamage; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Medusa_Mystic_Snake_AttackBuff) == 0x1708);
};
