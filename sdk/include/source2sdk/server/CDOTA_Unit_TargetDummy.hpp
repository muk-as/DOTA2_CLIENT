...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flDamageTaken; // 0x1f18            
            // metadata: MNetworkEnable
            float m_flLastHit; // 0x1f1c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartDamageTime; // 0x1f20            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flLastTargetDummyDamageTime; // 0x1f24            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Unit_TargetDummy because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_TargetDummy) == 0x1f28);
    };
};
