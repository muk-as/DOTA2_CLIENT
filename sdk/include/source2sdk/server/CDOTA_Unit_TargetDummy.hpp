...
namespace source2sdk::server
{
    ...
    public:
        ...
        float m_flDamageTaken; // 0x1ec8        
        // metadata: MNetworkEnable
        float m_flLastHit; // 0x1ecc        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flStartDamageTime; // 0x1ed0        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flLastTargetDummyDamageTime; // 0x1ed4        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Unit_TargetDummy because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Unit_TargetDummy) == 0x1ed8);
};
