...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Legion_Commander_PressTheAttack_Immunity : public server::CDOTA_Modifier_DebuffImmune
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Legion_Commander_PressTheAttack_Immunity) == 0x1710);
};
