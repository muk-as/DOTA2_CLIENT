...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t fiend_grip_mana_drain; // 0x17f8            
            float fiend_grip_tick_interval; // 0x17fc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Bane_FiendsGrip because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Bane_FiendsGrip) == 0x1800);
    };
};
