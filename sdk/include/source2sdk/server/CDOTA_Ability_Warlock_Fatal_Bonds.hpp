...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Warlock_Fatal_Bonds : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char m_FatalBondsEntities[0x18]; // 0x5b8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Warlock_Fatal_Bonds because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Warlock_Fatal_Bonds) == 0x5d0);
    };
};
