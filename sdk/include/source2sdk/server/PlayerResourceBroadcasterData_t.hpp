...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerResourceBroadcasterData_t, m_iszBroadcasterChannelDescription) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourceBroadcasterData_t, m_iszBroadcasterChannelCountryCode) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourceBroadcasterData_t, m_iszBroadcasterChannelLanguageCode) == 0x_);
        
        static_assert(sizeof(source2sdk::server::PlayerResourceBroadcasterData_t) == 0x_);
    };
};
