...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecGlowingPlayerIDs[0x18]; // 0x1888            
            ...
            char m_vecGlowingPlayerIDs2[0x18]; // 0x18a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_HallOfFame_Glow because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_HallOfFame_Glow) == 0x18b8);
    };
};
