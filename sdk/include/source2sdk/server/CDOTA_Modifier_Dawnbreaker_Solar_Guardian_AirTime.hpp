...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vCurrentTargetPosition; // 0x_            
            Vector m_vDesiredTargetPosition; // 0x_            
            Vector m_vStartPosition; // 0x_            
            std::int32_t airtime_scepter_movement_speed; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dawnbreaker_Solar_Guardian_AirTime) == 0x_);
    };
};
