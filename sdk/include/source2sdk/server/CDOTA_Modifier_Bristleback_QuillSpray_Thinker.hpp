...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t projectile_speed; // 0x18c0            
            float radius; // 0x18c4            
            bool m_bTriggeredByBristleback; // 0x18c8            
            bool m_bDelayed; // 0x18c9            
            uint8_t _pad18ca[0x2]; // 0x18ca
            std::int32_t m_nAngleRestriction; // 0x18cc            
            Vector m_vFacing; // 0x18d0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Bristleback_QuillSpray_Thinker) == 0x18e0);
    };
};
