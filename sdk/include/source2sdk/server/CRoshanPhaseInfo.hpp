...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CRoshanPhaseInfo, m_eRoshanPhase) == 0x8);
        static_assert(offsetof(source2sdk::server::CRoshanPhaseInfo, m_flRoshanPhaseStartTime) == 0xc);
        static_assert(offsetof(source2sdk::server::CRoshanPhaseInfo, m_flRoshanPhaseEndTime) == 0x10);
        
        static_assert(sizeof(source2sdk::server::CRoshanPhaseInfo) == 0x18);
    };
};
