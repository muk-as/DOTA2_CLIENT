...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bTeamFirstCourier; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::entity2::GameTime_t m_nPlayerCommandTime[24]; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Track_Order_Issuer because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Track_Order_Issuer) == 0x_);
    };
};
