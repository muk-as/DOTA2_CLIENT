...
namespace source2sdk::server
{
    ...
    public:
        ...
        float vampiric_aura; // 0x170c        
        float creep_lifesteal_reduction_pct; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Skeleton_King_Innate_VampiricSpirit_Aura) == 0x1718);
};
