...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t allow_multiple; // 0x188c            
            std::int32_t m_nAttributes; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_ForestTrollHighPriest_ManaAura_Bonus) == 0x1898);
    };
};
