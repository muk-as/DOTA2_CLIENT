...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CBaseAnimatingOverlayController m_animationController; // 0x510            
        ...
        static_assert(sizeof(source2sdk::server::CBodyComponentBaseAnimatingOverlay) == 0xa50);
    };
};
