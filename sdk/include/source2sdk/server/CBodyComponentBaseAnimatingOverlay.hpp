...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CBaseAnimatingOverlayController m_animationController; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CBodyComponentBaseAnimatingOverlay) == 0x_);
    };
};
