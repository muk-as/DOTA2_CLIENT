...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Unit_Hero_PhantomAssassin : public source2sdk::server::CDOTA_BaseNPC_Hero
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_PhantomAssassin) == 0x1ed8);
    };
};
