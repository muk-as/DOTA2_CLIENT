...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CSpeechBubbleInfo, m_LocalizationStr) == 0x_);
        static_assert(offsetof(source2sdk::server::CSpeechBubbleInfo, m_hNPC) == 0x_);
        static_assert(offsetof(source2sdk::server::CSpeechBubbleInfo, m_flStartTime) == 0x_);
        static_assert(offsetof(source2sdk::server::CSpeechBubbleInfo, m_flDuration) == 0x_);
        static_assert(offsetof(source2sdk::server::CSpeechBubbleInfo, m_unOffsetX) == 0x_);
        static_assert(offsetof(source2sdk::server::CSpeechBubbleInfo, m_unOffsetY) == 0x_);
        static_assert(offsetof(source2sdk::server::CSpeechBubbleInfo, m_unCount) == 0x_);
        
        static_assert(sizeof(source2sdk::server::CSpeechBubbleInfo) == 0x_);
    };
};
