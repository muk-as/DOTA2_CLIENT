...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float root_duration; // 0x1878            
            std::int32_t damage_boost_stacks; // 0x187c            
            float damage_boost_duration; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lycan_SummonWolves_Hamstring) == 0x18a0);
    };
};
