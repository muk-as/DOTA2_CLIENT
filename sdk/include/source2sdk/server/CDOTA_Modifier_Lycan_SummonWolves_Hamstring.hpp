...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t damage_boost_stacks; // 0x_            
            float damage_boost_duration; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lycan_SummonWolves_Hamstring) == 0x_);
    };
};
