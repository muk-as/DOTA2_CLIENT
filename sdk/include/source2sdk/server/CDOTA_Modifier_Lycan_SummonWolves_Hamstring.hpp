...
namespace source2sdk::server
{
    ...
    {
    public:
        float root_duration; // 0x16e8        
        int32_t damage_boost_stacks; // 0x16ec        
        float damage_boost_duration; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Lycan_SummonWolves_Hamstring) == 0x1710);
};
