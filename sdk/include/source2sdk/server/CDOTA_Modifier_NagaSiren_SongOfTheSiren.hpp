...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flSongDuration; // 0x1888            
            float m_flSongStartTime; // 0x188c            
            float mana_pct; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_NagaSiren_SongOfTheSiren) == 0x1898);
    };
};
