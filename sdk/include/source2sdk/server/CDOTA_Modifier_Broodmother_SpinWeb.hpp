...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_movespeed_scepter; // 0x1880            
            float bonus_turn_rate; // 0x1884            
            float flLastDamageTime; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Broodmother_SpinWeb) == 0x1890);
    };
};
