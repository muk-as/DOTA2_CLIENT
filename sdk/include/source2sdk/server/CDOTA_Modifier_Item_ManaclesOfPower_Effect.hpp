...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float leash_distance; // 0x1800            
            float leash_limit_multiplier; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_ManaclesOfPower_Effect) == 0x1810);
    };
};
