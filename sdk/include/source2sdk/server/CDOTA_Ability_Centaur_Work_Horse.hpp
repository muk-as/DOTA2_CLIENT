...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Centaur_Work_Horse : public server::CDOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Ability_Centaur_Work_Horse) == 0x5a8);
};
