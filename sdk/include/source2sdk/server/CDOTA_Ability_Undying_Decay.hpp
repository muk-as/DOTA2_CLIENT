...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t decay_damage; // 0x5b8            
            float radius; // 0x5bc            
            float decay_duration; // 0x5c0            
            std::int32_t str_steal; // 0x5c4            
            float creep_damage_multiplier; // 0x5c8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Undying_Decay) == 0x5d0);
    };
};
