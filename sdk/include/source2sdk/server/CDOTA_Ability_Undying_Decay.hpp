...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t decay_damage; // 0x5c8        
        float radius; // 0x5cc        
        float decay_duration; // 0x5d0        
        int32_t str_steal; // 0x5d4        
        float creep_damage_multiplier; // 0x5d8        
    ...
    static_assert(sizeof(CDOTA_Ability_Undying_Decay) == 0x5e0);
};
