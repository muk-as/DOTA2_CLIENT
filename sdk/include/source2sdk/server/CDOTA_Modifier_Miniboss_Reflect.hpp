...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t passive_reflection_pct; // 0x1708        
        int32_t passive_reflection_bonus_per_death; // 0x170c        
        bool m_bIsDire; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Miniboss_Reflect) == 0x1718);
};
