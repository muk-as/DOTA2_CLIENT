...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flTotalAttributes; // 0x_            
            float m_flOriginalStrength; // 0x_            
            float m_flOriginalAgility; // 0x_            
            float m_flOriginalIntellect; // 0x_            
            bool m_bIgnoreInCalc; // 0x_            
            bool m_bCalculateStatBonus; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Bane_Ichor_Of_Nyctasha) == 0x_);
    };
};
