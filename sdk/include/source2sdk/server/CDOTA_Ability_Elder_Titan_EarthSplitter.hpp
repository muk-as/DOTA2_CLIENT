...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t crack_width; // 0x5c8        
        int32_t crack_distance; // 0x5cc        
        int32_t speed; // 0x5d0        
        int32_t vision_width; // 0x5d4        
        float crack_time; // 0x5d8        
    ...
    static_assert(sizeof(CDOTA_Ability_Elder_Titan_EarthSplitter) == 0x5e8);
};
