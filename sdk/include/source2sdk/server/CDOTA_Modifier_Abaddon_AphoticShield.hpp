...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t regen; // 0x_            
            std::int32_t m_nDamageAbsorbed; // 0x_            
            float absorb_to_damage; // 0x_            
            float absorb_damage_aoe; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Abaddon_AphoticShield) == 0x_);
    };
};
