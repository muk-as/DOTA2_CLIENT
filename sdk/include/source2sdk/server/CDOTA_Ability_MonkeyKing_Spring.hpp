...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            Vector m_vPos; // 0x5b8            
            source2sdk::entity2::GameTime_t m_fStartChannelTime; // 0x5c4            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_MonkeyKing_Spring) == 0x5d8);
    };
};
