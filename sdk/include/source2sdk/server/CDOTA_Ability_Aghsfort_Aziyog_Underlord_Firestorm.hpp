...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Aghsfort_Aziyog_Underlord_Firestorm : public source2sdk::server::CDOTABaseAbility
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Aghsfort_Aziyog_Underlord_Firestorm) == 0x5c0);
    };
};
