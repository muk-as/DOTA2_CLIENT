...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x17f8            
            std::int32_t ally_speed; // 0x17fc            
            float ally_armor; // 0x1800            
            float ally_healing; // 0x1804            
            float ally_buff_duration; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Invoker_IceWall_AllyBuffAura) == 0x1810);
    };
};
