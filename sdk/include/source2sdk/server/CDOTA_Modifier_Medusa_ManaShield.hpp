...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float absorption_pct; // 0x17fc            
            float damage_per_mana; // 0x1800            
            float damage_per_mana_per_level; // 0x1804            
            float illusion_percentage; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Medusa_ManaShield) == 0x1810);
    };
};
