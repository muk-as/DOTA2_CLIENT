...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_iPulseCount; // 0x1878            
            float radius; // 0x187c            
            std::int32_t total_damage; // 0x1880            
            std::int32_t total_pulses; // 0x1884            
            std::int32_t self_damage_pct; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Slark_DarkPact_Pulses) == 0x1890);
    };
};
