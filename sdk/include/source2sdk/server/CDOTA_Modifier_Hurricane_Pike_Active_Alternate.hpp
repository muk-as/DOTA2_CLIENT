...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Hurricane_Pike_Active_Alternate : public client::CDOTA_Buff
    {
    public:
        Vector m_vDirection; // 0x16e8        
        float m_flEndTime; // 0x16f4        
        float m_flCurTime; // 0x16f8        
        float enemy_length; // 0x16fc        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Hurricane_Pike_Active_Alternate) == 0x1700);
};
