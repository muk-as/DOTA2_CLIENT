...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSoundscape[0x4]; // 0x968            
            uint8_t _pad096c[0x4]; // 0x96c
            CUtlSymbolLarge m_SoundscapeName; // 0x970            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerSoundscape) == 0x990);
    };
};
