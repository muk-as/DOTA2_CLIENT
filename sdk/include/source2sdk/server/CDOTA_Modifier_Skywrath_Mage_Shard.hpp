...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t damage_barrier_base; // 0x17fc            
            std::int32_t damage_barrier_per_level; // 0x1800            
            float barrier_duration; // 0x1804            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Skywrath_Mage_Shard because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Skywrath_Mage_Shard) == 0x1808);
    };
};
