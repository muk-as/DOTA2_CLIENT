...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t magic_resistance_pct; // 0x1888            
            float magic_resistance_per_tick; // 0x188c            
            std::int32_t max_stacks; // 0x1890            
            float tick_rate; // 0x1894            
            std::int32_t m_nTickCount; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Elder_Titan_NaturalOrder_MagicResistance) == 0x18a0);
    };
};
