...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t curse_slow; // 0x188c            
            float curse_interval; // 0x1890            
            std::int32_t curse_dps; // 0x1894            
            std::int32_t tower_dps_pct; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Abaddon_Frostmourne_Debuff_Bonus) == 0x18a0);
    };
};
