...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t curse_slow; // 0x_            
            float curse_interval; // 0x_            
            std::int32_t curse_dps; // 0x_            
            std::int32_t tower_dps_pct; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Abaddon_Frostmourne_Debuff_Bonus) == 0x_);
    };
};
