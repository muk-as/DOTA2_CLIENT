...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t trigger_distance; // 0x_            
            std::int32_t push_length; // 0x_            
            float push_duration; // 0x_            
            std::int32_t cogs_radius; // 0x_            
            std::int32_t cogs_pullin; // 0x_            
            std::int32_t attacks_to_destroy; // 0x_            
            std::int32_t m_iCogIndex; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Rattletrap_Cog) == 0x_);
    };
};
