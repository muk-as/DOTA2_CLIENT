...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nHumHeroesHit; // 0x1858            
            bool m_bHitInvisibleHero; // 0x185c            
            uint8_t _pad185d[0x3];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Elder_Titan_EarthSplitter_Caster) == 0x1860);
    };
};
