...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t scepter_height; // 0x_            
            std::int32_t scepter_height_arcbuffer; // 0x_            
            std::int32_t scepter_acceleration_z; // 0x_            
            std::int32_t scepter_acceleration_horizontal; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Earthshaker_EnchantTotem_Leap) == 0x_);
    };
};
