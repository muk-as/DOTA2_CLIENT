...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Unit_Underlord_Portal : public source2sdk::server::CDOTA_BaseNPC_Building
        {
        public:
        ...
        // Cannot assert offsets of fields in CDOTA_Unit_Underlord_Portal because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Underlord_Portal) == 0x1a00);
    };
};
