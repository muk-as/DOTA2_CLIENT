...
namespace source2sdk::server
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Silver_Edge : public server::CDOTA_Buff_Item
    {
    public:
        ...
        int32_t crit_chance; // 0x1718        
        int32_t crit_multiplier; // 0x171c        
        float backstab_duration; // 0x1720        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Silver_Edge) == 0x1740);
};
