...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t crit_chance; // 0x1898            
            std::int32_t crit_multiplier; // 0x189c            
            float backstab_duration; // 0x18a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Silver_Edge) == 0x18c0);
    };
};
