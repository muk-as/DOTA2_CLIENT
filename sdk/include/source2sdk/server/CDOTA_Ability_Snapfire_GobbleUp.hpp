...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Snapfire_GobbleUp : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char m_hGobbledUnit[0x4]; // 0x5b8            
            float max_time_in_belly; // 0x5bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Snapfire_GobbleUp because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Snapfire_GobbleUp) == 0x5c0);
    };
};
