...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecIllusions[0x18]; // 0x1878            
            float ally_voodoo_duration; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shadow_Shaman_Ally_Voodoo_Invuln) == 0x1898);
    };
};
