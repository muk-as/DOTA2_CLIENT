...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Aghsfort_Modifier_Magnus_Push_Skewer_Movement : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Aghsfort_Modifier_Magnus_Push_Skewer_Movement) == 0x16f0);
};
