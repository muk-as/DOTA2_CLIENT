...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float vision_radius; // 0x17f8            
            float max_slow_pct; // 0x17fc            
            float m_flBaseVision; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Ringmaster_WeightedPie_Blind) == 0x1808);
    };
};
