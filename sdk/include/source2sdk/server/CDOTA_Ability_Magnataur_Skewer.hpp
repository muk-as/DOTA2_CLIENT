...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float tree_radius; // 0x5c0            
            float tree_hit_damage; // 0x5c4            
            float cliff_hit_damage; // 0x5c8            
            std::int32_t terrain_hit_increase_pct; // 0x5cc            
            float terrain_hit_cooldown; // 0x5d0            
            std::int32_t m_nProjectileID; // 0x5d4            
            std::int32_t m_nVisibleTargetCount; // 0x5d8            
            ...
            char m_hEnemiesSkewered[0x18]; // 0x5e0            
            source2sdk::entity2::GameTime_t m_flLastTerrainObstructionHitTime; // 0x5f8            
            std::int32_t m_nTargetsHit; // 0x5fc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Magnataur_Skewer because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Magnataur_Skewer) == 0x600);
    };
};
