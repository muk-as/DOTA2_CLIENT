...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vFaceDirection; // 0x18b4            
            std::int32_t leap_distance; // 0x18c0            
            float leap_speed; // 0x18c4            
            float leap_acceleration; // 0x18c8            
            std::int32_t leap_radius; // 0x18cc            
            float leap_bonus_duration; // 0x18d0            
            bool m_bLaunched; // 0x18d4            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Mirana_Leap) == 0x18d8);
    };
};
