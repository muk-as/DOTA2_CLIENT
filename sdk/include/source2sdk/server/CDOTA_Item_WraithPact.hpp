...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Item_WraithPact : public source2sdk::server::CDOTA_Item
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Item_WraithPact) == 0x698);
    };
};
