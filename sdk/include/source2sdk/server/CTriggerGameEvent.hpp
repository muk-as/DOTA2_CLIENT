...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CUtlString m_strStartTouchEventName; // 0x968            
            // metadata: MNetworkEnable
            CUtlString m_strEndTouchEventName; // 0x970            
            // metadata: MNetworkEnable
            CUtlString m_strTriggerID; // 0x978            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerGameEvent) == 0x980);
    };
};
