...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t min_movespeed_override; // 0x_            
            float geminate_attack_mark_duration; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Weaver_Shukuchi) == 0x_);
    };
};
