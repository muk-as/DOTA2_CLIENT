...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t min_movespeed_override; // 0x18a4            
            float geminate_attack_mark_duration; // 0x18a8            
            ...
            char m_hEntitiesAffected[0x18]; // 0x18b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Weaver_Shukuchi because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Weaver_Shukuchi) == 0x18c8);
    };
};
