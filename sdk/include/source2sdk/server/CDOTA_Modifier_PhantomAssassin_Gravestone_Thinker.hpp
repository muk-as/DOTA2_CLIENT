...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nEpitaph; // 0x_            
            source2sdk::client::PlayerID_t m_nVictimPlayerID; // 0x_            
            std::int32_t m_nVictimHeroID; // 0x_            
            std::int32_t m_nCritDmg; // 0x_            
            std::int32_t m_nContractComplete; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_PhantomAssassin_Gravestone_Thinker) == 0x_);
    };
};
