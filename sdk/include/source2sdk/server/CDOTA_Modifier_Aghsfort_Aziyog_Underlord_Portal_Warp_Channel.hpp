...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vStartPosition; // 0x1818            
            float m_flTotalTime; // 0x1824            
            float m_flElapsedTimePortion; // 0x1828            
            float animation_rate; // 0x182c            
            std::int32_t stop_distance; // 0x1830            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Aghsfort_Aziyog_Underlord_Portal_Warp_Channel) == 0x1838);
    };
};
