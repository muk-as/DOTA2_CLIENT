...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float permanent_int_steal_range; // 0x1888            
            std::int32_t permanent_int_steal_amount; // 0x188c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Silencer_BrainDrain because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Silencer_BrainDrain) == 0x1890);
    };
};
