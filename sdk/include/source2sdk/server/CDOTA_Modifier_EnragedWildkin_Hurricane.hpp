...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_EnragedWildkin_Hurricane : public client::CDOTA_Buff
    {
    public:
        Vector m_vDirection; // 0x16e8        
        float m_flEndTime; // 0x16f4        
        float m_flCurTime; // 0x16f8        
        client::ParticleIndex_t m_FX; // 0x16fc        
        int32_t distance; // 0x1700        
    ...
    static_assert(sizeof(CDOTA_Modifier_EnragedWildkin_Hurricane) == 0x1708);
};
