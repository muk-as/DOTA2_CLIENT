...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_FX; // 0x189c            
            std::int32_t distance; // 0x18a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_EnragedWildkin_Hurricane) == 0x18a8);
    };
};
