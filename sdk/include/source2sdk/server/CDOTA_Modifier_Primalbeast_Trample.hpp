...
namespace source2sdk::server
{
    ...
    {
    public:
        float effect_radius; // 0x1708        
        Vector vLastPos; // 0x170c        
        float flCurrentDistance; // 0x1718        
        int32_t step_distance; // 0x171c        
        int32_t bonus_magic_resistance; // 0x1720        
        bool m_bIsUnslowable; // 0x1724        
    ...
    static_assert(sizeof(CDOTA_Modifier_Primalbeast_Trample) == 0x1740);
};
