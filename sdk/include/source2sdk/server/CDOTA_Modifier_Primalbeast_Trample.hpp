...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float effect_radius; // 0x17f8            
            Vector vLastPos; // 0x17fc            
            float flCurrentDistance; // 0x1808            
            std::int32_t step_distance; // 0x180c            
            std::int32_t bonus_magic_resistance; // 0x1810            
            bool m_bIsUnslowable; // 0x1814            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Primalbeast_Trample) == 0x1830);
    };
};
