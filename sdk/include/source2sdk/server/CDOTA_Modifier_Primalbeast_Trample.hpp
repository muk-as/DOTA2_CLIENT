...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector vLastPos; // 0x_            
            float flCurrentDistance; // 0x_            
            std::int32_t step_distance; // 0x_            
            std::int32_t bonus_magic_resistance; // 0x_            
            bool m_bIsUnslowable; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Primalbeast_Trample) == 0x_);
    };
};
