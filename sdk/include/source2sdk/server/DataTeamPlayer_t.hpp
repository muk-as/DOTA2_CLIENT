...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iHeroDamage) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iTowerDamage) == 0x_);
        ...
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iDamageByTypeReceivedPreReduction) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iDamageByTypeReceivedPostReduction) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iOutgoingDamageByTypePreReduction) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iOutgoingDamageByTypePostReduction) == 0x_);
