...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad_[0x_]; // 0x_
            // metadata: MNetworkEnable
            source2sdk::server::CDOTA_UnitInventory m_PreGameInventory; // 0x_            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            source2sdk::server::PlayerNeutralChoices_t m_NeutralChoices; // 0x_            
            // metadata: MNetworkEnable
            source2sdk::server::CDOTACourierController m_CourierController; // 0x_            
            // metadata: MNetworkEnable
            source2sdk::server::CQuickBuyController m_quickBuyController; // 0x_            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iReliableGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iUnreliableGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iStartingPosition) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iTotalEarnedGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iTotalEarnedXP) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSharedGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iHeroKillGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCreepKillGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iNeutralKillGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCourierGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iBountyGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iRoshanGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iBuildingGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iOtherGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iComebackGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iExperimentalGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iExperimental2Gold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCreepDenyGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iTPScrollsPurchased) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flCustomStats) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iIncomeGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iWardKillGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iAbilityGold) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iNetWorth) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iDenyCount) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iLastHitCount) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iLastHitStreak) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iLastHitMultikill) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iNearbyCreepDeathCount) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iClaimedDenyCount) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iClaimedMissCount) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iMissCount) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_nPossibleHeroSelection) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_nPossibleHeroFacetSelection) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flBuybackCooldownTime) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flBuybackGoldLimitTime) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flBuybackCostTime) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flCustomBuybackCooldown) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_fStuns) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_fHealing) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_fRegeneratedHealth) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iTowerKills) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iRoshanKills) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_hCameraTarget) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_hOverrideSelectionEntity) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iObserverWardsPlaced) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSentryWardsPlaced) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCreepsStacked) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCampsStacked) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iRunePickups) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldSpentOnSupport) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flHeroDamage) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flTowerDamage) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iWardsPurchased) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iWardsDestroyed) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_PreGameInventory) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_nKillsPerOpposingTeamMember) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedAbilities) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_fSuggestedAbilityWeights) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedPregameItems) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedItemSequence) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedItemSequenceVariants) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedItemOptions) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedGeneralItems) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedNeutralTrinkets) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedNeutralEnhancements) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSuggestedHeroes) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flSuggestedHeroesWeights) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flDamageByTypeReceivedPreReduction) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flDamageByTypeReceivedPostReduction) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flOutgoingDamageByTypePreReduction) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flOutgoingDamageByTypePostReduction) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_uSelectedOverworldID) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_uSelectedOverworldTokenRewards) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCommandsIssued) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldSpentOnConsumables) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldSpentOnItems) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldSpentOnBuybacks) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldLostToDeath) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_bIsNewPlayer) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_bIsGuidePlayer) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iPlayerSteamID) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iSmokesUsed) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iNeutralTokensFound) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iWatchersTaken) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iLotusesTaken) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iTormentorKills) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCourierKills) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_nAcquiredMadstone) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_nCurrentMadstone) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_NeutralChoices) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_CourierController) == 0x_);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_quickBuyController) == 0x_);
        
        static_assert(sizeof(source2sdk::server::DataTeamPlayer_t) == 0x_);
    };
};
