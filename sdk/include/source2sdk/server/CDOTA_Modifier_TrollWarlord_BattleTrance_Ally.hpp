...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t attack_speed_share_percent; // 0x_            
            std::int32_t m_nAttackSpeed; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TrollWarlord_BattleTrance_Ally) == 0x_);
    };
};
