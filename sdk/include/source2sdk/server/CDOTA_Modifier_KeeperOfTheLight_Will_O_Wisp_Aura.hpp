...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x1888            
            float wisp_damage; // 0x188c            
            float off_duration; // 0x1890            
            float off_duration_initial; // 0x1894            
            float on_duration; // 0x1898            
            std::int32_t hit_count; // 0x189c            
            std::int32_t m_iAttackCount; // 0x18a0            
            source2sdk::entity2::GameTime_t m_flNextTimeOn; // 0x18a4            
            ...
            source2sdk::entity2::GameTime_t m_flNextTime; // 0x18b4            
            ...
            char m_vecDamagedEntities[0x18]; // 0x18b8            
            float m_flCorrectionTime; // 0x18d0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_KeeperOfTheLight_Will_O_Wisp_Aura) == 0x18d8);
    };
};
