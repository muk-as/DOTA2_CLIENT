...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_SheepStick_Debuff : public server::CDOTA_Modifier_Hexed
    {
    public:
        float sheep_movement_speed; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_SheepStick_Debuff) == 0x16f0);
};
