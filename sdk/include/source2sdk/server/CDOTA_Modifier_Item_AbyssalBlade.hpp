...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_AbyssalBlade : public server::CDOTA_Buff_Item
    {
    public:
        ...
        float bonus_health_regen; // 0x1724        
        int32_t block_damage_ranged; // 0x1728        
        int32_t block_damage_melee; // 0x172c        
        int32_t block_chance; // 0x1730        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_AbyssalBlade) == 0x1738);
};
