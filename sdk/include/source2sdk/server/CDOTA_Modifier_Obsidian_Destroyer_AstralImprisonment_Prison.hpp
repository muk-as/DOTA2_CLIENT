...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t allied_movement_speed_pct; // 0x_            
            bool m_bAllowMovement; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::client::ParticleIndex_t m_nDebuffImmuneEffect; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Obsidian_Destroyer_AstralImprisonment_Prison) == 0x_);
    };
};
