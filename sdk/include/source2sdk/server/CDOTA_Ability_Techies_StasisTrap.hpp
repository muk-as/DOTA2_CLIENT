...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Techies_StasisTrap : public server::CDOTABaseAbility
    {
    public:
