...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Undying_Tombstone_Zombie_Deathlust : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Undying_Tombstone_Zombie_Deathlust) == 0x16f0);
};
