...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifer_Item_GlovesOfHaste : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifer_Item_GlovesOfHaste) == 0x1800);
    };
};
