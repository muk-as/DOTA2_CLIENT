...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_AeonDisk : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
            std::int32_t bonus_health; // 0x1888            
            std::int32_t bonus_mana; // 0x188c            
            std::int32_t health_threshold_pct; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_AeonDisk) == 0x1898);
    };
};
