...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t nStrengthSteal; // 0x1800            
            std::int32_t nIntSteal; // 0x1804            
            std::int32_t nAgilitySteal; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Morphling_ScepterStatsDrain_Intelligence_Buff) == 0x1810);
    };
};
