...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t ally_ms; // 0x1888            
            std::int32_t ally_armor; // 0x188c            
            // hThinker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> hThinker;
            char hThinker[0x4]; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kunkka_XMarksTheSpot) == 0x18a8);
    };
};
