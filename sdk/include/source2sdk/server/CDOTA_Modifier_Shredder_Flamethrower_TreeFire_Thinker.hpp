...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CUtlVector<CUtlPair<CHandle<source2sdk::server::CBaseEntity>,source2sdk::entity2::GameTime_t>> m_vecTreeFires;
            char m_vecTreeFires[0x18]; // 0x1888            
            bool m_bCleanupWhenEmpty; // 0x18a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shredder_Flamethrower_TreeFire_Thinker) == 0x18a8);
    };
};
