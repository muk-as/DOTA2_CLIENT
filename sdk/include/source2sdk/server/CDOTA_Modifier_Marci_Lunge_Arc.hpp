...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bDamageApplied; // 0x18a0            
            bool m_bTargetTeleported; // 0x18a1            
            ...
            bool m_bTriggeredLandingAnim; // 0x18cc            
            uint8_t _pad18cd[0x3]; // 0x18cd
            std::int32_t m_nMaxJumpDistance; // 0x18d0            
            std::int32_t min_jump_distance; // 0x18d4            
            std::int32_t max_jump_distance; // 0x18d8            
            float min_lob_travel_time; // 0x18dc            
            float max_lob_travel_time; // 0x18e0            
            float landing_radius; // 0x18e4            
            float debuff_duration; // 0x18e8            
            float min_height_above_lowest; // 0x18ec            
            float min_height_above_highest; // 0x18f0            
            float min_acceleration; // 0x18f4            
            float max_acceleration; // 0x18f8            
            float impact_damage; // 0x18fc            
            std::int32_t impact_position_offset; // 0x1900            
            std::int32_t ally_impact_damage_pct; // 0x1904            
            float ally_buff_duration; // 0x1908            
            ...
            char m_hBounceEntity[0x4]; // 0x190c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Marci_Lunge_Arc because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Marci_Lunge_Arc) == 0x1910);
    };
};
