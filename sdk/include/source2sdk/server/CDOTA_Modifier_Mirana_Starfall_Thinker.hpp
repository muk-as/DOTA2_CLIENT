...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float starfall_secondary_radius; // 0x1878            
            float starstruck_duration; // 0x187c            
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1880            
            float m_flDamage; // 0x1884            
            bool m_bStarDropped; // 0x1888            
            bool m_bSecondStar; // 0x1889            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Mirana_Starfall_Thinker) == 0x1890);
    };
};
