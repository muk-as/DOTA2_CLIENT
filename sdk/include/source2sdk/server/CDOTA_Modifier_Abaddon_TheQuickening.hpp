...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float cooldown_reduction_creeps; // 0x17f8            
            float cooldown_reduction_heroes; // 0x17fc            
            float radius; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Abaddon_TheQuickening) == 0x1808);
    };
};
