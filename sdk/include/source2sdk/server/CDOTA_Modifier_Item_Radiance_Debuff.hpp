...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t aura_damage; // 0x1710        
        int32_t aura_damage_upgrade_bonus; // 0x1714        
        int32_t aura_damage_illusions; // 0x1718        
        int32_t blind_pct; // 0x171c        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Item_Radiance_Debuff because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Item_Radiance_Debuff) == 0x1720);
};
