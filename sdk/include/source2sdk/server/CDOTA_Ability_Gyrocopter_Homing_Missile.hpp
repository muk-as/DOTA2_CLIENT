...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Gyrocopter_Homing_Missile : public source2sdk::server::CDOTABaseAbility
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Gyrocopter_Homing_Missile) == 0x5c8);
    };
};
