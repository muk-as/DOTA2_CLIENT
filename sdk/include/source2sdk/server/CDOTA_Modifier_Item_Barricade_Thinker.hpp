...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t length; // 0x1888            
            std::int32_t width; // 0x188c            
            std::int32_t max_hits; // 0x1890            
            std::int32_t m_iCurrentHits; // 0x1894            
            std::int32_t m_hObstruction; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Barricade_Thinker) == 0x18a0);
    };
};
