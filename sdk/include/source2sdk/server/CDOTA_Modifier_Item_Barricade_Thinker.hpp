...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t length; // 0x17f8            
            std::int32_t width; // 0x17fc            
            std::int32_t max_hits; // 0x1800            
            std::int32_t m_iCurrentHits; // 0x1804            
            std::int32_t m_hObstruction; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Barricade_Thinker) == 0x1810);
    };
};
