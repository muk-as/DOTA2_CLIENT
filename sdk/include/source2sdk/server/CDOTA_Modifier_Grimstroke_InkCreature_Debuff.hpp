...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flCurrentArmorReduction; // 0x17f8            
            ...
            char m_hLatchedCreature[0x4]; // 0x17fc            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Grimstroke_InkCreature_Debuff) == 0x1808);
    };
};
