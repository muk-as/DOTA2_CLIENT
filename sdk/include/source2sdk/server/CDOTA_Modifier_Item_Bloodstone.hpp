...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_aoe; // 0x1800            
            std::int32_t bonus_mp_regen; // 0x1804            
            float spell_lifesteal; // 0x1808            
            float lifesteal_multiplier; // 0x180c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Bloodstone because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Bloodstone) == 0x1810);
    };
};
