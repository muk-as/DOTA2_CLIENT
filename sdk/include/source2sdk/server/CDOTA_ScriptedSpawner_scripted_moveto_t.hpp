...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char hGivenToNPC[0x_]; // 0x_            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::server::CDOTA_ScriptedSpawner_scripted_moveto_t, hMoveToTarget) == 0x_);
        static_assert(offsetof(source2sdk::server::CDOTA_ScriptedSpawner_scripted_moveto_t, hGivenToNPC) == 0x_);
        
        static_assert(sizeof(source2sdk::server::CDOTA_ScriptedSpawner_scripted_moveto_t) == 0x_);
    };
};
