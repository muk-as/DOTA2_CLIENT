...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t penalty_duration; // 0x1890            
            float penalty_multiplier; // 0x1894            
            std::int32_t movespeed; // 0x1898            
            std::int32_t undispellable; // 0x189c            
            bool from_global_silence; // 0x18a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Silencer_CurseOfTheSilent) == 0x18a8);
    };
};
