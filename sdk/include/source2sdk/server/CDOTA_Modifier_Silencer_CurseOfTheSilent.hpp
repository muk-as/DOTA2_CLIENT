...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t penalty_duration; // 0x_            
            float penalty_multiplier; // 0x_            
            std::int32_t movespeed; // 0x_            
            std::int32_t undispellable; // 0x_            
            bool from_global_silence; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Silencer_CurseOfTheSilent) == 0x_);
    };
};
