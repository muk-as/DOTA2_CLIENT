...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t damage_reduction_pct; // 0x1808            
            float shard_stun_duration; // 0x180c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_BountyHunter_WindWalk) == 0x1828);
    };
};
