...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_PhantomLancer_Juxtapose : public server::CDOTABaseAbility
    {
    public:
        ...
        // CHandle<server::CBaseEntity> m_hInvisIllusion;
        char m_hInvisIllusion[0x4]; // 0x5a0        
    ...
    static_assert(sizeof(CDOTA_Ability_PhantomLancer_Juxtapose) == 0x5a8);
};
