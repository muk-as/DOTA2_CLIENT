...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Muerta_Ofrenda : public source2sdk::server::CDOTABaseAbility
        {
        public:
            // metadata: MNetworkEnable
            // m_hOfrenda has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hOfrenda;
            char m_hOfrenda[0x4]; // 0x5b8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Muerta_Ofrenda) == 0x5c0);
    };
};
