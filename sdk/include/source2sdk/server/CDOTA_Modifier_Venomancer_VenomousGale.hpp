...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float explosion_stun_duration; // 0x1888            
            std::int32_t explosion_damage; // 0x188c            
            std::int32_t movement_slow; // 0x1890            
            std::int32_t tick_damage; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Venomancer_VenomousGale) == 0x18a0);
    };
};
