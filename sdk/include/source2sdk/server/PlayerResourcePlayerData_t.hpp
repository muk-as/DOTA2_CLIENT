...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CNetworkUtlVectorBase<source2sdk::client::PlayerID_t> m_vecPrivateCoachPlayerIDs;
        ...
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsValid) == 0x30);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iszPlayerName) == 0x38);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iPlayerTeam) == 0x40);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bFullyJoinedServer) == 0x44);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bFakeClient) == 0x45);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsBroadcaster) == 0x46);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iBroadcasterChannel) == 0x48);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iBroadcasterChannelSlot) == 0x4c);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsBroadcasterChannelCameraman) == 0x50);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iConnectionState) == 0x54);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iPlayerSteamID) == 0x58);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eCoachTeam) == 0x60);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_vecPrivateCoachPlayerIDs) == 0x68);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_unCoachRating) == 0x80);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eLiveSpectatorTeam) == 0x84);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nLiveSpectatorSpectatedHeroIndex) == 0x88);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsPlusSubscriber) == 0x8c);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bWasMVPLastGame) == 0x8d);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nCavernCrawlMapVariant) == 0x8e);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eAccoladeType) == 0x90);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_unAccoladeData) == 0xa0);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iRankTier) == 0xb8);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iLeaderboardRank) == 0xbc);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eMmrBoostType) == 0xc0);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iTitle) == 0xc4);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_unFavTeamPacked) == 0xc8);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nPlayerSlot) == 0xd0);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsBot) == 0xd4);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bHasNeutralTier) == 0xd5);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bHasRedeemedNeutralTier) == 0xda);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nCommLevel) == 0xe0);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nBehaviorLevel) == 0xe4);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_flLastCommsTime) == 0xe8);
        
        static_assert(sizeof(source2sdk::server::PlayerResourcePlayerData_t) == 0xf0);
    };
};
