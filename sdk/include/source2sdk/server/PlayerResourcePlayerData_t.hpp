...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsValid) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iszPlayerName) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iPlayerTeam) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bFullyJoinedServer) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bFakeClient) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsBroadcaster) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iBroadcasterChannel) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iBroadcasterChannelSlot) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsBroadcasterChannelCameraman) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iConnectionState) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iPlayerSteamID) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eCoachTeam) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_vecPrivateCoachPlayerIDs) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_unCoachRating) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eLiveSpectatorTeam) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nLiveSpectatorSpectatedHeroIndex) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsPlusSubscriber) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bWasMVPLastGame) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nCavernCrawlMapVariant) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eAccoladeType) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_unAccoladeData) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iRankTier) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iLeaderboardRank) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_eMmrBoostType) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_iTitle) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_unFavTeamPacked) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nPlayerSlot) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bIsBot) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bHasNeutralTier) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_bHasRedeemedNeutralTier) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nCommLevel) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_nBehaviorLevel) == 0x_);
        static_assert(offsetof(source2sdk::server::PlayerResourcePlayerData_t, m_flLastCommsTime) == 0x_);
        
        static_assert(sizeof(source2sdk::server::PlayerResourcePlayerData_t) == 0x_);
    };
};
