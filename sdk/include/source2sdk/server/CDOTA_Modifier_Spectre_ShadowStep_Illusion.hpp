...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_move_speed_illusion_pct; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Spectre_ShadowStep_Illusion) == 0x_);
    };
};
