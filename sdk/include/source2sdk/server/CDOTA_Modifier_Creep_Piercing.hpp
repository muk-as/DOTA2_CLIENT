...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t creep_damage_bonus; // 0x1878            
            std::int32_t hero_damage_penalty; // 0x187c            
            std::int32_t heavy_damage_penalty; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Creep_Piercing) == 0x1888);
    };
};
