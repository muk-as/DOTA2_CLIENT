...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t creep_damage_bonus; // 0x17f8            
            std::int32_t hero_damage_penalty; // 0x17fc            
            std::int32_t heavy_damage_penalty; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Creep_Piercing) == 0x1808);
    };
};
