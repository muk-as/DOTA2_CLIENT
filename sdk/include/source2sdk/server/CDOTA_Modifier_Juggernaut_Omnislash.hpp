...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hLastTarget[0x4]; // 0x188c            
            std::int32_t m_nJumps; // 0x1890            
            std::int32_t bonus_damage; // 0x1894            
            std::int32_t bonus_attack_speed; // 0x1898            
            float omni_slash_radius; // 0x189c            
            float attack_rate_multiplier; // 0x18a0            
            bool m_bFirstHit; // 0x18a4            
            uint8_t _pad18a5[0x3]; // 0x18a5
            std::int32_t m_iTotalDamage; // 0x18a8            
            std::int32_t m_iHeroDamage; // 0x18ac            
            std::int32_t m_iKilledHeroes; // 0x18b0            
            source2sdk::entity2::GameTime_t m_fNextAttackTime; // 0x18b4            
            bool m_bScepterCast; // 0x18b8            
            bool m_bReflection; // 0x18b9            
            bool m_bEndNext; // 0x18ba            
            uint8_t _pad18bb[0x5];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Juggernaut_Omnislash because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Juggernaut_Omnislash) == 0x18c0);
    };
};
