...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_nFluidType) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_flFluidDensity) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_flNeutrallyBuoyantGravity) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_flNeutrallyBuoyantLinearDamping) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_flNeutrallyBuoyantAngularDamping) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_bNeutrallyBuoyant) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_vecFractionOfWheelSubmergedForWheelFriction) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_vecWheelFrictionScales) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_vecFractionOfWheelSubmergedForWheelDrag) == 0x_);
        static_assert(offsetof(source2sdk::server::CBuoyancyHelper, m_vecWheelDrag) == 0x_);
        
        static_assert(sizeof(source2sdk::server::CBuoyancyHelper) == 0x_);
    };
};
