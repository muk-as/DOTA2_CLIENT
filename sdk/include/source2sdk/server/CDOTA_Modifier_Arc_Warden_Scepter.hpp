...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Arc_Warden_Scepter : public source2sdk::client::CDOTA_Buff
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Arc_Warden_Scepter) == 0x1880);
    };
};
