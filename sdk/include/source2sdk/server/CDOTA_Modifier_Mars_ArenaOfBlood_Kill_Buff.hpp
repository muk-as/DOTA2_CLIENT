...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t arena_kill_buff_damage_pct; // 0x_            
            std::int32_t arena_kill_buff_heal_pct; // 0x_            
            std::int32_t allied_reduction_pct; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Mars_ArenaOfBlood_Kill_Buff) == 0x_);
    };
};
