...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Shadow_Demon_Disruption : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            // CHandle<source2sdk::server::CBaseEntity> m_hDisruptedUnit;
            char m_hDisruptedUnit[0x4]; // 0x5c0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Shadow_Demon_Disruption) == 0x5c8);
    };
};
