...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Shadow_Demon_Disruption : public server::CDOTABaseAbility
    {
    public:
        ...
        // CHandle<server::CBaseEntity> m_hDisruptedUnit;
        char m_hDisruptedUnit[0x4]; // 0x5a0        
    ...
    static_assert(sizeof(CDOTA_Ability_Shadow_Demon_Disruption) == 0x5a8);
};
