...
namespace source2sdk::server
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Aghsfort_Ability_Hoodwink_HuntersBoomerang : public server::CDOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Aghsfort_Ability_Hoodwink_HuntersBoomerang) == 0x5a8);
};
