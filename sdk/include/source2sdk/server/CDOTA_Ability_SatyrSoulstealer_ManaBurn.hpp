...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_SatyrSoulstealer_ManaBurn : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            char hNeutralTarget[0x_]; // 0x_            
            source2sdk::entity2::GameTime_t m_flTimeBuffer; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_SatyrSoulstealer_ManaBurn because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_SatyrSoulstealer_ManaBurn) == 0x_);
    };
};
