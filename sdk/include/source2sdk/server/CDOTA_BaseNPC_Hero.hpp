...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad18b8[0x98]; // 0x18b8
            // metadata: MNetworkEnable
            float m_flStrength; // 0x1950            
            // metadata: MNetworkEnable
            float m_flAgility; // 0x1954            
            // metadata: MNetworkEnable
            float m_flIntellect; // 0x1958            
            // metadata: MNetworkEnable
            float m_flStrengthTotal; // 0x195c            
            // metadata: MNetworkEnable
            float m_flAgilityTotal; // 0x1960            
            // metadata: MNetworkEnable
            float m_flIntellectTotal; // 0x1964            
            // metadata: MNetworkEnable
            std::int32_t m_iRecentDamage; // 0x1968            
            // metadata: MNetworkEnable
            std::int32_t m_iPrimaryAttribute; // 0x196c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flDeathTime; // 0x1970            
            float m_flStrengthGain; // 0x1974            
            float m_flAgilityGain; // 0x1978            
            float m_flIntellectGain; // 0x197c            
            float m_flLastSuggestionTime; // 0x1980            
            bool m_bItemsAddedToLoadout; // 0x1984            
            bool m_bPregameItemsAddedToLoadout; // 0x1985            
            uint8_t _pad1986[0x2]; // 0x1986
            ...
            char m_hNewARDMHero[0x4]; // 0x1988            
            source2sdk::entity2::GameTime_t m_fBuybackCooldown; // 0x198c            
            source2sdk::entity2::GameTime_t m_fBuybackGoldLimit; // 0x1990            
            std::int32_t m_nLastHealedAmount; // 0x1994            
            float m_flLastHealedTime; // 0x1998            
            ...
            char m_hLastHealEntity[0x4]; // 0x199c            
            Vector m_vRespawnPosition; // 0x19a0            
            ...
            char m_HeroDamageInfoArray[0x18]; // 0x19b0            
            ...
            char m_vecRecentModifiers[0x18]; // 0x19c8            
            source2sdk::entity2::GameTime_t m_fMostRecentDamageTime; // 0x19e0            
            // metadata: MNetworkEnable
            std::int32_t m_iAbilityPoints; // 0x19e4            
            // metadata: MNetworkEnable
            std::int32_t m_iTotalAbilityPoints; // 0x19e8            
            // metadata: MNetworkEnable
            ...
            source2sdk::client::PlayerID_t m_iIllusionOriginalPlayerID; // 0x1a18            
            ...
            uint8_t _pad1a24[0x34]; // 0x1a24
            source2sdk::server::CountdownTimer m_RespawnMusicTimer; // 0x1a58            
            source2sdk::server::CountdownTimer m_HeroKillTimer; // 0x1a70            
            source2sdk::server::CountdownTimer m_MultipleHeroKillTimer; // 0x1a88            
            source2sdk::server::CountdownTimer m_MultipleLastHitTimer; // 0x1aa0            
            std::int32_t m_iMultipleKillCount; // 0x1ab8            
            float m_flKillStreakStartTime; // 0x1abc            
            bool m_bDisableWearables; // 0x1ac0            
            ...
            char m_hTogglableWearable[0x19c]; // 0x1ac4            
            source2sdk::server::CDOTA_BaseNPC_Hero_KillInfo_t m_KillInfo; // 0x1c60            
            source2sdk::server::CountdownTimer m_DirectorAbilityActivity; // 0x1c80            
            // metadata: MNetworkEnable
            bool m_bReincarnating; // 0x1c98            
            // metadata: MNetworkEnable
            bool m_bCustomKillEffect; // 0x1c99            
            uint8_t _pad1c9a[0x2]; // 0x1c9a
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flSpawnedAt; // 0x1c9c            
            // metadata: MNetworkEnable
            ...
            char m_hFacetAbilities[0x18]; // 0x1ca0            
            source2sdk::server::CountdownTimer m_PurchaseItemTimer; // 0x1cb8            
            source2sdk::server::CountdownTimer m_NeutralItemTimer; // 0x1cd0            
            source2sdk::server::CountdownTimer m_RetrieveItemsFromStashTimer; // 0x1ce8            
            source2sdk::server::CountdownTimer m_RequestGoToSecretShopTimer; // 0x1d00            
            std::int32_t m_iNextItemToPurchase; // 0x1d18            
            bool m_bDoesNextItemCompleteRecipe; // 0x1d1c            
            uint8_t _pad1d1d[0x3]; // 0x1d1d
            ...
            char m_BuildingOrBuilt[0x18]; // 0x1d38            
            source2sdk::server::sLoadoutItem m_TPScroll; // 0x1d50            
            source2sdk::server::sLoadoutItem m_Dust; // 0x1d68            
            source2sdk::server::sLoadoutItem m_Gem; // 0x1d80            
            source2sdk::server::sLoadoutItem m_SentryWard; // 0x1d98            
            source2sdk::server::sLoadoutItem m_ObserverWard; // 0x1db0            
            bool m_bAutoPurchaseItems; // 0x1dc8            
            bool m_bBuybackDisabled; // 0x1dc9            
            uint8_t _pad1dca[0x6]; // 0x1dca
            ...
            char m_hPets[0x18]; // 0x1dd0            
            bool m_bPreventPetSpawn; // 0x1de8            
            uint8_t _pad1de9[0x7]; // 0x1de9
            source2sdk::server::CDOTAMusicProbabilityEntry m_MusicProbabilityGank; // 0x1df0            
            uint8_t _pad1e18[0x28]; // 0x1e18
            CUtlString m_strCustomKillEffect; // 0x1e40            
            CUtlString m_strCustomHexModel; // 0x1e48            
            source2sdk::client::ParticleIndex_t m_nKillStreakFX; // 0x1e50            
            uint8_t _pad1e54[0x4]; // 0x1e54
            ...
            char m_AbilitiesPendingDelete[0x18]; // 0x1e58            
            ...
            char m_vecItemPurchaseHistory[0x18]; // 0x1e70            
            ...
            char m_vecAbilitySkillHistory[0x18]; // 0x1e88            
            ...
            char m_vecNeutralItemEquippedHistory[0x18]; // 0x1ea0            
            uint8_t _pad1eb8[0x18]; // 0x1eb8
            ...
            char m_vecExpiredIllusions[0x18]; // 0x1ed0            
            uint8_t _pad1ee8[0x4]; // 0x1ee8
            float m_flLastTimeLookedAtByDirector; // 0x1eec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_BaseNPC_Hero because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_Hero) == 0x1ef0);
    };
};
