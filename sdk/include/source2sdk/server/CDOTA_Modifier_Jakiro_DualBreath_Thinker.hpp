...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float start_radius; // 0x1888            
            float end_radius; // 0x188c            
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x1890            
            float m_fTotalTime; // 0x1894            
            Vector m_vCastPosition; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Jakiro_DualBreath_Thinker) == 0x18a8);
    };
};
