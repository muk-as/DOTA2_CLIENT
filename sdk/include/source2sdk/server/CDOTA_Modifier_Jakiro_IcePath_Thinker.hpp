...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vPathStart; // 0x_            
            Vector m_vPathEnd; // 0x_            
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x_            
            source2sdk::client::ParticleIndex_t m_nPathEffectIndexa; // 0x_            
            source2sdk::client::ParticleIndex_t m_nPathEffectIndexb; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Jakiro_IcePath_Thinker) == 0x_);
    };
};
