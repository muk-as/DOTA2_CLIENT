...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t self_movement_speed; // 0x1898            
            source2sdk::client::ParticleIndex_t nFXIndex; // 0x189c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Solar_Crest because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Solar_Crest) == 0x18a0);
    };
};
