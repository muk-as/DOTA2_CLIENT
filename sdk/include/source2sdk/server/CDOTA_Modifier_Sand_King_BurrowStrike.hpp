...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            Vector m_vPopupLocation; // 0x1888            
            bool m_bTeleported; // 0x1894            
            bool m_bPreviouslyBurrowed; // 0x1895            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Sand_King_BurrowStrike) == 0x1898);
    };
};
