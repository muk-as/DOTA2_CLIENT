...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Brewmaster_CinderBrew : public source2sdk::server::CDOTABaseAbility
        {
        public:
            ...
            float duration; // 0x_            
            float barrel_impact_damage; // 0x_            
            float barrel_width; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Brewmaster_CinderBrew) == 0x_);
    };
};
