...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_Techies_RemoteMines : public source2sdk::server::CDOTABaseAbility
        {
        public:
