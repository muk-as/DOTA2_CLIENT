...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bleed_health_pct; // 0x_            
            float tick_interval; // 0x_            
            float wheel_damage_multiplier; // 0x_            
            float slow_percent; // 0x_            
            float bleed_creep_dps; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Ringmaster_Impalement_Bleed) == 0x_);
    };
};
