...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_TriggerHitPoints; // 0x4e8            
            float m_flTimeToTrigger; // 0x4ec            
            source2sdk::entity2::GameTime_t m_flStartTime; // 0x4f0            
        ...
        static_assert(sizeof(source2sdk::server::CLogicActiveAutosave) == 0x4f8);
    };
};
