...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t movement_speed_buff_rate; // 0x17f8            
            float slow_resist; // 0x17fc            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Disperser_Movespeed_Buff) == 0x1808);
    };
};
