...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_Naginata : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
            ...
            std::int32_t cooldown_reduction_percent; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Naginata) == 0x_);
    };
};
