...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Muerta_PierceTheVeil : public source2sdk::client::CDOTA_Buff
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Muerta_PierceTheVeil) == 0x1898);
    };
};
