...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_projectile_speed_pct; // 0x_            
            std::int32_t bonus_attack_range; // 0x_            
            std::int32_t deadly_blow_multiplier; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_HeavyQuiver) == 0x_);
    };
};
