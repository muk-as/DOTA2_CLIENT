...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_projectile_speed_pct; // 0x1888            
            std::int32_t bonus_attack_range; // 0x188c            
            std::int32_t deadly_blow_multiplier; // 0x1890            
            float maim_duration; // 0x1894            
            std::int32_t m_nAttackRecord; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_HeavyQuiver) == 0x18a0);
    };
};
