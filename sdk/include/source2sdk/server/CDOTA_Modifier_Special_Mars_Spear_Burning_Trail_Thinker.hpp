...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float shard_trail_radius; // 0x_            
            float shard_debuff_linger_duration; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Special_Mars_Spear_Burning_Trail_Thinker) == 0x_);
    };
};
