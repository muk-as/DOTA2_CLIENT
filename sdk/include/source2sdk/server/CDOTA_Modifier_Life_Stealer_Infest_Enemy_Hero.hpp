...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float attack_rate_enemy; // 0x1888            
            float dot_duration; // 0x188c            
            float radius; // 0x1890            
            float m_flTotalDamage; // 0x1894            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Life_Stealer_Infest_Enemy_Hero) == 0x1898);
    };
};
