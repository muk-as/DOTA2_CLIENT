...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t effect_multiplier_distance; // 0x16f0        
        int32_t effect_multiplier; // 0x16f4        
        int32_t bonus_status_resistance; // 0x16f8        
        int32_t nethertoxin_bonus_pct; // 0x16fc        
        bool m_bEffectMultiplied; // 0x1700        
    ...
    static_assert(sizeof(CDOTA_Modifier_Viper_CorrosiveSkin_Slow) == 0x1708);
};
