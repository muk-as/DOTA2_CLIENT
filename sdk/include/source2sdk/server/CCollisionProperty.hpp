...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::VPhysicsCollisionAttribute_t m_collisionAttribute; // 0x_            
            // metadata: MNetworkEnable
        ...
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_collisionAttribute) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vecMins) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vecMaxs) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_usSolidFlags) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_nSolidType) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_triggerBloat) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_nSurroundType) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_CollisionGroup) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_nEnablePhysics) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_flBoundingRadius) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vecSpecifiedSurroundingMins) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vecSpecifiedSurroundingMaxs) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vecSurroundingMaxs) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vecSurroundingMins) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vCapsuleCenter1) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_vCapsuleCenter2) == 0x_);
        static_assert(offsetof(source2sdk::server::CCollisionProperty, m_flCapsuleRadius) == 0x_);
        
        static_assert(sizeof(source2sdk::server::CCollisionProperty) == 0x_);
    };
};
