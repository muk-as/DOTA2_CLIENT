...
namespace source2sdk::server
{
    ...
    {
    public:
        client::ParticleIndex_t m_nFXEarthAmbient1; // 0x1898        
        client::ParticleIndex_t m_nFXEarthAmbient2; // 0x189c        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Unit_Brewmaster_PrimalEarth because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Unit_Brewmaster_PrimalEarth) == 0x18a0);
};
