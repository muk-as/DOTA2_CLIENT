...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_fEquipTime; // 0x688            
            source2sdk::entity2::GameTime_t m_flActivatedTime; // 0x68c            
            // m_hOwner has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hOwner;
            char m_hOwner[0x4]; // 0x690            
            // metadata: MNetworkEnable
            bool m_bItemActivated; // 0x694            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Item_Miniboss_Minion_Summoner) == 0x698);
    };
};
