...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t vuln_slow; // 0x_            
            std::int32_t base_crit_pct; // 0x_            
            std::int32_t parry_bonus_crit; // 0x_            
            ...
            char m_vecAttackRecords[0x_]; // 0x_            
            bool m_bFromParry; // 0x_            
            bool m_bParryBonus; // 0x_            
            bool m_bConsumed; // 0x_            
            bool m_bForceInvisBonus; // 0x_            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kez_Shodo_Sai_Mark) == 0x_);
    };
};
