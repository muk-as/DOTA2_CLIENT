...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hMeasureTarget[0x4]; // 0x968            
            uint8_t _pad096c[0x4]; // 0x96c
            CUtlSymbolLarge m_iszMeasureTarget; // 0x970            
            float m_fRadius; // 0x978            
            std::int32_t m_nTouchers; // 0x97c            
            ...
            char m_NearestEntityDistance[0x28]; // 0x980            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerProximity) == 0x9a8);
    };
};
