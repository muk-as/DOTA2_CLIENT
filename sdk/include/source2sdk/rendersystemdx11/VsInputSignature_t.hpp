...
namespace source2sdk
{
    namespace rendersystemdx11
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::rendersystemdx11::VsInputSignatureElement_t> m_depth_elems;
            char m_depth_elems[0x18]; // 0x18            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::rendersystemdx11::VsInputSignature_t, m_elems) == 0x0);
        static_assert(offsetof(source2sdk::rendersystemdx11::VsInputSignature_t, m_depth_elems) == 0x18);
        
        static_assert(sizeof(source2sdk::rendersystemdx11::VsInputSignature_t) == 0x30);
    };
};
