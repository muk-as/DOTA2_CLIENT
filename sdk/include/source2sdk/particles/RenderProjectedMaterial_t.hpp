...
namespace source2sdk
{
    namespace particles
    {
        ...
        static_assert(offsetof(source2sdk::particles::RenderProjectedMaterial_t, m_hMaterial) == 0x_);
        
        static_assert(sizeof(source2sdk::particles::RenderProjectedMaterial_t) == 0x_);
    };
};
