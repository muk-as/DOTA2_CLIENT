...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            std::int32_t m_nHeadLocationMin; // 0x_            
            // metadata: MPropertyFriendlyName "max active CP"
            std::int32_t m_nHeadLocationMax; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            // metadata: MPropertyFriendlyName "reset rate"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flResetRate; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_SetControlPointPositionToRandomActiveCP) == 0x_);
    };
};
