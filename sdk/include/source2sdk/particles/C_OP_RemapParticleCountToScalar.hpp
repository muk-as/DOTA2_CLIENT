...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_nInputMin; // 0x_            
            // metadata: MPropertyFriendlyName "input maximum"
            source2sdk::particleslib::CParticleCollectionFloatInput m_nInputMax; // 0x_            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RemapParticleCountToScalar) == 0x_);
    };
};
