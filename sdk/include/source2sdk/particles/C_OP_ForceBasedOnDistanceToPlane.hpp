...
namespace source2sdk
{
    namespace particles
    {
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_ForceBasedOnDistanceToPlane) == 0x_);
    };
};
