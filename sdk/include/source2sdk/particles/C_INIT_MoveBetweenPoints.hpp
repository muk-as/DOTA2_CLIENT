...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flSpeedMin; // 0x_            
            // metadata: MPropertyFriendlyName "maximum speed"
            source2sdk::particleslib::CPerParticleFloatInput m_flSpeedMax; // 0x_            
            // metadata: MPropertyFriendlyName "end spread"
            source2sdk::particleslib::CPerParticleFloatInput m_flEndSpread; // 0x_            
            // metadata: MPropertyFriendlyName "start offset"
            source2sdk::particleslib::CPerParticleFloatInput m_flStartOffset; // 0x_            
            // metadata: MPropertyFriendlyName "end offset"
            source2sdk::particleslib::CPerParticleFloatInput m_flEndOffset; // 0x_            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_MoveBetweenPoints) == 0x_);
    };
};
