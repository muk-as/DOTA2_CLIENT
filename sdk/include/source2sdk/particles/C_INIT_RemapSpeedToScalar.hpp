...
namespace source2sdk
{
    namespace particles
    {
        ...
        #pragma pack(push, 1)
        class C_INIT_RemapSpeedToScalar : public source2sdk::particles::CParticleFunctionInitializer
        {
        public:
            // metadata: MPropertyFriendlyName "output field"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nFieldOutput; // 0x1c8            
            // metadata: MPropertyFriendlyName "control point number (ignored if per particle)"
            ...
            // metadata: MPropertyFriendlyName "per particle"
            bool m_bPerParticle; // 0x1ec            
            uint8_t _pad01ed[0x3];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_INIT_RemapSpeedToScalar because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_INIT_RemapSpeedToScalar) == 0x1f0);
    };
};
