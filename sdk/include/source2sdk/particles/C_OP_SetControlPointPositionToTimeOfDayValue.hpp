...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            char m_pszTimeOfDayParameter[128]; // 0x_            
            // metadata: MPropertyFriendlyName "default value"
            Vector m_vecDefaultValue; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_SetControlPointPositionToTimeOfDayValue) == 0x_);
    };
};
