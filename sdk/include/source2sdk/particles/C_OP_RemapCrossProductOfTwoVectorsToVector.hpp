...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleVecInput m_InputVec1; // 0x_            
            // metadata: MPropertyFriendlyName "input vector 2"
            source2sdk::particleslib::CPerParticleVecInput m_InputVec2; // 0x_            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RemapCrossProductOfTwoVectorsToVector) == 0x_);
    };
};
