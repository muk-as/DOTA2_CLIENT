...
namespace source2sdk
{
    namespace soundsystem_lowlevel
    {
        ...
        {
        public:
            source2sdk::soundsystem_lowlevel::VMixDualCompressorDesc_t m_desc; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::soundsystem_lowlevel::CVMixDualCompressorProcessorDesc) == 0x_);
    };
};
