...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        static_assert(offsetof(source2sdk::animgraphlib::CDirectPlaybackTagData, m_sequenceName) == 0x_);
        static_assert(offsetof(source2sdk::animgraphlib::CDirectPlaybackTagData, m_tags) == 0x_);
        
        static_assert(sizeof(source2sdk::animgraphlib::CDirectPlaybackTagData) == 0x_);
    };
};
