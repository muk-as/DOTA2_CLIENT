...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        public:
            ...
            char m_ChainsToSolveData[0x_]; // 0x_            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::animgraphlib::SolveIKChainPoseOpFixedSettings_t, m_ChainsToSolveData) == 0x_);
        
        static_assert(sizeof(source2sdk::animgraphlib::SolveIKChainPoseOpFixedSettings_t) == 0x_);
    };
};
