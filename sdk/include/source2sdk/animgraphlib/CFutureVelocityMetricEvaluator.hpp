...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        public:
            ...
            float m_flStoppingDistance; // 0x_            
            float m_flTargetSpeed; // 0x_            
            source2sdk::animgraphlib::VelocityMetricMode m_eMode; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::animgraphlib::CFutureVelocityMetricEvaluator) == 0x_);
    };
};
