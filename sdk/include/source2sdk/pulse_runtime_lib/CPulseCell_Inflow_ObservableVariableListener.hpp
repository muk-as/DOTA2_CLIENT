...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        {
        public:
            source2sdk::pulse_runtime_lib::PulseRuntimeBlackboardReferenceIndex_t m_nBlackboardReference; // 0x_            
            bool m_bSelfReference; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_Inflow_ObservableVariableListener) == 0x_);
    };
};
