...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        static_assert(offsetof(source2sdk::pulse_runtime_lib::PulseSelectorOutflowList_t, m_Outflows) == 0x_);
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::PulseSelectorOutflowList_t) == 0x_);
    };
};
