...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        public:
            ...
            source2sdk::pulse_runtime_lib::PulseObservableBoolExpression_t m_Condition; // 0x_            
            source2sdk::pulse_runtime_lib::CPulse_OutflowConnection m_SubGraph; // 0x_            
            source2sdk::pulse_runtime_lib::CPulse_OutflowConnection m_WhenTrue; // 0x_            
            source2sdk::pulse_runtime_lib::CPulse_OutflowConnection m_WhenFalse; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CPulseCell_BooleanSwitchState because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_BooleanSwitchState) == 0x_);
    };
};
