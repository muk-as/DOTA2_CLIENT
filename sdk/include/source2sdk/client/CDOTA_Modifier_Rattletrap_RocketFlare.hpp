...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t projectile_vision_radius; // 0x_            
            float projectile_vision_duration; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Rattletrap_RocketFlare) == 0x_);
    };
};
