...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t movement_speed_bonus; // 0x1880            
            std::int32_t bonus_health_per_level; // 0x1884            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Chen_HolyPersuasion because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Chen_HolyPersuasion) == 0x1888);
    };
};
