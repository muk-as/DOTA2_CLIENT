...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CDestructiblePartsSystemData_PartRuntimeData m_DefaultRuntimeData; // 0x30            
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_PartData, m_DefaultRuntimeData) == 0x30);
        
        static_assert(sizeof(source2sdk::client::CDestructiblePartsSystemData_PartData) == 0x60);
    };
};
