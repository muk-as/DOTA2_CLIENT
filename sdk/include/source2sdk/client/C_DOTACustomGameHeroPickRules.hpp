...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nNumBansPerTeam; // 0x514            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flEnterTime; // 0x518            
            std::int32_t m_nNumHeroesPicked; // 0x51c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTACustomGameHeroPickRules because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTACustomGameHeroPickRules) == 0x520);
    };
};
