...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_iDamageLevel; // 0x1a18            
            source2sdk::client::ParticleIndex_t m_nAmbientFXIndex; // 0x1a1c            
            source2sdk::client::ParticleIndex_t m_nTPFXIndex; // 0x1a20            
            source2sdk::client::ParticleIndex_t m_nStatusFXIndex; // 0x1a24            
            // metadata: MNetworkEnable
            ...
            char m_nFXIndexDestruction[0x8]; // 0x1a30            
            // metadata: MNetworkEnable
            QAngle m_angInitialAngles; // 0x1a38            
            // metadata: MNetworkEnable
            source2sdk::animationsystem::HSequence m_hHeroStatueSequence; // 0x1a44            
            // metadata: MNetworkEnable
            source2sdk::animationsystem::HSequence m_hConstantLayerSequence; // 0x1a48            
            // metadata: MNetworkEnable
            float m_fHeroStatueCycle; // 0x1a4c            
            // metadata: MNetworkEnable
            std::int32_t m_iHeroStatueStatusEffectIndex; // 0x1a50            
            // metadata: MNetworkEnable
            bool m_bHeroStatue; // 0x1a54            
            // metadata: MNetworkEnable
            bool m_bBattleCup; // 0x1a55            
            // metadata: MNetworkEnable
            char m_HeroStatueInscription[32]; // 0x1a56            
            uint8_t _pad1a76[0x2]; // 0x1a76
            // metadata: MNetworkEnable
            source2sdk::client::PlayerID_t m_iHeroStatueOwnerPlayerID; // 0x1a78            
            // metadata: MNetworkEnable
            Color m_ParticleTintColor; // 0x1a7c            
            // metadata: MNetworkEnable
            source2sdk::client::FowCustomTeams_t m_nFoWTeam; // 0x1a80            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_Building) == 0x1a88);
    };
};
