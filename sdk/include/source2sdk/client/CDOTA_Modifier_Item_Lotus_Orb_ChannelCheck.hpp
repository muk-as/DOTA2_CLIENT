...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::GameTime_t m_fChannelEnd; // 0x171c        
        bool m_bInterrupt; // 0x1720        
        bool m_bExpired; // 0x1721        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Lotus_Orb_ChannelCheck) == 0x1728);
};
