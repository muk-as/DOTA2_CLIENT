...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            Vector m_vLocation; // 0x1800            
            source2sdk::entity2::GameTime_t m_fChannelEnd; // 0x180c            
            bool m_bInterrupt; // 0x1810            
            bool m_bExpired; // 0x1811            
            uint8_t _pad1812[0x6];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Lotus_Orb_ChannelCheck because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Lotus_Orb_ChannelCheck) == 0x1818);
    };
};
