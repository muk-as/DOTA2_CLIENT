...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_AghsFort_Spectre_ActiveDispersion : public client::C_DOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Ability_AghsFort_Spectre_ActiveDispersion) == 0x5e0);
};
