...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            bool m_bIsMovable; // 0x1a18            
            uint8_t _pad1a19[0x3]; // 0x1a19
            QAngle m_angle; // 0x1a1c            
            std::int32_t m_iPoseParameterAim; // 0x1a28            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_Venomancer_PlagueWard) == 0x1a30);
    };
};
