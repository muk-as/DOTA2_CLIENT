...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<CHandle<source2sdk::client::C_BaseEntity>> m_hAppliers;
            char m_hAppliers[0x18]; // 0x1800            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Clinkz_Strafe_Debuff because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Clinkz_Strafe_Debuff) == 0x1818);
    };
};
