...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float multicast_delay; // 0x_            
            std::int32_t m_nMultiCastCount; // 0x_            
            float ignite_multicast_aoe; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Ogre_Magi_Ignite_Multicast because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Ogre_Magi_Ignite_Multicast) == 0x_);
    };
};
