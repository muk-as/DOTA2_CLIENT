...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Brewmaster_WindWalk : public client::CDOTA_Modifier_Invisible
    {
    public:
        int32_t bonus_movement_speeed; // 0x16f8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Brewmaster_WindWalk) == 0x1700);
};
