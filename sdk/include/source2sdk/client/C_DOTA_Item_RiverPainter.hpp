...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Item_RiverPainter : public source2sdk::client::C_DOTA_Item
        {
        public:
            // metadata: MNetworkEnable
            std::int32_t m_iRiverPaintColor; // 0x650            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Item_RiverPainter) == 0x658);
    };
};
