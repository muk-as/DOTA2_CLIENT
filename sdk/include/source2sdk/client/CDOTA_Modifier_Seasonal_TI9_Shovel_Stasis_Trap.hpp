...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Seasonal_TI9_Shovel_Stasis_Trap : public source2sdk::client::CDOTA_Modifier_Seasonal_Summon_Common_Thinker
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Seasonal_TI9_Shovel_Stasis_Trap) == 0x18a0);
    };
};
