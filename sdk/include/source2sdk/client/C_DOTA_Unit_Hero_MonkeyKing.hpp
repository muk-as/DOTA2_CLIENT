...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::uint32_t m_nTreeDisguise; // 0x1db0            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnPerchedTreeChanged"
            std::uint32_t m_nPerchedTree; // 0x1db4            
            ...
            char m_hTreeDisguiseEnt[0x4]; // 0x1db8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Hero_MonkeyKing) == 0x1dc0);
    };
};
