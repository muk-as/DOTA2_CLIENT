...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_nInitiatingPlayerID) == 0x_);
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_PingWheelMessageID) == 0x_);
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_flActiveUntilTime) == 0x_);
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_vLocation) == 0x_);
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_nPingedEntityEntIndex) == 0x_);
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_nID) == 0x_);
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_IconType) == 0x_);
        static_assert(offsetof(source2sdk::client::PingConfirmationState_t, m_nAgreeState) == 0x_);
        
        static_assert(sizeof(source2sdk::client::PingConfirmationState_t) == 0x_);
    };
};
