...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Primal_Beast_Trample_Haste : public source2sdk::client::CDOTA_Buff
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Primal_Beast_Trample_Haste) == 0x1898);
    };
};
