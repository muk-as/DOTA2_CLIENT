...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hEntsHit[0x18]; // 0x6a0        
        int32_t damage; // 0x6b8        
        float duration; // 0x6bc        
        float spend_charge_delay; // 0x6c0        
    ...
    static_assert(sizeof(CDOTA_Ability_AghsFort_Ravage_Potion) == 0x6c8);
};
