...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hEntsHit[0x18]; // 0x728            
            std::int32_t damage; // 0x740            
            float duration; // 0x744            
            float spend_charge_delay; // 0x748            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_AghsFort_Ravage_Potion) == 0x750);
    };
};
