...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Shadow_Demon_Soul_Catcher_Illusion : public source2sdk::client::CDOTA_Buff
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Shadow_Demon_Soul_Catcher_Illusion) == 0x1890);
    };
};
