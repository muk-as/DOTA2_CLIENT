...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_OrchidMalevolence : public client::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_intellect; // 0x16e8        
        float bonus_mana_regen; // 0x16ec        
        float bonus_health_regen; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_OrchidMalevolence) == 0x1700);
};
