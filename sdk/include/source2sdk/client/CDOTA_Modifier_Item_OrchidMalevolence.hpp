...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_OrchidMalevolence : public source2sdk::client::CDOTA_Buff_Item
        {
        public:
            std::int32_t bonus_intellect; // 0x17f8            
            float bonus_mana_regen; // 0x17fc            
            float bonus_health_regen; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_OrchidMalevolence) == 0x1810);
    };
};
