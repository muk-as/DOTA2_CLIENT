...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nBurningGroundInstancesPerEnrageLevel; // 0x2a4            
            ...
            std::int32_t m_nMaxDemonPortalCount; // 0x730            
            ...
            std::int32_t m_nNumMagicMissiles; // 0x910            
        ...
        static_assert(sizeof(source2sdk::client::CSurvivorsEnemyDefinition_ImperiaBoss) == 0xbe8);
    };
};
