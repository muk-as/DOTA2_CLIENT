...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t base_damage_amp; // 0x1888            
            std::int32_t damage_amp_per_level; // 0x188c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enchantress_RabbleRouser_Aura) == 0x1890);
    };
};
