...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t max_steps; // 0x688            
            Vector m_vTarget; // 0x68c            
            Vector m_vDir; // 0x698            
            std::int32_t m_nSteps; // 0x6a4            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_AghsFort_StonehallGeneral_OverwhelmingOdds) == 0x6b0);
    };
};
