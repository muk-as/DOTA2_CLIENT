...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t aghs_shard_move_slow; // 0x1708        
        int32_t aghs_shard_damage; // 0x170c        
        int32_t attack_slow; // 0x1710        
        int32_t turn_rate_slow; // 0x1714        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Tusk_FrozenSigil because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Tusk_FrozenSigil) == 0x1718);
};
