...
namespace source2sdk
{
    namespace client
    {
        ...
        {
            // MScriptDescription "à7.þÿ Max number of players connected to the server including spectators."
            ...
            // MScriptDescription "€8.þÿ Default number of non-spectator players supported."
