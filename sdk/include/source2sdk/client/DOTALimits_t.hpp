...
namespace source2sdk
{
    namespace client
    {
        ...
        {
            // MScriptDescription "m_hVarmint Max number of players connected to the server including spectators."
            ...
            // MScriptDescription "P Default number of non-spectator players supported."
