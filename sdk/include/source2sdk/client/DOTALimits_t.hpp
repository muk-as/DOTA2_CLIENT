...
namespace source2sdk
{
    namespace client
    {
        ...
        {
            // MScriptDescription "°X&ý Max number of players connected to the server including spectators."
            ...
            // MScriptDescription "PY&ý Default number of non-spectator players supported."
