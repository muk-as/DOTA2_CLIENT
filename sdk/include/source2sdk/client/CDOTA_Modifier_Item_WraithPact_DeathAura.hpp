...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t armor_penalty_aura; // 0x1878            
            std::int32_t damage_penalty_aura; // 0x187c            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_WraithPact_DeathAura) == 0x1888);
    };
};
