...
namespace source2sdk::client
{
    ...
    public:
        ...
        // CHandle<client::C_BaseEntity> m_hNPC;
    ...
    static_assert(offsetof(C_SpeechBubbleInfo, m_LocalizationStr) == 0x30);
    static_assert(offsetof(C_SpeechBubbleInfo, m_hNPC) == 0x130);
    static_assert(offsetof(C_SpeechBubbleInfo, m_flStartTime) == 0x134);
    static_assert(offsetof(C_SpeechBubbleInfo, m_flDuration) == 0x138);
    static_assert(offsetof(C_SpeechBubbleInfo, m_unOffsetX) == 0x13c);
    static_assert(offsetof(C_SpeechBubbleInfo, m_unOffsetY) == 0x140);
    static_assert(offsetof(C_SpeechBubbleInfo, m_unCount) == 0x144);
    
    static_assert(sizeof(C_SpeechBubbleInfo) == 0x148);
};
