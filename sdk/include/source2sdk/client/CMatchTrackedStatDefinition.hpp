...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::EMatchTrackedStatImpl m_eStatImpl; // 0x_            
        ...
        static_assert(offsetof(source2sdk::client::CMatchTrackedStatDefinition, m_unStatID) == 0x_);
        static_assert(offsetof(source2sdk::client::CMatchTrackedStatDefinition, m_eStatImpl) == 0x_);
        static_assert(offsetof(source2sdk::client::CMatchTrackedStatDefinition, m_expressionData) == 0x_);
        static_assert(offsetof(source2sdk::client::CMatchTrackedStatDefinition, m_aggregateData) == 0x_);
        
        static_assert(sizeof(source2sdk::client::CMatchTrackedStatDefinition) == 0x_);
    };
};
