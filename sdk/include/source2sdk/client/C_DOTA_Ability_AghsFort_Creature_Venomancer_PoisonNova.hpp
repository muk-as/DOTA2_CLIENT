...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXPreview; // 0x5b0            
            float radius; // 0x5b4            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_AghsFort_Creature_Venomancer_PoisonNova) == 0x5b8);
    };
};
