...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float mesmerize_radius; // 0x17fc            
            float k_flCloseThreshold; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Ringmaster_Wheel_Mesmerize_Pull) == 0x1808);
    };
};
