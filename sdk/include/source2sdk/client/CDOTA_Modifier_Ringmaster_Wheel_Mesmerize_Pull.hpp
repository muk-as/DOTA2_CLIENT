...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float mesmerize_radius; // 0x187c            
            float k_flCloseThreshold; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Ringmaster_Wheel_Mesmerize_Pull) == 0x1888);
    };
};
