...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float heal_pct; // 0x1804            
            source2sdk::entity2::GameTime_t m_flLastTickTime; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Frogmen_WaterBubble) == 0x1810);
    };
};
