...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            uint8_t _pad00e0[0x38]; // 0xe0
            // metadata: MNetworkEnable
            bool m_bClientClothCreationSuppressed; // 0x118            
            uint8_t _pad0119[0xb7]; // 0x119
            // metadata: MNetworkEnable
        ...
        static_assert(offsetof(source2sdk::client::CModelState, m_bClientClothCreationSuppressed) == 0x118);
        static_assert(offsetof(source2sdk::client::CModelState, m_MeshGroupMask) == 0x1d0);
        static_assert(offsetof(source2sdk::client::CModelState, m_nBodyGroupChoices) == 0x220);
        static_assert(offsetof(source2sdk::client::CModelState, m_nIdealMotionType) == 0x26a);
        static_assert(offsetof(source2sdk::client::CModelState, m_nForceLOD) == 0x26b);
        static_assert(offsetof(source2sdk::client::CModelState, m_nClothUpdateFlags) == 0x26c);
        
        static_assert(sizeof(source2sdk::client::CModelState) == 0x280);
    };
};
