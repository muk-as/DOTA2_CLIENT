...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float max_health_dmg_pct; // 0x_            
            float damage_pct; // 0x_            
            float damage_pct_enemies; // 0x_            
            float base_damage_amp; // 0x_            
            float flTickRate; // 0x_            
            bool m_bDoesSilence; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Bloodseeker_Bloodrage) == 0x_);
    };
};
