...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Eternal_Shroud_Bonus_Magic_Resist : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Eternal_Shroud_Bonus_Magic_Resist) == 0x16f0);
};
