...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float freeze_radius; // 0x_            
            std::int32_t freeze_damage; // 0x_            
            float freeze_debuff_duration; // 0x_            
            float freeze_delay; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_BossWinterWyvern_Cold_Embrace_Thinker) == 0x_);
    };
};
