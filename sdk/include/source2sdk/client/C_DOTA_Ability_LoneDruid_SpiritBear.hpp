...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_LoneDruid_SpiritBear) == 0x5c0);
    };
};
