...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXIndexA; // 0x1888            
            std::int32_t movement_speed; // 0x188c            
            std::int32_t cast_range; // 0x1890            
            bool m_bDidSwapSpiritForm; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_KeeperOfTheLight_SpiritForm) == 0x1898);
    };
};
