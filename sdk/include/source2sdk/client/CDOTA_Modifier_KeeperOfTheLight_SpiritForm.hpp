...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXIndexA; // 0x17f8            
            std::int32_t movement_speed; // 0x17fc            
            std::int32_t cast_range; // 0x1800            
            bool m_bDidSwapSpiritForm; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_KeeperOfTheLight_SpiritForm) == 0x1808);
    };
};
