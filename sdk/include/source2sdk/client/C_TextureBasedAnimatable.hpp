...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hPositionKeys[0x8]; // 0x828        
        // metadata: MNetworkEnable
        ...
        char m_hRotationKeys[0x8]; // 0x830        
        // metadata: MNetworkEnable
        Vector m_vAnimationBoundsMin; // 0x838        
        // metadata: MNetworkEnable
        Vector m_vAnimationBoundsMax; // 0x844        
        // metadata: MNetworkEnable
        float m_flStartTime; // 0x850        
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(C_TextureBasedAnimatable) == 0x858);
};
