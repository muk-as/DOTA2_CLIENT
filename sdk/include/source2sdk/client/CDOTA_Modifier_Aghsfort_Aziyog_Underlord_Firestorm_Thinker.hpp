...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t wave_damage; // 0x_            
            std::int32_t wave_count; // 0x_            
            std::int32_t radius; // 0x_            
            std::int32_t summon_count; // 0x_            
            float wave_interval; // 0x_            
            float burn_duration; // 0x_            
            float first_wave_delay; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Aghsfort_Aziyog_Underlord_Firestorm_Thinker) == 0x_);
    };
};
