...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float cooldown_reduction_creeps; // 0x1888            
            float cooldown_reduction_heroes; // 0x188c            
            float radius; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Abaddon_TheQuickening) == 0x1898);
    };
};
