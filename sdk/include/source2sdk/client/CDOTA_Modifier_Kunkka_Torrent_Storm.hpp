...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t torrent_min_distance; // 0x1708        
        int32_t torrent_max_distance; // 0x170c        
        int32_t m_iExplosionQuadrant; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Kunkka_Torrent_Storm) == 0x1720);
};
