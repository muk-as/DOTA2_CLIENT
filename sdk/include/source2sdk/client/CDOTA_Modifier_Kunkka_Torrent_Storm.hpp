...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float torrent_min_distance; // 0x17f8            
            float torrent_max_distance; // 0x17fc            
            std::int32_t m_iExplosionQuadrant; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kunkka_Torrent_Storm) == 0x1810);
    };
};
