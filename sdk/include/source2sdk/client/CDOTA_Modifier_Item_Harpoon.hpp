...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_chance; // 0x1888            
            std::int32_t bonus_chance_damage; // 0x188c            
            std::int32_t bonus_strength; // 0x1890            
            std::int32_t bonus_agility; // 0x1894            
            std::int32_t bonus_intellect; // 0x1898            
            float bonus_mana_regen; // 0x189c            
            std::int32_t bonus_damage; // 0x18a0            
            std::int32_t bonus_speed; // 0x18a4            
            ...
            char m_InFlightProcAttackRecords[0x18]; // 0x18a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Harpoon because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Harpoon) == 0x18c0);
    };
};
