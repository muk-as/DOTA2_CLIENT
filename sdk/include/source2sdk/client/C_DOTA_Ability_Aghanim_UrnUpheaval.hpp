...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CountdownTimer m_SlowTimer; // 0x_            
            source2sdk::client::CountdownTimer m_timer; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Aghanim_UrnUpheaval) == 0x_);
    };
};
