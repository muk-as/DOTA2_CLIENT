...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x_            
            float bonus_linger_duration; // 0x_            
            source2sdk::entity2::GameTime_t m_startDecayTime; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Axe_One_Man_Army) == 0x_);
    };
};
