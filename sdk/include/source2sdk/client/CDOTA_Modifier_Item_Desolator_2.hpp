...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Desolator_2 : public client::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_damage; // 0x16e8        
        float corruption_duration; // 0x16ec        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Desolator_2) == 0x1708);
};
