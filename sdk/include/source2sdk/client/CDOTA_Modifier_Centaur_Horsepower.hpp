...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t strength_to_movement_pct; // 0x17f8            
            std::int32_t move_speed_limit; // 0x17fc            
            std::int32_t base_move_speed_penalty; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Centaur_Horsepower) == 0x1808);
    };
};
