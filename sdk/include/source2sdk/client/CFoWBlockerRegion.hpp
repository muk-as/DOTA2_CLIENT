...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecFowBlockers[0x68]; // 0x5e0            
            // metadata: MNetworkEnable
            float m_flMinX; // 0x648            
            // metadata: MNetworkEnable
            float m_flMaxX; // 0x64c            
            // metadata: MNetworkEnable
            float m_flMinY; // 0x650            
            // metadata: MNetworkEnable
            float m_flMaxY; // 0x654            
            // metadata: MNetworkEnable
            float m_flGridSize; // 0x658            
        ...
        static_assert(sizeof(source2sdk::client::CFoWBlockerRegion) == 0x660);
    };
};
