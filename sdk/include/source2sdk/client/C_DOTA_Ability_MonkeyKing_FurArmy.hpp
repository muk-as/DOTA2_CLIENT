...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t num_first_soldiers; // 0x5b8            
            std::int32_t num_second_soldiers; // 0x5bc            
            bool m_bCreateMonkeys; // 0x5c0            
            uint8_t _pad05c1[0x3]; // 0x5c1
            source2sdk::entity2::GameTime_t m_flNextCreationTime; // 0x5c4            
            source2sdk::entity2::GameTime_t m_flScepterTime; // 0x5c8            
