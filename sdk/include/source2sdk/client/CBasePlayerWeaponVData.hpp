...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szClassName) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szWorldModel) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_sToolsOnlyOwnerModelName) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bBuiltRightHanded) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bAllowFlipping) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_sMuzzleAttachment) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szMuzzleFlashParticle) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szMuzzleFlashParticleConfig) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szBarrelSmokeParticle) == 0x_);
        ...
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iMaxClip2) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iDefaultClip1) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iDefaultClip2) == 0x_);
        ...
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iPosition) == 0x_);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_aShootSounds) == 0x_);
        
        static_assert(sizeof(source2sdk::client::CBasePlayerWeaponVData) == 0x_);
    };
};
