...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Ability_EmberSpirit_FireRemnant : public source2sdk::client::C_DOTABaseAbility
        {
        public:
