...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t shard_trail_radius; // 0x1714        
        float shard_debuff_linger_duration; // 0x1718        
        float shard_interval; // 0x171c        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Special_Mars_Spear_Burning_Trail_Thinker) == 0x1720);
};
