...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x68c            
            std::int32_t m_iProjectile; // 0x690            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x694            
            source2sdk::client::ParticleIndex_t m_nFXIndexB; // 0x698            
            Vector m_vPos; // 0x69c            
            std::int32_t total_damage; // 0x6a8            
            bool m_bStarted; // 0x6ac            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_KeeperOfTheLight_Illuminate) == 0x6b0);
    };
};
