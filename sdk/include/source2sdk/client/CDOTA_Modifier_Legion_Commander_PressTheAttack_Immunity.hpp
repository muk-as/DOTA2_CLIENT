...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Legion_Commander_PressTheAttack_Immunity : public source2sdk::client::CDOTA_Modifier_DebuffImmune
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Legion_Commander_PressTheAttack_Immunity) == 0x1890);
    };
};
