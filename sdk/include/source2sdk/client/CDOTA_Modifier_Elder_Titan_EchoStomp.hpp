...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t wake_damage_limit; // 0x1888            
            float animation_rate; // 0x188c            
            float initial_stun_duration; // 0x1890            
            uint8_t _pad1894[0x4]; // 0x1894
            source2sdk::client::CountdownTimer ctStunTimer; // 0x1898            
            float m_flDamageTaken; // 0x18b0            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Elder_Titan_EchoStomp) == 0x18b8);
    };
};
