...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float pulse_radius; // 0x68c            
            float pulse_debuff_duration; // 0x690            
            float pulse_damage; // 0x694            
            float pulse_silence_duration; // 0x698            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Marci_Unleash) == 0x6a0);
    };
};
