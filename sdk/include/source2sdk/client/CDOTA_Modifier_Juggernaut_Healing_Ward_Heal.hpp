...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t healing_ward_heal_amount; // 0x1708        
        int32_t m_nStartingHealthThisInterval; // 0x170c        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Juggernaut_Healing_Ward_Heal because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Juggernaut_Healing_Ward_Heal) == 0x1710);
};
