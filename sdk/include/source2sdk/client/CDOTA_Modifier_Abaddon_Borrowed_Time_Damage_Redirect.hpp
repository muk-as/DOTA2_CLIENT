...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_fDamageTaken; // 0x1878            
            std::int32_t ally_threshold_scepter; // 0x187c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Abaddon_Borrowed_Time_Damage_Redirect) == 0x1880);
    };
};
