...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels, m_DebugName) == 0x0);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels, m_nHitGroup) == 0x8);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels, m_bDisableHitGroupWhenDestroyed) == 0xc);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels, m_nOtherHitgroupsToDestroyWhenFullyDestructed) == 0x10);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels, m_bOnlyDestroyWhenGibbing) == 0x28);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels, m_sBodyGroupName) == 0x30);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels, m_DamageLevels) == 0x38);
        
        static_assert(sizeof(source2sdk::client::CDestructiblePartsSystemData_HitGroupInfoAndDamageLevels) == 0x50);
    };
};
