...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            Vector m_vWallCenter; // 0x_            
            Vector m_vWallDirection; // 0x_            
            Vector m_vWallRight; // 0x_            
            Vector m_vWallLeft; // 0x_            
            source2sdk::client::ParticleIndex_t m_nParticleIndexA; // 0x_            
            source2sdk::client::ParticleIndex_t m_nParticleIndexB; // 0x_            
            bool m_bStartedExpanding; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            float glacier_formation_speed; // 0x_            
            source2sdk::entity2::GameTime_t m_flFormationStartTime; // 0x_            
            ...
            char m_vecEnemiesInWall[0x_]; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_IceWall_VectorTarget_Thinker) == 0x_);
    };
};
