...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_AghsFort_TorrentEffectPotion_Torrent : public client::CDOTA_Buff_Item
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_AghsFort_TorrentEffectPotion_Torrent) == 0x16f0);
};
