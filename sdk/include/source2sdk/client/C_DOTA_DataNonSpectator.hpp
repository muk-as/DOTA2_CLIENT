...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nTotalEventPoints; // 0x_            
            // metadata: MNetworkEnable
            source2sdk::client::HeroID_t m_nCaptainInspectedHeroID; // 0x_            
            // metadata: MNetworkEnable
            std::int32_t m_nFeaturedPlayerID; // 0x_            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            source2sdk::client::CRoshanPhaseInfo m_roshanSpawnInfo; // 0x_            
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_DataNonSpectator) == 0x_);
    };
};
