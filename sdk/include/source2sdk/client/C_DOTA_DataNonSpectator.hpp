...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecDataTeam[0x68]; // 0x510            
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "fixed64"
            // metadata: MNetworkChangeCallback "OnTeamWorldTreeStateChanged"
            std::uint64_t m_bWorldTreeState[256]; // 0x578            
            // metadata: MNetworkEnable
            ...
            char m_vecWorldTreeModelReplacements[0x68]; // 0xd78            
            // metadata: MNetworkEnable
            Vector2D m_vDesiredWardPlacement[2]; // 0xde0            
            // metadata: MNetworkEnable
            std::int32_t m_nEnemyStartingPosition[5]; // 0xdf0            
            // metadata: MNetworkEnable
            std::int32_t m_nTotalEventPoints; // 0xe04            
            // metadata: MNetworkEnable
            source2sdk::client::HeroID_t m_nCaptainInspectedHeroID; // 0xe08            
            // metadata: MNetworkEnable
            std::int32_t m_nFeaturedPlayerID; // 0xe0c            
            // metadata: MNetworkEnable
            float m_flSuggestedWardWeights[20]; // 0xe10            
            // metadata: MNetworkEnable
            std::uint8_t m_nSuggestedWardIndexes[20]; // 0xe60            
            // metadata: MNetworkEnable
            std::int32_t m_iSuggestedLanes[5]; // 0xe74            
            // metadata: MNetworkEnable
            float m_iSuggestedLaneWeights[5]; // 0xe88            
            // metadata: MNetworkEnable
            bool m_bSuggestedLaneRoam[5]; // 0xe9c            
            // metadata: MNetworkEnable
            bool m_bSuggestedLaneJungle[5]; // 0xea1            
            ...
            char m_vecNeutralItemsTierInfo[0x68]; // 0xea8            
            // metadata: MNetworkEnable
            ...
            char m_vecNeutralStashItems[0x18]; // 0xf10            
            // metadata: MNetworkEnable
            ...
            char m_vecNeutralItemsConsumed[0x18]; // 0xf28            
            // metadata: MNetworkEnable
            ...
            char m_PingConfirmationStates[0x68]; // 0xf40            
            // metadata: MNetworkEnable
            ...
            char m_vecKnownClearCamps[0x18]; // 0xfa8            
            // metadata: MNetworkEnable
            Vector2D m_vPossibleWardPlacement[100]; // 0xfc0            
            // metadata: MNetworkEnable
            float m_vPossibleWardRadii[100]; // 0x12e0            
            // metadata: MNetworkEnable
            ...
            char m_vecTrackedTeleports[0x68]; // 0x1470            
            // metadata: MNetworkEnable
            source2sdk::client::CRoshanPhaseInfo m_roshanSpawnInfo; // 0x14d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_DataNonSpectator because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_DataNonSpectator) == 0x14f0);
    };
};
