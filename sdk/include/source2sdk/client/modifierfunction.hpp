...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "pБ(ы GetModifierManaDrainAmplify_Percentage"
            ...
            // MScriptDescription "PБ(ы GetModifierAvoidDamage"
            ...
            // MScriptDescription "0 Б(ы GetModifierCastRangeBonusStacking"
            ...
            // MScriptDescription "ахl'ы ReincarnateSuppressFX"
            ...
            // MScriptDescription "∞!Б(ы GetModifierPercentageHealthcost"
            ...
            // MScriptDescription "†$Б(ы GetOverrideAttackMagical"
            ...
            // MScriptDescription "`&Б(ы OnAbilityStart"
            ...
            // MScriptDescription "ј*Б(ы GetModifierIgnoreCooldown"
            ...
            // MScriptDescription "Р-Б(ы GetModifierBecomeIntelligence"
            ...
            // MScriptDescription "02Б(ы GetTierTokenReroll"
