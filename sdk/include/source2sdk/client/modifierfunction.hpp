...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "PÅ(˚ GetModifierAvoidDamage"
            ...
            // MScriptDescription "0 Å(˚ GetModifierCastRangeBonusStacking"
            ...
            // MScriptDescription "†ıl'˚ GetModifierPercentageCooldown"
            ...
            // MScriptDescription "ê-Å(˚ GetModifierBecomeIntelligence"
            ...
            // MScriptDescription "02Å(˚ GetTierTokenReroll"
