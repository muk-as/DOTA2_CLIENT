...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "ê‚ä(˚ GetModifierPreAttack_BonusDamage_Proc"
            ...
            // MScriptDescription "@Âä(˚ GetModifierDamageOutgoing_Percentage_Illusion_Amplify"
            ...
            // MScriptDescription "0Êä(˚ GetModifierMPRestoreAmplify_Percentage"
            ...
            // MScriptDescription "Áä(˚ GetModifierMagicalResistanceBonus"
            ...
            // MScriptDescription "Èä(˚ GetModifierAttackRangeOverride"
            ...
            // MScriptDescription "pÎä(˚ GetModifierPercentageHealthcostStacking"
            ...
            // MScriptDescription "êÏä(˚ GetDisableAutoAttack"
            ...
            // MScriptDescription "pÌä(˚ GetIsIllusion"
            ...
            // MScriptDescription "0Ôä(˚ GetCriticalStrikeBonus"
            ...
            // MScriptDescription "∞˝ä(˚ OnHealthGained"
            ...
            // MScriptDescription "ê˛ä(˚ GetModifierModelScaleUseInOutEase"
            ...
            // MScriptDescription "®»u'˚ OnTierTokenRerolled"
