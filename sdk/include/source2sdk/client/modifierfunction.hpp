...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "`ûã(˚ GetModifierPreAttack_BonusDamage_Proc"
            ...
            // MScriptDescription "–•ã(˚ GetModifierAttackRangeOverride"
            ...
            // MScriptDescription "Pßã(˚ GetModifierPercentageHealthcostStacking"
            ...
            // MScriptDescription "¨ã(˚ OnAttacked"
            ...
            // MScriptDescription "∞≠ã(˚ OnHealthGained"
            ...
            // MScriptDescription "‡øã(˚ OnTakeDamagePostUnavoidableBlock"
            ...
            // MScriptDescription "pƒã(˚ GetModifierProperty_MagicalLifesteal"
