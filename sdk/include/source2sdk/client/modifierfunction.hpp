...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "êˆä(˚ GetModifierMPRestoreAmplify_Percentage"
            ...
            // MScriptDescription "P¯ä(˚ GetModifierMagicalResistanceBonus"
            ...
            // MScriptDescription "P˙ä(˚ GetModifierAttackRangeOverride"
            ...
            // MScriptDescription "–˚ä(˚ GetModifierPercentageHealthcostStacking"
            ...
            // MScriptDescription "–˝ä(˚ GetIsIllusion"
            ...
            // MScriptDescription "êˇä(˚ GetCriticalStrikeBonus"
            ...
            // MScriptDescription "Ëÿu'˚ OnTreeCutDown"
