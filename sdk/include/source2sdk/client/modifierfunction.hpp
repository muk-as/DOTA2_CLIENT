...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription " òŠ(û GetModifierPreAttack_BonusDamage_Proc"
            ...
            // MScriptDescription " üŠ(û GetDisableAutoAttack"
            ...
            // MScriptDescription " ‹(û GetModifierModelScaleUseInOutEase"
            ...
            // MScriptDescription "°‹(û GetModifierProperty_MagicalLifesteal"
