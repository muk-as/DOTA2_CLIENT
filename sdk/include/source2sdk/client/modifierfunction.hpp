...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "°
‹(û GetModifierDamageOutgoing_Percentage_Illusion_Amplify"
            ...
            // MScriptDescription " ‹(û GetModifierMPRestoreAmplify_Percentage"
            ...
            // MScriptDescription "@‹(û GetModifierAttackRangeOverride"
            ...
            // MScriptDescription "À‹(û GetModifierPercentageHealthcostStacking"
            ...
            // MScriptDescription "à‹(û GetDisableAutoAttack"
            ...
            // MScriptDescription "À‹(û GetIsIllusion"
            ...
            // MScriptDescription "€ ‹(û GetCriticalStrikeBonus"
            ...
            // MScriptDescription "@v'û OnMagicDamageCalculated"
            MODIFIER_EVENT_ON_MAGIC_DAMAGE_CALCULATED = 0xd6,
            // MScriptDescription "`"‹(û OnAttacked"
            ...
            // MScriptDescription "p)‹(û OnTakeDamagePostUnavoidableBlock"
            ...
            // MScriptDescription " -‹(û GetTierTokenReroll"
