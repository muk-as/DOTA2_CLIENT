...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "çã(˚ GetModifierPreAttack_BonusDamage_Proc"
            ...
            // MScriptDescription "¿êã(˚ GetModifierMPRestoreAmplify_Percentage"
            ...
            // MScriptDescription "Äíã(˚ GetModifierMagicalResistanceBonus"
            ...
            // MScriptDescription "Äîã(˚ GetModifierAttackRangeOverride"
            ...
            // MScriptDescription "∞öã(˚ OnAbilityExecuted"
            ...
            // MScriptDescription "@ùã(˚ GetModifierModelScaleUseInOutEase"
            ...
            // MScriptDescription "p±ã(˚ GetModifierCreateBonusIllusionChance"
            ...
            // MScriptDescription "P≤ã(˚ GetTierTokenReroll"
            ...
            // MScriptDescription "0≥ã(˚ GetModifierProperty_MagicalLifesteal"
