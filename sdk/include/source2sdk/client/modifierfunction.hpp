...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class modifierfunction : std::uint32_t
        {
            ...
            // MScriptDescription "∞Úä(˚ GetModifierPreAttack_BonusDamage_Proc"
            ...
            // MScriptDescription "`ıä(˚ GetModifierDamageOutgoing_Percentage_Illusion_Amplify"
            ...
            // MScriptDescription "Pˆä(˚ GetModifierMPRestoreAmplify_Percentage"
            ...
            // MScriptDescription "¯ä(˚ GetModifierMagicalResistanceBonus"
            ...
            // MScriptDescription "˙ä(˚ GetModifierAttackRangeOverride"
            ...
            // MScriptDescription "ê˚ä(˚ GetModifierPercentageHealthcostStacking"
            ...
            // MScriptDescription "∞¸ä(˚ GetDisableAutoAttack"
            ...
            // MScriptDescription "ê˝ä(˚ GetIsIllusion"
            ...
            // MScriptDescription "Pˇä(˚ GetCriticalStrikeBonus"
            ...
            // MScriptDescription "∞ã(˚ GetModifierModelScaleUseInOutEase"
            ...
            // MScriptDescription " ã(˚ OnTakeDamagePostUnavoidableBlock"
            ...
            // MScriptDescription "(Ÿu'˚ OnTreeCutDown"
