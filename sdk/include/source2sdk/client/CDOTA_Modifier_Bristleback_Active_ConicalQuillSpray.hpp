...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t m_nPoseParameterWE; // 0x174c        
        int32_t m_nPoseParameterNS; // 0x1750        
        float m_flLastPoseX; // 0x1754        
        float m_flLastPoseY; // 0x1758        
        int32_t m_nLastMaxDirection; // 0x175c        
        Vector m_vLastOrigin; // 0x1760        
        entity2::GameTime_t m_flLastGameTime; // 0x176c        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Bristleback_Active_ConicalQuillSpray) == 0x1770);
};
