...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t m_nPoseParameterWE; // 0x172c        
        int32_t m_nPoseParameterNS; // 0x1730        
        float m_flLastPoseX; // 0x1734        
        float m_flLastPoseY; // 0x1738        
        int32_t m_nLastMaxDirection; // 0x173c        
        Vector m_vLastOrigin; // 0x1740        
        entity2::GameTime_t m_flLastGameTime; // 0x174c        
    };
    #pragma pack(pop)
