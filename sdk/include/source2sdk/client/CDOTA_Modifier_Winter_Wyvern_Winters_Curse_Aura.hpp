...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float radius; // 0x1894            
            std::int32_t damage_reduction; // 0x1898            
            ...
            char m_vhAffectedEnemyHeroes[0x18]; // 0x18a8            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Winter_Wyvern_Winters_Curse_Aura) == 0x18c0);
    };
};
