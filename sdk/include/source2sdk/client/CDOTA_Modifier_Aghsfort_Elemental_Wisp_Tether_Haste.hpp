...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t health_regen; // 0x1890            
            std::int32_t status_resist; // 0x1894            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Aghsfort_Elemental_Wisp_Tether_Haste) == 0x1898);
    };
};
