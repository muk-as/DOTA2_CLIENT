...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t aura_damage_upgrade_bonus; // 0x18a0            
            std::int32_t aura_damage_illusions; // 0x18a4            
            std::int32_t blind_pct; // 0x18a8            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Radiance_Debuff) == 0x18b0);
    };
};
