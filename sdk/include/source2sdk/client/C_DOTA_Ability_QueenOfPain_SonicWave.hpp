...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x680            
            float m_fTotalTime; // 0x684            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x688            
            float starting_aoe; // 0x68c            
            float final_aoe; // 0x690            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_QueenOfPain_SonicWave) == 0x6a8);
    };
};
