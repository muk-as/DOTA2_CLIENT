...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t m_nSource; // 0x16e8        
        float animation_rate; // 0x16ec        
        Vector m_vWalkDir; // 0x16f0        
        int32_t walk_speed; // 0x16fc        
        float turn_rate; // 0x1700        
        entity2::GameTime_t m_flLastThinkTime; // 0x1704        
        float m_flWalkAngle; // 0x1708        
    ...
    static_assert(sizeof(CDOTA_Modifier_Bane_Nightmare) == 0x1710);
};
