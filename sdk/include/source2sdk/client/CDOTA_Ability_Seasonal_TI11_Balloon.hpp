...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float charge_use_interval; // 0x5b0            
            float max_usable_charges; // 0x5b4            
            source2sdk::entity2::GameTime_t m_flLastChargeUseTime; // 0x5b8            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Seasonal_TI11_Balloon) == 0x5c8);
    };
};
