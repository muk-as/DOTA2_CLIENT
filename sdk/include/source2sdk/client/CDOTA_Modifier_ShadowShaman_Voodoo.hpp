...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_ShadowShaman_Voodoo : public source2sdk::client::CDOTA_Modifier_Hexed
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_ShadowShaman_Voodoo) == 0x1808);
    };
};
