...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_SangeAndYasha : public client::CDOTA_Buff_Item
    {
    public:
        ...
        int32_t slow_resistance; // 0x1700        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_SangeAndYasha) == 0x1708);
};
