...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t destroy_if_target_is_dead; // 0x1888            
            source2sdk::entity2::GameTime_t m_fStartAttackTime; // 0x188c            
            ...
            char hTarget[0x4]; // 0x1890            
            bool m_bTargetIsAlive; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Spectre_Haunt) == 0x1898);
    };
};
