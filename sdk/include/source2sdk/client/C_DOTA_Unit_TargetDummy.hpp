...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flDamageTaken; // 0x1b68            
            // metadata: MNetworkEnable
            float m_flLastHit; // 0x1b6c            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartDamageTime; // 0x1b70            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flLastTargetDummyDamageTime; // 0x1b74            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Unit_TargetDummy because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_TargetDummy) == 0x1b78);
    };
};
