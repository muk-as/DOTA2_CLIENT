...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Riki_Permanent_Invisibility : public source2sdk::client::CDOTA_Modifier_PersistentInvisibility
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Riki_Permanent_Invisibility) == 0x1810);
    };
};
