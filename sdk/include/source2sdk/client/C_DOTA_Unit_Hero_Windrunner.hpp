...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nTargetAngle; // 0x1b68            
            std::int32_t m_iPoseParameterAim; // 0x1b6c            
            source2sdk::client::ParticleIndex_t m_nFXDeath; // 0x1b70            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Hero_Windrunner) == 0x1b78);
    };
};
