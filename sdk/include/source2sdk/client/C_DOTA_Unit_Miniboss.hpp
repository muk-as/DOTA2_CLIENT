...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_flTransitionTimestamp; // 0x_            
            std::int32_t m_nTempViewer; // 0x_            
            ...
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::client::ParticleIndex_t nShieldFX; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Miniboss) == 0x_);
    };
};
