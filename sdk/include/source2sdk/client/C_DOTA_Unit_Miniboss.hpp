...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nVisualTeam; // 0x17d8            
            uint8_t _pad17dc[0x4]; // 0x17dc
            source2sdk::entity2::GameTime_t m_flTransitionTimestamp; // 0x17e0            
            std::int32_t m_nTempViewer; // 0x17e4            
            ...
            char m_hAttackingHeroes[0x18]; // 0x17e8            
            uint8_t _pad1800[0x8]; // 0x1800
            source2sdk::client::ParticleIndex_t nShieldFX; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Miniboss) == 0x1810);
    };
};
