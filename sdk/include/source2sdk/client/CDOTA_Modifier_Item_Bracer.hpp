...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Bracer : public client::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_strength; // 0x1708        
        int32_t bonus_agility; // 0x170c        
        int32_t bonus_intellect; // 0x1710        
        float bonus_health_regen; // 0x1714        
        int32_t bonus_damage; // 0x1718        
        int32_t bonus_slow_resistance; // 0x171c        
        int32_t bonus_health; // 0x1720        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Bracer) == 0x1728);
};
