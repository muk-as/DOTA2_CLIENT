...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_Harpoon_Pull : public source2sdk::client::CDOTA_Buff
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Harpoon_Pull) == 0x1800);
    };
};
