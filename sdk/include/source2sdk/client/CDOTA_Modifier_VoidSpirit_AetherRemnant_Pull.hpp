...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float artifice_pct_effectiveness; // 0x1804            
            bool bIsArtifice; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_VoidSpirit_AetherRemnant_Pull) == 0x1810);
    };
};
