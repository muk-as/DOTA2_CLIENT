...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float evasion; // 0x17f8            
            float min_movespeed; // 0x17fc            
            float bonus_attack_speed; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lycan_SummonWolves_GeistForm) == 0x1808);
    };
};
