...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t mana_burned; // 0x187c            
            float damage_per_mana; // 0x1880            
            float spell_lifesteal; // 0x1884            
            float spell_amp; // 0x1888            
            std::int32_t self_mana_restore_pct; // 0x188c            
            ...
            char m_hPullThinker[0x4]; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_EMP) == 0x1898);
    };
};
