...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t shard_width; // 0x680            
            std::int32_t shard_count; // 0x684            
            float shard_duration; // 0x688            
            float shard_angle_step; // 0x68c            
            std::int32_t shard_distance; // 0x690            
            Vector m_vSpawnOrigin; // 0x694            
