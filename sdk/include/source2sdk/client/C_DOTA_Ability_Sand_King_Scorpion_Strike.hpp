...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Ability_Sand_King_Scorpion_Strike : public source2sdk::client::C_DOTABaseAbility
        {
        public:
            ...
            char hEntitiesToIgnore[0x18]; // 0x5b0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Ability_Sand_King_Scorpion_Strike because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Sand_King_Scorpion_Strike) == 0x5c8);
    };
};
