...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_hero_damage; // 0x17f8            
            std::int32_t creep_damage_penalty; // 0x17fc            
            float radius; // 0x1800            
            float attack_interval; // 0x1804            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_EmberSpirit_SleightOfFist_Caster) == 0x1808);
    };
};
