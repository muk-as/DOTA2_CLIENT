...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t trigger_chance; // 0x17f8            
            float buff_duration; // 0x17fc            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Legion_Commander_MomentOfCourage) == 0x1800);
    };
};
