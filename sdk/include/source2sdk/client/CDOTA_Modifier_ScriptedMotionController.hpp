...
namespace source2sdk::client
{
    ...
    {
    public:
        HSCRIPT m_hHorizontalControlFunction; // 0x1708        
        HSCRIPT m_hVerticalControlFunction; // 0x1710        
        HSCRIPT m_hOnDestroyFunction; // 0x1718        
