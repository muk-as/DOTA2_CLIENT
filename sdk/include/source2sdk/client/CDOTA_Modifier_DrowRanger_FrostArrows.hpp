...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_DrowRanger_FrostArrows : public client::CDOTA_Buff
    {
    public:
        // m_InFlightAttackRecords has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CUtlVector<int16_t> m_InFlightAttackRecords;
        char m_InFlightAttackRecords[0x18]; // 0x16e8        
        int32_t shard_bonus_damage_per_stack; // 0x1700        
    ...
    static_assert(sizeof(CDOTA_Modifier_DrowRanger_FrostArrows) == 0x1708);
};
