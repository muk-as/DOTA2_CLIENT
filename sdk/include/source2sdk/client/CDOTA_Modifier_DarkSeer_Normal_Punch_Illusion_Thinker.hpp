...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            Vector m_vecIllusionSpawnPosition; // 0x1888            
            std::int32_t speed; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_DarkSeer_Normal_Punch_Illusion_Thinker) == 0x18a0);
    };
};
