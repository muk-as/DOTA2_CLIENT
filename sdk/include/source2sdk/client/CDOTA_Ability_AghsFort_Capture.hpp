...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Ability_AghsFort_Capture : public source2sdk::client::C_DOTABaseAbility
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_AghsFort_Capture) == 0x690);
    };
};
