...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float radius; // 0x_            
            std::int32_t strike_damage; // 0x_            
            std::int32_t strike_damage_bonus; // 0x_            
            std::int32_t hits_units_inside_kinetic; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Disruptor_Thunder_Strike) == 0x_);
    };
};
