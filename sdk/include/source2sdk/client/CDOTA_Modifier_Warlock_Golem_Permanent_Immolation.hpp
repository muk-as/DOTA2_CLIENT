...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t share_damage; // 0x_            
            float manahealthboost; // 0x_            
            float manaboost_scale_mult; // 0x_            
            float m_flAdditionalDamage; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Warlock_Golem_Permanent_Immolation) == 0x_);
    };
};
