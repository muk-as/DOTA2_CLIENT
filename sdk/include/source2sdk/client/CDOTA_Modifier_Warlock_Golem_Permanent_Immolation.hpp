...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t share_damage; // 0x188c            
            float manahealthboost; // 0x1890            
            float manaboost_scale_mult; // 0x1894            
            float m_flAdditionalDamage; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Warlock_Golem_Permanent_Immolation) == 0x18a0);
    };
};
