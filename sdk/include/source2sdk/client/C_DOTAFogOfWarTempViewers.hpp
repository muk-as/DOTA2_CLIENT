...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::uint32_t m_FoWTempViewerVersion; // 0x5e0            
            ...
            char m_TempViewerInfo[0x68]; // 0x5e8            
            std::int32_t m_dota_spectator_fog_of_war_last; // 0x650            
            std::uint32_t m_unLastFogOfWarTeam; // 0x654            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTAFogOfWarTempViewers because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTAFogOfWarTempViewers) == 0x658);
    };
};
