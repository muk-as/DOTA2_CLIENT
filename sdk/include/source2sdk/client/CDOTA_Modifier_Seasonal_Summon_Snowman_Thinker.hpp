...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Seasonal_Summon_Snowman_Thinker : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Seasonal_Summon_Snowman_Thinker) == 0x16f8);
};
