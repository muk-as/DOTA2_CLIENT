...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float attack_damage_per_stone; // 0x_            
            float attack_damage_per_stone_used; // 0x_            
            float buff_duration; // 0x_            
            source2sdk::entity2::GameTime_t m_ExpireTime; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_EarthSpirit_StoneCaller_Innate) == 0x_);
    };
};
