...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float attack_radius; // 0x17fc            
            source2sdk::entity2::GameTime_t m_flLastAttack; // 0x1800            
            float roaming_seconds_per_rotation; // 0x1804            
            float roaming_radius; // 0x1808            
            float attack_interval; // 0x180c            
            float min_move_speed; // 0x1810            
            float max_move_speed; // 0x1814            
            std::int32_t m_iPreviousHawkCount; // 0x1818            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Beastmaster_CallOfTheWild_Hawk) == 0x1820);
    };
};
