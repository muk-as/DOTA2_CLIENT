...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_chance_pct; // 0x_            
            float bonus_chance_duration; // 0x_            
            float damage; // 0x_            
            float movespeed_duration; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_SpiritBreaker_GreaterBash) == 0x_);
    };
};
