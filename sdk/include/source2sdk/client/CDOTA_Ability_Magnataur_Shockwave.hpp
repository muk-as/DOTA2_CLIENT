...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char hAlreadyHitListReturning[0x18]; // 0x6a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Magnataur_Shockwave because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Magnataur_Shockwave) == 0x6c0);
    };
};
