...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t only_creep_allies_damage_pct; // 0x1800            
            bool illusions_can_apply; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Spectre_Desolate) == 0x1808);
    };
};
