...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_Wind_Waker : public source2sdk::client::CDOTA_Buff_Item
        {
        public:
            ...
            std::int32_t cast_range_bonus; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Wind_Waker) == 0x18a0);
    };
};
