...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t perched_jump_distance; // 0x688            
            std::int32_t ground_jump_distance; // 0x68c            
            uint8_t _pad0690[0x800];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Ability_MonkeyKing_TreeDance because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_MonkeyKing_TreeDance) == 0xe90);
    };
};
