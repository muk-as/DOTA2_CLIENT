...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t slow_melee; // 0x188c            
            std::int32_t slow_range; // 0x1890            
            bool bCasterRanged; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Orb_Of_Destruction_Debuff) == 0x1898);
    };
};
