...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t slow_melee; // 0x17fc            
            std::int32_t slow_range; // 0x1800            
            bool bCasterRanged; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Orb_Of_Destruction_Debuff) == 0x1808);
    };
};
