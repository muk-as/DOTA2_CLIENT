...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::ParticleIndex_t m_nFXHammerIndex; // 0x604        
        int32_t aura_radius; // 0x608        
