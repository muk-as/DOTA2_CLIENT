...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFXHammerIndex; // 0x684            
            std::int32_t aura_radius; // 0x688            
