...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFXHammerIndex; // 0x5b4            
            std::int32_t aura_radius; // 0x5b8            
