...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float bonus_slow; // 0x_            
            std::int32_t bonus_damage; // 0x_            
            float flAccummulatedBonusSlow; // 0x_            
            std::int32_t iAccummulatedBonusDamage; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Dazzle_Poison_Touch) == 0x_);
    };
};
