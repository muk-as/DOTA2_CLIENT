...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t flLastGameTime; // 0x_            
            float m_flCurrentShield; // 0x_            
            float barrier_decay_pct; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Bloodseeker_BloodMist_Barrier) == 0x_);
    };
};
