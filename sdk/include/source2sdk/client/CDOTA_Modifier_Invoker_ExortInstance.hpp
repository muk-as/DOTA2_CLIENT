...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Invoker_ExortInstance : public client::CDOTA_Modifier_Invoker_Instance
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Invoker_ExortInstance) == 0x1710);
};
