...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Invoker_ExortInstance : public source2sdk::client::CDOTA_Modifier_Invoker_Instance
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_ExortInstance) == 0x18a8);
    };
};
