...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t min_range; // 0x68c            
            float mesmerize_radius; // 0x690            
            float knockback_radius; // 0x694            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Ability_Ringmaster_Wheel because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Ringmaster_Wheel) == 0x698);
    };
};
