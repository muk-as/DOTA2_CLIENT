...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_DebugName) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_nHitGroup) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_bDisableHitGroupWhenDestroyed) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_nOtherHitgroupsToDestroyWhenFullyDestructed) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_bOnlyDestroyWhenGibbing) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_sBodyGroupName) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePart, m_DamageLevels) == 0x_);
        
        static_assert(sizeof(source2sdk::client::CDestructiblePart) == 0x_);
    };
};
