...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t drag_speed; // 0x1878            
            float aura_origin_x; // 0x187c            
            float aura_origin_y; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_EMP_Pull) == 0x1898);
    };
};
