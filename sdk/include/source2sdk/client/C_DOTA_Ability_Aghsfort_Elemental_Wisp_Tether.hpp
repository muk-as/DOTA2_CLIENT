...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class C_DOTA_Ability_Aghsfort_Elemental_Wisp_Tether : public client::C_DOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(C_DOTA_Ability_Aghsfort_Elemental_Wisp_Tether) == 0x5f8);
};
