...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Venom_Gland : public client::CDOTA_Buff_Item
    {
    public:
        int32_t primary_attribute; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Venom_Gland) == 0x1710);
};
