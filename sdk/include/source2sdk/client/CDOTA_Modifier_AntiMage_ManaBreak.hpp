...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t percent_damage_per_burn; // 0x_            
            std::int32_t mana_per_hit; // 0x_            
            float mana_per_hit_pct; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AntiMage_ManaBreak) == 0x_);
    };
};
