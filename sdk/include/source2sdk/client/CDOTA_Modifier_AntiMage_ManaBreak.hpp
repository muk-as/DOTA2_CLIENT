...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t percent_damage_per_burn; // 0x17f8            
            std::int32_t mana_per_hit; // 0x17fc            
            float mana_per_hit_pct; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AntiMage_ManaBreak) == 0x1808);
    };
};
