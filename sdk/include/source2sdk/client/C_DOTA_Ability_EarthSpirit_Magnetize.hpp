...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float cast_radius; // 0x688            
            float rock_explosion_radius; // 0x68c            
            float damage_duration; // 0x690            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_EarthSpirit_Magnetize) == 0x698);
    };
};
