...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float cast_radius; // 0x5b0            
            float rock_explosion_radius; // 0x5b4            
            float damage_duration; // 0x5b8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_EarthSpirit_Magnetize) == 0x5c0);
    };
};
