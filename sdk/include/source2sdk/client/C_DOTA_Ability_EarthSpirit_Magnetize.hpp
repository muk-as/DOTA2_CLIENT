...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float cast_radius; // 0x680            
            float rock_explosion_radius; // 0x684            
            float damage_duration; // 0x688            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_EarthSpirit_Magnetize) == 0x690);
    };
};
