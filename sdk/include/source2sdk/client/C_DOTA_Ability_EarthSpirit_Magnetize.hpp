...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t cast_radius; // 0x600        
        int32_t rock_explosion_radius; // 0x604        
        float damage_duration; // 0x608        
    ...
    static_assert(sizeof(C_DOTA_Ability_EarthSpirit_Magnetize) == 0x610);
};
