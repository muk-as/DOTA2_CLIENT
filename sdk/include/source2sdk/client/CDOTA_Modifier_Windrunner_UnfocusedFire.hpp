...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t nQuadrant; // 0x16e8        
        int32_t focusfire_damage_reduction; // 0x16ec        
        int32_t bonus_range; // 0x16f0        
        [[maybe_unused]] std::uint8_t pad_0x16f4[0x44];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Windrunner_UnfocusedFire because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Windrunner_UnfocusedFire) == 0x1738);
};
