...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float mana_per_second; // 0x188c            
            float radius; // 0x1890            
            float break_distance; // 0x1894            
            float damage_interval; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Shredder_Chakram_Thinker) == 0x18a0);
    };
};
