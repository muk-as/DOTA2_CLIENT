...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iMaxDist; // 0x1888            
            std::int32_t destroy_attacks; // 0x188c            
            Vector m_vDirection; // 0x1890            
            Vector m_vStartLoc; // 0x189c            
            ...
            char m_hAttachTarget[0x4]; // 0x18a8            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Weaver_Swarm) == 0x18b0);
    };
};
