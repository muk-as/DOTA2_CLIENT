...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Animation_TailSpin : public client::CDOTA_Buff
    {
    public:
        int32_t damage; // 0x16e8        
        int32_t damage_radius; // 0x16ec        
        float m_flPlaybackRate; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Animation_TailSpin) == 0x1710);
};
