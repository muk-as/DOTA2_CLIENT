...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t shard_regen_reduction_pct_per_stack; // 0x_            
            float shard_burst_radius; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_DrowRanger_FrostArrows_Hypothermia) == 0x_);
    };
};
