...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t acceleration; // 0x1878            
            std::int32_t m_nTeamNumber; // 0x187c            
            float speed; // 0x1880            
            float pre_chase_time; // 0x1884            
            ...
            source2sdk::client::CountdownTimer m_MoveTime; // 0x1898            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Techies_StickyBomb_Chase because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Techies_StickyBomb_Chase) == 0x18b0);
    };
};
