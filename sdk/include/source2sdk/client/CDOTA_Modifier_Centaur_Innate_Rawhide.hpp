...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t health_per_upgrade; // 0x17fc            
            std::int32_t iCurrentCount; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Centaur_Innate_Rawhide) == 0x1808);
    };
};
