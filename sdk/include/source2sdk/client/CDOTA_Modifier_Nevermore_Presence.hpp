...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t presence_armor_reduction; // 0x1708        
        int32_t bonus_armor_per_stack; // 0x170c        
        bool m_bWasHidden; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_Nevermore_Presence) == 0x1718);
};
