...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t presence_armor_reduction; // 0x1878            
            std::int32_t bonus_armor_per_stack; // 0x187c            
            bool m_bWasHidden; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Nevermore_Presence) == 0x1888);
    };
};
