...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_GungirChain : public client::CDOTA_Buff
    {
    public:
    ...
    // Cannot assert offsets of fields in CDOTA_Modifier_GungirChain because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_GungirChain) == 0x1720);
};
