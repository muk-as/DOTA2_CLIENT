...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nSkeletonWarriors; // 0x1d98            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnSKArcanaProgressChanged"
            std::int32_t m_vecInitialHeroKillBitmask[5]; // 0x1d9c            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnSKArcanaProgressChanged"
            std::int32_t m_vecInGameHeroKillBitmask[5]; // 0x1db0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Hero_SkeletonKing) == 0x1dc8);
    };
};
