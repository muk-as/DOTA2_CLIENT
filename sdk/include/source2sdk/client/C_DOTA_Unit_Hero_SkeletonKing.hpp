...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t m_nSkeletonWarriors; // 0x1bf8        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnSKArcanaProgressChanged"
        int32_t m_vecInitialHeroKillBitmask[5]; // 0x1bfc        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnSKArcanaProgressChanged"
        int32_t m_vecInGameHeroKillBitmask[5]; // 0x1c10        
        [[maybe_unused]] std::uint8_t pad_0x1c24[0x4];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_DOTA_Unit_Hero_SkeletonKing because it is not a standard-layout class
    static_assert(sizeof(C_DOTA_Unit_Hero_SkeletonKing) == 0x1c28);
};
