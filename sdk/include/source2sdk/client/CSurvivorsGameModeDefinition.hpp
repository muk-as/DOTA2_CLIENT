...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_sPhysicalWeaknessEffect[0xe0]; // 0x938        
        ...
        char m_sGenericStunEffect[0xe0]; // 0xa18        
        Color m_cEliteGlowColor; // 0xaf8        
        float m_flLevelUpDelay; // 0xafc        
        float m_flLevelUpKnockbackRadius; // 0xb00        
        float m_flLevelUpKnockbackDistance; // 0xb04        
        ...
        char m_sLevelUpEffect[0xe0]; // 0xb08        
        ...
        char m_sLevelUpKnockbackEffect[0xe0]; // 0xbe8        
        ...
        char m_sPlayerHitEffect[0xe0]; // 0xcc8        
        ...
        char m_vecSeperationLayerData[0x18]; // 0xda8        
        client::CSurvivorsLootTable m_luckyLootTable; // 0xdc0        
        [[maybe_unused]] std::uint8_t pad_0xdd8[0x28];
    };
    #pragma pack(pop)
    ...
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_sPhysicalWeaknessEffect) == 0x938);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_sGenericStunEffect) == 0xa18);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_cEliteGlowColor) == 0xaf8);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_flLevelUpDelay) == 0xafc);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_flLevelUpKnockbackRadius) == 0xb00);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_flLevelUpKnockbackDistance) == 0xb04);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_sLevelUpEffect) == 0xb08);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_sLevelUpKnockbackEffect) == 0xbe8);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_sPlayerHitEffect) == 0xcc8);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_vecSeperationLayerData) == 0xda8);
    static_assert(offsetof(CSurvivorsGameModeDefinition, m_luckyLootTable) == 0xdc0);
    
    static_assert(sizeof(CSurvivorsGameModeDefinition) == 0xe00);
};
