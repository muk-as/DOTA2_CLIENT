...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t magic_resist_pct; // 0x17fc            
            std::int32_t m_nTotalBonusDamage; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Rubick_Might_And_Magus) == 0x1808);
    };
};
