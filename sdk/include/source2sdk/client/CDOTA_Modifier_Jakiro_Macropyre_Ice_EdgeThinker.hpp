...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t ice_edge_path_radius; // 0x1804            
            std::int32_t cast_range; // 0x1808            
            float ice_edge_linger_duration; // 0x180c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Jakiro_Macropyre_Ice_EdgeThinker) == 0x1810);
    };
};
