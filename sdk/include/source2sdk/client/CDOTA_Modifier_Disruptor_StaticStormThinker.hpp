...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nCurrentPulse; // 0x1878            
            float radius; // 0x187c            
            std::int32_t damage_max; // 0x1880            
            std::int32_t pulses; // 0x1884            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Disruptor_StaticStormThinker) == 0x1890);
    };
};
