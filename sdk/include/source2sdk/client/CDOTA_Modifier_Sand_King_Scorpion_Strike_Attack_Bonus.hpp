...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t inner_radius_bonus_damage_pct; // 0x_            
            bool m_bIsInnerRadiusHit; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Sand_King_Scorpion_Strike_Attack_Bonus) == 0x_);
    };
};
