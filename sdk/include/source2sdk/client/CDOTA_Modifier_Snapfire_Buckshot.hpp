...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t split_shot; // 0x1890            
            std::int32_t glancing_shot_damage_pct; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Snapfire_Buckshot) == 0x18b0);
    };
};
