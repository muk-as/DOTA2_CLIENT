...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t all_stats; // 0x1960            
            std::int32_t reflect_chance; // 0x1964            
            bool m_bProcSuccessful; // 0x1968            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Mirror_Shield) == 0x1970);
    };
};
