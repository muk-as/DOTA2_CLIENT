...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t damage_min; // 0x18d8            
            std::int32_t damage_max; // 0x18dc            
            std::int32_t slow_min; // 0x18e0            
            std::int32_t slow_max; // 0x18e4            
            float slow_duration; // 0x18e8            
            float windup_time; // 0x18ec            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_Ascension_PlasmaField_Thinker) == 0x18f0);
    };
};
