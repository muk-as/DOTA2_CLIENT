...
namespace source2sdk::client
{
    ...
    public:
        ...
        bool m_bWindingUp; // 0x1714        
        [[maybe_unused]] std::uint8_t pad_0x1715[0x3]; // 0x1715
        client::CountdownTimer m_ViewerTimer; // 0x1718        
        ...
        int32_t damage_min; // 0x1758        
        int32_t damage_max; // 0x175c        
        int32_t slow_min; // 0x1760        
        int32_t slow_max; // 0x1764        
        float slow_duration; // 0x1768        
        float windup_time; // 0x176c        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_AghsFort_Ascension_PlasmaField_Thinker) == 0x1770);
};
