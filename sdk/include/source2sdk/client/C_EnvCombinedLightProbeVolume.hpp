...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            Color m_Entity_Color; // 0x_            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "StateChanged"
            float m_Entity_flBrightness; // 0x_            
            // metadata: MNetworkEnable
            ...
            // Datamap fields:
            // void m_Entity_pEnvMap; // 0x_
            // void m_Entity_pLightProbeVolume; // 0x_
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_EnvCombinedLightProbeVolume because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_EnvCombinedLightProbeVolume) == 0x_);
    };
};
