...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::CountdownTimer m_ctRespawn; // 0x1a08            
            source2sdk::client::C_DOTA_BaseNPC* m_pTombstone; // 0x1a20            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Unit_Undying_Zombie because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Undying_Zombie) == 0x1a28);
    };
};
