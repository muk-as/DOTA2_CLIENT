...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hCamera[0x_]; // 0x_            
            source2sdk::client::PointCameraSettings_t m_OverlaidStart; // 0x_            
            source2sdk::client::PointCameraSettings_t m_OverlaidEnd; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CPulseCell_LerpCameraSettings::CursorState_t because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CPulseCell_LerpCameraSettings_CursorState_t) == 0x_);
    };
};
