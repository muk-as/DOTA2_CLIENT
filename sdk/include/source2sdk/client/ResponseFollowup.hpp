...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::ResponseFollowup, followup_target) == 0x14);
        static_assert(offsetof(source2sdk::client::ResponseFollowup, followup_entityiotarget) == 0x1c);
        static_assert(offsetof(source2sdk::client::ResponseFollowup, followup_entityioinput) == 0x24);
