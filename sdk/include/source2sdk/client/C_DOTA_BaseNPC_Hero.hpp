...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_iCurrentXP; // 0x1a50            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnAbilityPointsChanged"
            std::int32_t m_iAbilityPoints; // 0x1a54            
            // metadata: MNetworkEnable
            std::int32_t m_iTotalAbilityPoints; // 0x1a58            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flRespawnTime; // 0x1a5c            
            // metadata: MNetworkEnable
            float m_flRespawnTimePenalty; // 0x1a60            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnBaseStatChanged"
            float m_flStrength; // 0x1a64            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnBaseStatChanged"
            float m_flAgility; // 0x1a68            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnBaseStatChanged"
            float m_flIntellect; // 0x1a6c            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnBaseStatChanged"
            float m_flStrengthTotal; // 0x1a70            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnBaseStatChanged"
            float m_flAgilityTotal; // 0x1a74            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnBaseStatChanged"
            float m_flIntellectTotal; // 0x1a78            
            ...
            char m_hFacetAbilities[0x18]; // 0x1a80            
            // metadata: MNetworkEnable
            std::int32_t m_iRecentDamage; // 0x1a98            
            float m_fPainFactor; // 0x1a9c            
            float m_fTargetPainFactor; // 0x1aa0            
            bool m_bLifeState; // 0x1aa4            
            bool m_bFirstSpawn; // 0x1aa5            
            uint8_t _pad1aa6[0x2]; // 0x1aa6
            source2sdk::client::ParticleIndex_t m_nFXStunIndex; // 0x1aa8            
            source2sdk::client::ParticleIndex_t m_nFXSilenceIndex; // 0x1aac            
            source2sdk::client::ParticleIndex_t m_nFXDeathIndex; // 0x1ab0            
            uint8_t _pad1ab4[0x24]; // 0x1ab4
            // metadata: MNetworkEnable
            source2sdk::client::PlayerID_t m_iPlayerID; // 0x1ad8            
            uint8_t _pad1adc[0x4]; // 0x1adc
            // metadata: MNetworkEnable
            source2sdk::client::HeroFacetKey_t m_iHeroFacetKey; // 0x1ae0            
            // metadata: MNetworkEnable
            ...
            char m_hReplicatingOtherHeroModel[0x4]; // 0x1ae8            
            // metadata: MNetworkEnable
            bool m_bReincarnating; // 0x1aec            
            // metadata: MNetworkEnable
            bool m_bCustomKillEffect; // 0x1aed            
            uint8_t _pad1aee[0x2]; // 0x1aee
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flSpawnedAt; // 0x1af0            
            // metadata: MNetworkEnable
            bool m_bScriptDisableRespawns; // 0x1af4            
            uint8_t _pad1af5[0x3]; // 0x1af5
            // metadata: MNetworkEnable
            std::int32_t m_iPrimaryAttribute; // 0x1af8            
            std::int32_t m_nLastDrawnHealth; // 0x1afc            
            float m_flHurtAmount; // 0x1b00            
            source2sdk::entity2::GameTime_t m_flLastHurtTime; // 0x1b04            
            float m_flHurtDecayRate; // 0x1b08            
            float m_flHealAmount; // 0x1b0c            
            source2sdk::entity2::GameTime_t m_flLastHealTime; // 0x1b10            
            float m_flHealDecayRate; // 0x1b14            
            bool m_bIsFirstTimeHeal; // 0x1b18            
            uint8_t _pad1b19[0x3]; // 0x1b19
            source2sdk::entity2::GameTime_t m_flLastTreeShakeTime; // 0x1b1c            
            source2sdk::client::CountdownTimer m_CenterOnHeroCooldownTimer; // 0x1b20            
            uint8_t _pad1b38[0x208]; // 0x1b38
            ...
            char m_CombinedModels[0x20]; // 0x1d40            
            std::int32_t m_nCurrentCombinedModelIndex; // 0x1d60            
            std::int32_t m_nPendingCombinedModelIndex; // 0x1d64            
            source2sdk::client::HeroID_t m_iHeroID; // 0x1d68            
            float m_flCheckLegacyItemsAt; // 0x1d6c            
            bool m_bDisplayAdditionalHeroes; // 0x1d70            
            uint8_t _pad1d71[0xf]; // 0x1d71
            ...
            char m_CombinedParticleModels[0x20]; // 0x1d80            
            ...
            char m_vecAttachedParticleIndeces[0x18]; // 0x1da0            
            ...
            char m_hPets[0x18]; // 0x1db8            
            source2sdk::client::ParticleIndex_t m_nKillStreakFX; // 0x1dd0            
            std::int32_t m_nKillStreakFXTier; // 0x1dd4            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_Hero) == 0x1de0);
    };
};
