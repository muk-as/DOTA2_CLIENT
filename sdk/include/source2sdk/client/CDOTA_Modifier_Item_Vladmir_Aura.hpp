...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t lifesteal_aura; // 0x1708        
        int32_t damage_aura; // 0x170c        
        float armor_aura; // 0x1710        
        float mana_regen_aura; // 0x1714        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Vladmir_Aura) == 0x1720);
};
