...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Item_Arcane_Scout : public source2sdk::client::C_DOTA_Item
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Item_Arcane_Scout) == 0x730);
    };
};
