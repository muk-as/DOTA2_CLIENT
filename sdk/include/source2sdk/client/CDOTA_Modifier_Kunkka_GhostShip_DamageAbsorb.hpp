...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flAccumulatedDamage; // 0x17f8            
            std::int32_t movespeed_bonus; // 0x17fc            
            float ghostship_absorb; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kunkka_GhostShip_DamageAbsorb) == 0x1808);
    };
};
