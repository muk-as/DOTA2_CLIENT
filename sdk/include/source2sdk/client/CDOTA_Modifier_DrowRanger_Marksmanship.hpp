...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_GlacialInFlightAttackRecords[0x_]; // 0x_            
            std::int32_t bonus_factor; // 0x_            
            std::int32_t disable_range; // 0x_            
            std::int32_t agility_range; // 0x_            
            std::int32_t bonus_damage; // 0x_            
            std::int32_t split_count; // 0x_            
            std::int32_t split_range; // 0x_            
            bool m_bGlacialAttack; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_DrowRanger_Marksmanship) == 0x_);
    };
};
