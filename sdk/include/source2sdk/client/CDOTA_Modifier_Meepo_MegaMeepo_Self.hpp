...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t base_int; // 0x17fc            
            std::int32_t base_agi; // 0x1800            
            std::int32_t stats_pct; // 0x1804            
            ...
            char m_hMegameepoFrame[0x4]; // 0x1808            
            bool m_bWasOutOfGame; // 0x180c            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Meepo_MegaMeepo_Self) == 0x1810);
    };
};
