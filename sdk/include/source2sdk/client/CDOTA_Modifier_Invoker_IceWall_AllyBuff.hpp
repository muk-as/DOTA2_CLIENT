...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t ally_speed; // 0x1878            
            float ally_armor; // 0x187c            
            float ally_healing; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_IceWall_AllyBuff) == 0x1888);
    };
};
