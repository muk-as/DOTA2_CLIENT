...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t ally_speed; // 0x17f8            
            float ally_armor; // 0x17fc            
            float ally_healing; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_IceWall_AllyBuff) == 0x1808);
    };
};
