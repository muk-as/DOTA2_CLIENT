...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Unit_Templar_Gate : public source2sdk::client::C_DOTA_BaseNPC_Building
        {
        public:
            ...
            char m_hOtherPortal[0x4]; // 0x1ab0            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Unit_Templar_Gate) == 0x1ab8);
    };
};
