...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::CountdownTimer m_CooldownTimer; // 0x17f8            
            std::int32_t maim_chance; // 0x1810            
            float maim_duration; // 0x1814            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lycan_SummonWolves_CriticalStrike) == 0x1818);
    };
};
