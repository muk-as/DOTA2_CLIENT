...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            CUtlString m_strActivityModifier; // 0x_            
            std::int32_t stolen_debuff_amp; // 0x_            
            float stolen_mana_reduction; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Rubick_SpellSteal because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Rubick_SpellSteal) == 0x_);
    };
};
