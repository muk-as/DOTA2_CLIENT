...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flChronosphereDuration; // 0x_            
            float m_flChronosphereStartTime; // 0x_            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_FacelessVoid_Chronosphere_Freeze) == 0x_);
    };
};
