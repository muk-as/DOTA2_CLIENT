...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float model_scale_per_stack; // 0x17f8            
            bool m_bIsRadiant; // 0x17fc            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Seasonal_Summon_TI11_Balloon_Visuals) == 0x1800);
    };
};
