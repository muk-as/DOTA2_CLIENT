...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t overprotective_damage_threshold; // 0x_            
            float overprotective_damage_reset_interval; // 0x_            
            float overprotective_wisp_duration; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enchantress_NaturesAttendants_DamageTracker) == 0x_);
    };
};
