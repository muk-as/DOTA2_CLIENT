...
namespace source2sdk::client
{
    ...
    public:
        ...
        // CUtlVector<CUtlPair<CHandle<client::C_BaseEntity>,entity2::GameTime_t>> m_vecTreeFires;
        char m_vecTreeFires[0x18]; // 0x1708        
        bool m_bCleanupWhenEmpty; // 0x1720        
    ...
    static_assert(sizeof(CDOTA_Modifier_Shredder_Flamethrower_TreeFire_Thinker) == 0x1728);
};
