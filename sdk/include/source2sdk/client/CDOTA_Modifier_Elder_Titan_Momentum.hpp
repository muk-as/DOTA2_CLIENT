...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t attack_speed_penalty; // 0x_            
            std::int32_t attack_speed_from_movespeed; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Elder_Titan_Momentum) == 0x_);
    };
};
