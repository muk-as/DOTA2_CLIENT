...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t attack_speed_penalty; // 0x1888            
            std::int32_t attack_speed_from_movespeed; // 0x188c            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Elder_Titan_Momentum) == 0x1898);
    };
};
