...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hCourierStateEntity[0x4]; // 0x181c        
        [[maybe_unused]] std::uint8_t pad_0x1820[0xe0];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_DOTA_Unit_Courier because it is not a standard-layout class
    static_assert(sizeof(C_DOTA_Unit_Courier) == 0x1900);
};
