...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::ParticleIndex_t m_nFxHuskIndex; // 0x1700        
        client::ParticleIndex_t m_nFxIndexA; // 0x1704        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Huskar_Berserkers_Blood because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Huskar_Berserkers_Blood) == 0x1708);
};
