...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t creep_damage_bonus; // 0x1888            
            std::int32_t hero_damage_penalty; // 0x188c            
            std::int32_t heavy_damage_penalty; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Creep_Piercing) == 0x1898);
    };
};
