...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float jump_range; // 0x1888            
            std::int32_t jumps_remaining; // 0x188c            
            std::int32_t damage_to_heroes; // 0x1890            
            std::int32_t heroes_killed; // 0x1894            
            bool m_bFoundTarget; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lich_Chain_Frost_Frostbound) == 0x18b8);
    };
};
