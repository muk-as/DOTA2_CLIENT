...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float damage; // 0x6a0            
            float range; // 0x6a4            
            float yaw_offset; // 0x6a8            
            std::int32_t projectile_width; // 0x6ac            
            float neutral_shared_cooldown; // 0x6b0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Frogmen_TendrilsOfTheDeep) == 0x6c8);
    };
};
