...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Ability_Frogmen_TendrilsOfTheDeep : public source2sdk::client::C_DOTABaseAbility
        {
        public:
            ...
            float damage; // 0x5d0            
            float range; // 0x5d4            
            float yaw_offset; // 0x5d8            
            std::int32_t projectile_width; // 0x5dc            
            float neutral_shared_cooldown; // 0x5e0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Frogmen_TendrilsOfTheDeep) == 0x5f0);
    };
};
