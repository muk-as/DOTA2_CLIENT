...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float shard_width; // 0x_            
            float shard_damage; // 0x_            
            std::int32_t shard_count; // 0x_            
            float shard_speed; // 0x_            
            float shard_duration; // 0x_            
            float shard_angle_step; // 0x_            
            float shard_distance; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Tusk_IceShards) == 0x_);
    };
};
