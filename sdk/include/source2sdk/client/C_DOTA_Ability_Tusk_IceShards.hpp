...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float shard_width; // 0x5b4            
            float shard_damage; // 0x5b8            
            std::int32_t shard_count; // 0x5bc            
            float shard_speed; // 0x5c0            
            float shard_duration; // 0x5c4            
            float shard_angle_step; // 0x5c8            
            float shard_distance; // 0x5cc            
            Vector m_vSpawnOrigin; // 0x5d0            
            Vector m_vDirection; // 0x5dc            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Tusk_IceShards) == 0x600);
    };
};
