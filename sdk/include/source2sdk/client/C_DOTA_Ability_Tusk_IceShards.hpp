...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float shard_width; // 0x684            
            float shard_damage; // 0x688            
            std::int32_t shard_count; // 0x68c            
            float shard_speed; // 0x690            
            float shard_duration; // 0x694            
            float shard_angle_step; // 0x698            
            float shard_distance; // 0x69c            
            Vector m_vSpawnOrigin; // 0x6a0            
            Vector m_vDirection; // 0x6ac            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Tusk_IceShards) == 0x6d0);
    };
};
