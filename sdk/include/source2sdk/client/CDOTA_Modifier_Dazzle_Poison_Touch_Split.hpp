...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nAttacksLanded; // 0x_            
            std::int32_t attacks_to_split; // 0x_            
            std::int32_t split_radius; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Dazzle_Poison_Touch_Split) == 0x_);
    };
};
