...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<CHandle<source2sdk::client::C_BaseEntity>> m_hShardWatchPathThinkers;
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_VoidSpirit_AetherRemnant_Unit) == 0x1938);
    };
};
