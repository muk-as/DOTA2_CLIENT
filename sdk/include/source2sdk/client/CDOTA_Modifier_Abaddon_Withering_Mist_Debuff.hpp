...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t heal_reduction_pct; // 0x_            
            std::int32_t hp_threshold_pct; // 0x_            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x_            
            bool bUnderThreshold; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Abaddon_Withering_Mist_Debuff) == 0x_);
    };
};
