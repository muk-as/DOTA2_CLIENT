...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t heal_reduction_pct; // 0x1878            
            std::int32_t hp_threshold_pct; // 0x187c            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1880            
            bool bUnderThreshold; // 0x1884            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Abaddon_Withering_Mist_Debuff) == 0x1888);
    };
};
