...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::SurvivorsParticleID_t m_unParticleID; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::particleslib::CNewParticleEffect* m_pParticle; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CSurvivorsPowerUp_Stampede because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CSurvivorsPowerUp_Stampede) == 0x_);
    };
};
