...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t pull_units_per_second; // 0x1894            
            float pull_distance_limit; // 0x1898            
            uint8_t _pad189c[0x14]; // 0x189c
            float animation_rate; // 0x18b0            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Pudge_Dismember_Pull) == 0x18b8);
    };
};
