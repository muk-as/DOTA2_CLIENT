...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CGameSceneNodeHandle m_hParent; // 0x_            
            // metadata: MNetworkEnable
            // metadata: MNetworkPriority "32"
        ...
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_nodeToWorld) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_pOwner) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_pParent) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_pChild) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_pNextSibling) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_hParent) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_vecOrigin) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_angRotation) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_flScale) == 0x_);
        ...
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_bForceParentToBeNetworked) == 0x_);
        ...
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_nHierarchicalDepth) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_nHierarchyType) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_nDoNotSetAnimTimeInInvalidatePhysicsCount) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_name) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_hierarchyAttachName) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_flZOffset) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_flClientLocalScale) == 0x_);
        static_assert(offsetof(source2sdk::client::CGameSceneNode, m_vRenderOrigin) == 0x_);
        
        static_assert(sizeof(source2sdk::client::CGameSceneNode) == 0x_);
    };
};
