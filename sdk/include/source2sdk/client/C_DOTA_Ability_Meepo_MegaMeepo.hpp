...
namespace source2sdk::client
{
    ...
    public:
        ...
        char hMegameepoFrame[0x4]; // 0x604        
        ...
        char hListOfMeepos[0x18]; // 0x608        
        bool m_bHasSwappedAbilities; // 0x620        
    ...
    static_assert(sizeof(C_DOTA_Ability_Meepo_MegaMeepo) == 0x628);
};
