...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char hMegameepoFrame[0x4]; // 0x5b4            
            ...
            char hListOfMeepos[0x18]; // 0x5b8            
            bool m_bHasSwappedAbilities; // 0x5d0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Meepo_MegaMeepo) == 0x5d8);
    };
};
