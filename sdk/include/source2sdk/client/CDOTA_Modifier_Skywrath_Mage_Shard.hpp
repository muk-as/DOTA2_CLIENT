...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t damage_barrier_base; // 0x188c            
            std::int32_t damage_barrier_per_level; // 0x1890            
            float barrier_duration; // 0x1894            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Skywrath_Mage_Shard because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Skywrath_Mage_Shard) == 0x1898);
    };
};
