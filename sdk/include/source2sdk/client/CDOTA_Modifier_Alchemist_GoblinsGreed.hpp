...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_DeathList[0x_]; // 0x_            
            float damage; // 0x_            
            float duration; // 0x_            
            std::int32_t bonus_gold; // 0x_            
            std::int32_t bonus_bonus_gold; // 0x_            
            std::int32_t bonus_gold_cap; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Alchemist_GoblinsGreed) == 0x_);
    };
};
