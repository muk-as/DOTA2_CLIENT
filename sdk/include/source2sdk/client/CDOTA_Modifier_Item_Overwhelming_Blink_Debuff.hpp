...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Overwhelming_Blink_Debuff) == 0x1808);
    };
};
