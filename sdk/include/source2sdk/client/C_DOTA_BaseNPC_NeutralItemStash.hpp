...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecNewItemFX[0x18]; // 0x1ac8            
            bool m_bHasFoundProps; // 0x1ae0            
            bool m_bDidHaveNewItems; // 0x1ae1            
