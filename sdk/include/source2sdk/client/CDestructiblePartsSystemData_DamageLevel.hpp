...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_sName) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_sBreakablePieceName) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_nBodyGroupValue) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_nHealth) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_nDamagePassthroughType) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_nDestructionDeathBehavior) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_sCustomDeathHandshake) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_bShouldDestroyOnDeath) == 0x_);
        static_assert(offsetof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel, m_flDeathDestroyTime) == 0x_);
        
        static_assert(sizeof(source2sdk::client::CDestructiblePartsSystemData_DamageLevel) == 0x_);
    };
};
