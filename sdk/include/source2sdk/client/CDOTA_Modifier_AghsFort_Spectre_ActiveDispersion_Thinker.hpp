...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CountdownTimer m_ViewerTimer; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_Spectre_ActiveDispersion_Thinker) == 0x18d0);
    };
};
