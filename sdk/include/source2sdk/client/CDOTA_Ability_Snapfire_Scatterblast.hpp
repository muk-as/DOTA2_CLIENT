...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t point_blank_range; // 0x_            
            float point_blank_dmg_bonus_pct; // 0x_            
            float blast_width_end; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Snapfire_Scatterblast) == 0x_);
    };
};
