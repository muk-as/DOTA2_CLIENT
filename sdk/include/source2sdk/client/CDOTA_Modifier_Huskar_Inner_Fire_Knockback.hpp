...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float knockback_duration; // 0x17fc            
            float effective_distance; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Huskar_Inner_Fire_Knockback) == 0x1808);
    };
};
