...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_UltimateScepter_Consumed_Alchemist : public source2sdk::client::CDOTA_Modifier_Item_UltimateScepter_Consumed
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_UltimateScepter_Consumed_Alchemist) == 0x1808);
    };
};
