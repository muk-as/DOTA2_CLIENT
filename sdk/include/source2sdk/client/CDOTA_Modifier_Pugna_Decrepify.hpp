...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_heal_amp_pct_allies; // 0x_            
            std::int32_t bonus_movement_speed; // 0x_            
            std::int32_t bonus_movement_speed_allies; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Pugna_Decrepify because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Pugna_Decrepify) == 0x_);
    };
};
