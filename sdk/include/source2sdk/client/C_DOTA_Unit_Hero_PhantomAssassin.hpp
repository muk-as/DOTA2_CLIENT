...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Unit_Hero_PhantomAssassin : public source2sdk::client::C_DOTA_BaseNPC_Hero
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Hero_PhantomAssassin) == 0x1db8);
    };
};
