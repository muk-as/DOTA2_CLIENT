...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nAmbientFXIndex; // 0x998            
            ...
            char m_nFXIndex[0x8]; // 0x9a0            
            Color m_ParticleTintColor; // 0x9a8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_PortraitBuilding) == 0x9b0);
    };
};
