...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class C_DOTA_Ability_TemplarAssassin_Trap_Teleport : public client::C_DOTABaseAbility
    {
    public:
    ...
    static_assert(sizeof(C_DOTA_Ability_TemplarAssassin_Trap_Teleport) == 0x5e0);
};
