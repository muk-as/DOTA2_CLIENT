...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float health_damage; // 0x17f8            
            float attack_slow; // 0x17fc            
            float movement_slow_max; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Venomancer_NoxiousPlagueSecondary) == 0x1808);
    };
};
