...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bIsCurrentlyChanneling; // 0x1a50            
            uint8_t _pad1a51[0x3]; // 0x1a51
            // metadata: MNetworkEnable
            float m_flChannelCycle; // 0x1a54            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_BaseNPC_Creature because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_Creature) == 0x1a58);
    };
};
