...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_iIndex; // 0x5b4            
            float cooldown_reduction_on_kill; // 0x5b8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Sniper_Assassinate) == 0x5c0);
    };
};
