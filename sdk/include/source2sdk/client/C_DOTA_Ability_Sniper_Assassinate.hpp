...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_iIndex; // 0x68c            
            float cooldown_reduction_on_kill; // 0x690            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Sniper_Assassinate) == 0x698);
    };
};
