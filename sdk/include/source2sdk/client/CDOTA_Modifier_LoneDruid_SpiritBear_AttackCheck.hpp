...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            bool m_bCanBeResummoned; // 0x1888            
            bool m_bCanAttack; // 0x1889            
            uint8_t _pad188a[0x2]; // 0x188a
            source2sdk::client::ParticleIndex_t m_nFxIndex; // 0x188c            
            source2sdk::client::ParticleIndex_t m_nStatusFxIndex; // 0x1890            
            std::int32_t bear_attack_leash_range; // 0x1894            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_LoneDruid_SpiritBear_AttackCheck) == 0x1898);
    };
};
