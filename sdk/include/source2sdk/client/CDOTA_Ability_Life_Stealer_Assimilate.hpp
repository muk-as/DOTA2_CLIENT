...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Life_Stealer_Assimilate : public client::C_DOTABaseAbility
    {
    public:
        ...
        // CHandle<client::C_BaseEntity> m_hLastAssimilation;
        char m_hLastAssimilation[0x4]; // 0x5d8        
    ...
    static_assert(sizeof(CDOTA_Ability_Life_Stealer_Assimilate) == 0x5e0);
};
