...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t speed_boost; // 0x1708        
        int32_t trail_radius; // 0x170c        
        float trail_duration; // 0x1710        
        Vector m_vLastTrailThinkerLocation; // 0x1714        
        bool m_bTrailStarted; // 0x1720        
    ...
    static_assert(sizeof(CDOTA_Modifier_DarkSeer_Surge) == 0x1728);
};
