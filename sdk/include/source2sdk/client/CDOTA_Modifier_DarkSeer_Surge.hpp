...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t speed_boost; // 0x_            
            float trail_radius; // 0x_            
            float trail_duration; // 0x_            
            Vector m_vLastTrailThinkerLocation; // 0x_            
            bool m_bTrailStarted; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_DarkSeer_Surge) == 0x_);
    };
};
