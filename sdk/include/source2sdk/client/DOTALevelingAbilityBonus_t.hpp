...
namespace source2sdk::client
{
    ...
    static_assert(offsetof(DOTALevelingAbilityBonus_t, m_pszName) == 0x0);
    static_assert(offsetof(DOTALevelingAbilityBonus_t, m_vecValues) == 0x8);
    static_assert(offsetof(DOTALevelingAbilityBonus_t, m_eOperation) == 0x20);
    
    static_assert(sizeof(DOTALevelingAbilityBonus_t) == 0x28);
};
