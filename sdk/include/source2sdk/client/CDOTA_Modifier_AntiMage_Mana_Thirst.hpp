...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AntiMage_Mana_Thirst) == 0x_);
    };
};
