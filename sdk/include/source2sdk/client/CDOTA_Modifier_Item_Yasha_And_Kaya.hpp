...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t spell_amp; // 0x16f8        
        int32_t mana_regen_multiplier; // 0x16fc        
        int32_t spell_lifesteal_amp; // 0x1700        
        int32_t cast_speed_pct; // 0x1704        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Item_Yasha_And_Kaya because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Item_Yasha_And_Kaya) == 0x1708);
};
