...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CSurvivorsPowerUp_AreaAttack : public client::CSurvivorsPowerUp
    {
    public:
        ...
        // CUtlVector<client::CSurvivorsPowerUpDamageTickInfo> m_vecQueuedDamageTicks;
        char m_vecQueuedDamageTicks[0x18]; // 0x7c8        
        client::ESurvivorsAreaAttackOrigin m_eOrigin; // 0x7e0        
        ...
        // CUtlVector<client::CSurvivorsAttackParticleInfo> m_vecAttackParticles;
    ...
    static_assert(sizeof(CSurvivorsPowerUp_AreaAttack) == 0x800);
};
