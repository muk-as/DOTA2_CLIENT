...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x_            
            std::int32_t ally_speed; // 0x_            
            float ally_armor; // 0x_            
            float ally_healing; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_IceWall_AllyBuffAura) == 0x_);
    };
};
