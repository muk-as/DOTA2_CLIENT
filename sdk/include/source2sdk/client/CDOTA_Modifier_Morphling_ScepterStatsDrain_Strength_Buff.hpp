...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t nAgiSteal; // 0x1804            
            std::int32_t nIntSteal; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Morphling_ScepterStatsDrain_Strength_Buff) == 0x1810);
    };
};
