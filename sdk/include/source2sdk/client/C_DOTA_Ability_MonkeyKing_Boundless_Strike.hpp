...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float strike_cast_range; // 0x680            
            float strike_radius; // 0x684            
            std::int32_t spring_channel_pct; // 0x688            
