...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t hp_regen_reduction; // 0x1890            
            std::int32_t m_nTicksRemaining; // 0x1894            
            float m_flAttackDamage; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Venomancer_PoisonStingWard) == 0x18a0);
    };
};
