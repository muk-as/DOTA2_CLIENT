...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float attack_slow; // 0x17f8            
            float movement_slow_max; // 0x17fc            
            float movement_slow_min; // 0x1800            
            float debuff_radius; // 0x1804            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Venomancer_NoxiousPlague_Slow) == 0x1808);
    };
};
