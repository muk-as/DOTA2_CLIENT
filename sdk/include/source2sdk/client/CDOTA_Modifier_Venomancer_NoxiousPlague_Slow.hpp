...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float attack_slow; // 0x1888            
            float movement_slow_max; // 0x188c            
            float movement_slow_min; // 0x1890            
            float debuff_radius; // 0x1894            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Venomancer_NoxiousPlague_Slow) == 0x1898);
    };
};
