...
namespace source2sdk::client
{
    ...
    {
    public:
        float attack_slow; // 0x1708        
        float movement_slow_max; // 0x170c        
        float movement_slow_min; // 0x1710        
        float debuff_radius; // 0x1714        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Venomancer_NoxiousPlague_Slow) == 0x1718);
};
