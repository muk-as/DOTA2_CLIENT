...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_movespeed_pct_self; // 0x_            
            std::int32_t bonus_movespeed_pct_allies; // 0x_            
            std::int32_t bonus_movespeed_pct_extra; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_SpiritBreaker_EmpoweringHaste) == 0x_);
    };
};
