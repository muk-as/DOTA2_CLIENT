...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float trigger_radius; // 0x187c            
            float minefield_duration; // 0x1880            
            bool m_bTriggered; // 0x1884            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Techies_Minefield_Sign_Thinker) == 0x1888);
    };
};
