...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float bonus_per_kill; // 0x1890            
            float max_kill_bonus; // 0x1894            
            float kill_bonus_window; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Phylactery) == 0x18b8);
    };
};
