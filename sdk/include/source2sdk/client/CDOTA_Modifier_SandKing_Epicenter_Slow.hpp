...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t epicenter_slow; // 0x1878            
            std::int32_t epicenter_slow_as; // 0x187c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_SandKing_Epicenter_Slow because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_SandKing_Epicenter_Slow) == 0x1880);
    };
};
