...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::CountdownTimer m_RevealTimer; // 0x_            
            source2sdk::client::CountdownTimer m_InvisAttackTimer; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_TreantMiniboss_NaturesGuise) == 0x_);
    };
};
