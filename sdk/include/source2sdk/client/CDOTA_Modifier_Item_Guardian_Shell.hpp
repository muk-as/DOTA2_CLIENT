...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float counter_cooldown; // 0x1800            
            source2sdk::entity2::GameTime_t m_flLastCounterTime; // 0x1804            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Guardian_Shell because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Guardian_Shell) == 0x1808);
    };
};
