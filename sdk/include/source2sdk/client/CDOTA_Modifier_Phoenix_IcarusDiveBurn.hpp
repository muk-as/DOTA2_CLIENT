...
namespace source2sdk::client
{
    ...
    {
    public:
        float burn_tick_interval; // 0x1708        
        float blind_duration; // 0x170c        
        int32_t blind_per_second; // 0x1710        
        int32_t damage_per_second; // 0x1714        
        int32_t slow_movement_speed_pct; // 0x1718        
    ...
    static_assert(sizeof(CDOTA_Modifier_Phoenix_IcarusDiveBurn) == 0x1720);
};
