...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t m_iKillerTeam; // 0x1808        
        int32_t m_iLastHealthPercent; // 0x180c        
        ...
        bool m_bGoldenRoshan; // 0x1830        
        bool m_bIsNightTimeMode; // 0x1831        
        [[maybe_unused]] std::uint8_t pad_0x1832[0x6];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_DOTA_Unit_Roshan because it is not a standard-layout class
    static_assert(sizeof(C_DOTA_Unit_Roshan) == 0x1838);
};
