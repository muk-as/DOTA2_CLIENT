...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iKillerTeam; // 0x1a40            
            std::int32_t m_iLastHealthPercent; // 0x1a44            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1a48            
            ...
            char m_hRadiantRoshanPit[0x4]; // 0x1a4c            
            ...
            char m_hDireRoshanPit[0x4]; // 0x1a50            
            ...
            char m_hRiverMidpoint[0x4]; // 0x1a54            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Roshan) == 0x1a78);
    };
};
