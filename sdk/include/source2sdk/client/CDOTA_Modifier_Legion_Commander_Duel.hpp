...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t reward_damage; // 0x_            
            std::int32_t assist_reward_damage; // 0x_            
            std::int32_t damage_reduction_pct; // 0x_            
            std::int32_t debuff_immunity; // 0x_            
            bool m_bAttacked; // 0x_            
            bool m_bHadAVictor; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::entity2::GameTime_t m_flTimeDuelStart; // 0x_            
