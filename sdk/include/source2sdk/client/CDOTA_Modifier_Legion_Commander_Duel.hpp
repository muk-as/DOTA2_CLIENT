...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t reward_damage; // 0x1888            
            std::int32_t assist_reward_damage; // 0x188c            
            std::int32_t damage_reduction_pct; // 0x1890            
            std::int32_t debuff_immunity; // 0x1894            
            bool m_bAttacked; // 0x1898            
            bool m_bHadAVictor; // 0x1899            
            uint8_t _pad189a[0x2]; // 0x189a
            source2sdk::entity2::GameTime_t m_flTimeDuelStart; // 0x189c            
            ...
            // CUtlVector<CHandle<source2sdk::client::C_BaseEntity>> m_hAllyAssisters;
            char m_hAllyAssisters[0x18]; // 0x18c0            
            ...
            // CUtlVector<CHandle<source2sdk::client::C_BaseEntity>> m_hEnemyAssisters;
            char m_hEnemyAssisters[0x18]; // 0x18d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Legion_Commander_Duel because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Legion_Commander_Duel) == 0x18f0);
    };
};
