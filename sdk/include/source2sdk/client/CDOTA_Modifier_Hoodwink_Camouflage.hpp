...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_flFadeTime; // 0x188c            
            bool m_bInvisLastThink; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Hoodwink_Camouflage) == 0x1898);
    };
};
