...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Grimstroke_Scepter_Buff : public client::CDOTA_Modifier_DebuffImmune
    {
    public:
        int32_t images_movespeed_bonus; // 0x1708        
    ...
    static_assert(sizeof(CDOTA_Modifier_Grimstroke_Scepter_Buff) == 0x1710);
};
