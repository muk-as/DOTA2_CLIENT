...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float damage_aoe; // 0x17fc            
            float damage; // 0x1800            
            float damage_illusions; // 0x1804            
            std::int32_t damage_threshold; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lina_Overheat) == 0x1810);
    };
};
