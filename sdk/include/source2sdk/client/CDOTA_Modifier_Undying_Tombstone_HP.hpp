...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t tombstone_health; // 0x1888            
            std::int32_t zombie_damage_interval; // 0x188c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Undying_Tombstone_HP because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Undying_Tombstone_HP) == 0x1890);
    };
};
