...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t attack_damage_bonus; // 0x1878            
            std::int32_t attack_damage_reduction; // 0x187c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Rubick_FadeBoltBuff because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Rubick_FadeBoltBuff) == 0x1880);
    };
};
