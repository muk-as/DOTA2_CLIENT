...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_iRangeFX; // 0x1ab0            
            uint8_t _pad1ab4[0x4]; // 0x1ab4
            // metadata: MNetworkEnable
            CUtlSymbolLarge m_szOutpostName; // 0x1ab8            
            // metadata: MNetworkEnable
            CUtlSymbolLarge m_szInteractAbilityName; // 0x1ac0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_BaseNPC_Watch_Tower because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_Watch_Tower) == 0x1ac8);
    };
};
