...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CUtlSymbolLarge m_szOutpostName; // 0x1a78            
            // metadata: MNetworkEnable
            CUtlSymbolLarge m_szInteractAbilityName; // 0x1a80            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_BaseNPC_Watch_Tower because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_Watch_Tower) == 0x1a88);
    };
};
