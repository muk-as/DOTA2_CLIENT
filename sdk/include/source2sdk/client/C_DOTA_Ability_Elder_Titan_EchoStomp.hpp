...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXIndexTitan; // 0x688            
            source2sdk::client::ParticleIndex_t m_nFXIndexSpirit; // 0x68c            
            source2sdk::client::ParticleIndex_t m_nFXIndexTitanB; // 0x690            
            source2sdk::client::ParticleIndex_t m_nFXIndexSpiritB; // 0x694            
            float radius; // 0x698            
            float stomp_damage; // 0x69c            
            float sleep_duration; // 0x6a0            
            float cast_time; // 0x6a4            
            ...
            char m_vecStompedHeroes[0x18]; // 0x6a8            
            ...
            char m_vecStompedHeroes_BuffCounted[0x18]; // 0x6c0            
            bool m_bStompedInvisibleHero; // 0x6d8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Elder_Titan_EchoStomp) == 0x6e0);
    };
};
