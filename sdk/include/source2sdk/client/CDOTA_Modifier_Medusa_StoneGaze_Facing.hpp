...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float stone_duration; // 0x_            
            float duration; // 0x_            
            float vision_cone; // 0x_            
            float m_flAccumulatedTime; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            source2sdk::client::CountdownTimer ctFacing; // 0x_            
            bool m_bAlreadyStoned; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Medusa_StoneGaze_Facing) == 0x_);
    };
};
