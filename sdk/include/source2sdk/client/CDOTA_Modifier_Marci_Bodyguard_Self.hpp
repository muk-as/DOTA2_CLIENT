...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t creep_lifesteal_reduction_pct; // 0x1800            
            std::int32_t shared_healing_percent; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Marci_Bodyguard_Self) == 0x1810);
    };
};
