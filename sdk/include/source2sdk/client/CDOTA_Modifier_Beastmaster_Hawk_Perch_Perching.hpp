...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t perching_tree_height; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Beastmaster_Hawk_Perch_Perching) == 0x1890);
    };
};
