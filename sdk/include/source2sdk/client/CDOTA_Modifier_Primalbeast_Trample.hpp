...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float effect_radius; // 0x1878            
            Vector vLastPos; // 0x187c            
            float flCurrentDistance; // 0x1888            
            std::int32_t step_distance; // 0x188c            
            std::int32_t bonus_magic_resistance; // 0x1890            
            bool m_bIsUnslowable; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Primalbeast_Trample) == 0x18b0);
    };
};
