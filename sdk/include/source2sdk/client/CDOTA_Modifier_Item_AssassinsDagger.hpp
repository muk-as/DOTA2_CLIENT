...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t debuff_duration; // 0x1810            
            std::int32_t bonus_attack_speed; // 0x1814            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_AssassinsDagger because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_AssassinsDagger) == 0x1818);
    };
};
