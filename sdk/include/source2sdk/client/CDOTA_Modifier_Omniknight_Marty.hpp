...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t base_hpregen; // 0x188c            
            std::int32_t strength_bonus; // 0x1890            
            std::int32_t magic_resist; // 0x1894            
            std::int32_t nDebuffAmount; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Omniknight_Marty) == 0x18a0);
    };
};
