...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t consumed_bonus; // 0x17f8            
            std::int32_t consumed_bonus_night_vision; // 0x17fc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Moonshard_Consumed because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Moonshard_Consumed) == 0x1800);
    };
};
