...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Seasonal_Summon_CNY_Balloon_Thinker : public client::CDOTA_Buff
    {
    public:
        float speed; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Seasonal_Summon_CNY_Balloon_Thinker) == 0x1730);
};
