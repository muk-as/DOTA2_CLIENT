...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_pszBasicHitSound) == 0x10);
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_nVictoryDuration) == 0x18);
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_pszHeroNameVO) == 0x20);
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_vecHeroStyles) == 0x28);
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_vecActionDefinitions) == 0x40);
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_HeroPick_HeightOffset) == 0x58);
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_HeroPick_XOffset_Right) == 0x5c);
        static_assert(offsetof(source2sdk::client::CDOTAFightingGameHeroDefinition, m_HeroPick_Angle_Right) == 0x60);
