...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float bonus_damage_duration; // 0x188c            
            float bonus_damage_from_creep; // 0x1890            
            float bonus_damage_from_hero; // 0x1894            
            bool m_bWasHidden; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AbyssalUnderlord_AtrophyAura_Effect) == 0x18a0);
    };
};
