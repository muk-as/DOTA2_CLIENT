...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float bonus_damage_duration; // 0x_            
            float bonus_damage_from_creep; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AbyssalUnderlord_AtrophyAura_Effect) == 0x_);
    };
};
