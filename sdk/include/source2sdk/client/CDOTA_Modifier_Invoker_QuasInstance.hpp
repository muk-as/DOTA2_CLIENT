...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Invoker_QuasInstance : public client::CDOTA_Modifier_Invoker_Instance
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Invoker_QuasInstance) == 0x16f8);
};
