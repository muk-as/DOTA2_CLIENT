...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_bAutoCourierAutoBurst) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_bAutoCourierAutoDeliver) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_bDeliverWhileVisibleOnly) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_hCourier) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_nPlayerID) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_bUseNewLogic) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_eFSMShop) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_hFSMUnit) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_eFSMState) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_bFSMStashAfter) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTACourierController, m_bManualRequest) == 0x_);
        
        static_assert(sizeof(source2sdk::client::CDOTACourierController) == 0x_);
    };
};
