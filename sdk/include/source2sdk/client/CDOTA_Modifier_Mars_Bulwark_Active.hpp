...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nPoseParameterWE; // 0x1894            
            std::int32_t m_nPoseParameterNS; // 0x1898            
            float m_flLastPoseX; // 0x189c            
            float m_flLastPoseY; // 0x18a0            
            std::int32_t m_nLastMaxDirection; // 0x18a4            
            Vector m_vLastOrigin; // 0x18a8            
            source2sdk::entity2::GameTime_t m_flLastGameTime; // 0x18b4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Mars_Bulwark_Active because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Mars_Bulwark_Active) == 0x18b8);
    };
};
