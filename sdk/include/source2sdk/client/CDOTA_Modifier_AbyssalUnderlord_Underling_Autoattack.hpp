...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CHandle<source2sdk::client::C_BaseEntity> m_hBestTarget;
            char m_hBestTarget[0x4]; // 0x17f8            
            float underling_search_radius; // 0x17fc            
            bool m_bRunningToFountain; // 0x1800            
            uint8_t _pad1801[0x3]; // 0x1801
            std::int32_t underling_building_damage_reduction; // 0x1804            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AbyssalUnderlord_Underling_Autoattack) == 0x1808);
    };
};
