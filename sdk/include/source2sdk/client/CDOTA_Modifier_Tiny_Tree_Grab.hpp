...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t attack_count; // 0x17f8            
            std::int32_t bonus_damage; // 0x17fc            
            std::int32_t bonus_damage_buildings; // 0x1800            
            float stun_duration; // 0x1804            
            std::int32_t attack_range; // 0x1808            
            std::int32_t m_nOriginalAttackCapability; // 0x180c            
            float bat_increase; // 0x1810            
            std::int32_t speed_reduction; // 0x1814            
            std::int32_t m_nBonusAttackRange; // 0x1818            
            ...
            char m_hStolenTree[0x4]; // 0x181c            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1820            
            source2sdk::client::ParticleIndex_t m_nFXAttackIndex; // 0x1824            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Tiny_Tree_Grab because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tiny_Tree_Grab) == 0x1828);
    };
};
