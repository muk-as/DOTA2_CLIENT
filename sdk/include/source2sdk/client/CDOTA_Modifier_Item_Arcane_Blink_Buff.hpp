...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t cast_pct_improvement; // 0x17f8            
            std::int32_t manacost_reduction; // 0x17fc            
            std::int32_t debuff_amp; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Arcane_Blink_Buff) == 0x1808);
    };
};
