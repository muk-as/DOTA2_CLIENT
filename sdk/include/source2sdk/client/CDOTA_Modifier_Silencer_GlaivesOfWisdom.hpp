...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float intellect_damage_pct; // 0x17f8            
            ...
            char m_InFlightSilenceAttackRecords[0x18]; // 0x1818            
            source2sdk::client::CDOTA_Buff* m_pAttackCounterBuff; // 0x1830            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Silencer_GlaivesOfWisdom because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Silencer_GlaivesOfWisdom) == 0x1838);
    };
};
