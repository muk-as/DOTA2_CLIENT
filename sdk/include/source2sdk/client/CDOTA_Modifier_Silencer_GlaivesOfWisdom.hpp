...
namespace source2sdk::client
{
    ...
    {
    public:
        float intellect_damage_pct; // 0x1708        
        ...
        char m_InFlightSilenceAttackRecords[0x18]; // 0x1728        
        client::CDOTA_Buff* m_pAttackCounterBuff; // 0x1740        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CDOTA_Modifier_Silencer_GlaivesOfWisdom because it is not a standard-layout class
    static_assert(sizeof(CDOTA_Modifier_Silencer_GlaivesOfWisdom) == 0x1748);
};
