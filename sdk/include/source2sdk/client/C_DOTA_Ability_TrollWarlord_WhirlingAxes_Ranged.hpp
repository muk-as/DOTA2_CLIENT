...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float axe_width; // 0x690            
            float axe_speed; // 0x694            
            float axe_range; // 0x698            
            float axe_spread; // 0x69c            
            std::int32_t axe_count; // 0x6a0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_TrollWarlord_WhirlingAxes_Ranged) == 0x6c0);
    };
};
