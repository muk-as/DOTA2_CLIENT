...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_cast_speed; // 0x_            
            std::int32_t bonus_turn_speed; // 0x_            
            std::int32_t cooldown_acceleration; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_FacelessVoid_TimeZone_Effect) == 0x_);
    };
};
