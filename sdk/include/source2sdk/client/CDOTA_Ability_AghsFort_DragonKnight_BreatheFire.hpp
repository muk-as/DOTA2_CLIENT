...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t start_radius; // 0x5b0            
            std::int32_t end_radius; // 0x5b4            
            Vector m_vStartPos; // 0x5b8            
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x5c4            
            float m_fTotalTime; // 0x5c8            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_AghsFort_DragonKnight_BreatheFire) == 0x5d0);
    };
};
