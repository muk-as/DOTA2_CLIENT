...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hTreeWearable[0x4]; // 0x1d98            
            source2sdk::client::ParticleIndex_t m_nFXIndexScepterAmbient; // 0x1d9c            
