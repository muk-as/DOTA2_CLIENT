...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Orb_Of_Revelations : public client::CDOTA_Buff_Item
    {
    public:
