...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float damage_barrier_base; // 0x188c            
            float damage_barrier_per_level; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Skywrath_Mage_Shield_Barrier) == 0x1898);
    };
};
