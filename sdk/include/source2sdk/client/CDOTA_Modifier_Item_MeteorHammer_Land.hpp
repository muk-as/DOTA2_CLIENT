...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_MeteorHammer_Land : public client::CDOTA_Buff
    {
    public:
        float impact_radius; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_MeteorHammer_Land) == 0x16f8);
};
