...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Ability_StormSpirit_Overload : public source2sdk::client::C_DOTABaseAbility
        {
        public:
            std::int32_t m_iAttackIndex; // 0x680            
