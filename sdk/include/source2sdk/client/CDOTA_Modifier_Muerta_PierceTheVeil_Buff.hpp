...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t modelscale; // 0x_            
            std::int32_t bonus_damage; // 0x_            
            std::int32_t spell_lifesteal; // 0x_            
            ...
            source2sdk::client::ParticleIndex_t m_nScreenFXIndex; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Muerta_PierceTheVeil_Buff) == 0x_);
    };
};
