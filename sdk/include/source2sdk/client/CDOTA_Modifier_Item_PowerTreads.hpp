...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_movement_speed_ranged; // 0x_            
            std::int32_t bonus_movement_speed_melee; // 0x_            
            std::int32_t bonus_attack_speed; // 0x_            
            std::int32_t bonus_stat; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_PowerTreads) == 0x_);
    };
};
