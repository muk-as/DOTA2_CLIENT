...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Item_Miniboss_Minion_Summoner) == 0x_);
    };
};
