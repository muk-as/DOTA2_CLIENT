...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_Lunar_Crest : public source2sdk::client::CDOTA_Buff_Item
        {
        public:
            std::int32_t bonus_health; // 0x17f8            
            std::int32_t movement_speed; // 0x17fc            
            std::int32_t bonus_spell_resist; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Lunar_Crest) == 0x1808);
    };
};
