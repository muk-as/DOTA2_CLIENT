...
namespace source2sdk::client
{
    ...
    {
    public:
        float m_flDamagePerTick; // 0x16e8        
        int32_t m_nCurrentTick; // 0x16ec        
        int32_t m_nTotalTicks; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_QueenOfPain_SonicWave_Damage) == 0x16f8);
};
