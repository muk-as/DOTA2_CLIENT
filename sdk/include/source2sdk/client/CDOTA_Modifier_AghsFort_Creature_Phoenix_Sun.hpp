...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hSecondaryTarget[0x4]; // 0x1700        
        int32_t m_iAttackCount; // 0x1704        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_AghsFort_Creature_Phoenix_Sun) == 0x1708);
};
