...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hSecondaryTarget[0x4]; // 0x18a0            
            std::int32_t m_iAttackCount; // 0x18a4            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_Creature_Phoenix_Sun) == 0x18a8);
    };
};
