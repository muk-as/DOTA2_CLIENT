...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float absorption_pct; // 0x_            
            float damage_per_mana; // 0x_            
            float damage_per_mana_per_level; // 0x_            
            float illusion_percentage; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Medusa_ManaShield) == 0x_);
    };
};
