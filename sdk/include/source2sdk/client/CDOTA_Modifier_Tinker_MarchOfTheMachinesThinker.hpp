...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float collision_radius; // 0x17f8            
            float radius; // 0x17fc            
            float distance; // 0x1800            
            float speed; // 0x1804            
            std::int32_t machines_per_sec; // 0x1808            
            std::int32_t heal_per_second; // 0x180c            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tinker_MarchOfTheMachinesThinker) == 0x1820);
    };
};
