...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hSoulEntityClient[0x4]; // 0x1708        
        int32_t damage_reduction_percent; // 0x170c        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_Muerta_PartingShot_PhysicalBodyDebuff) == 0x1710);
};
