...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Slark_Depth_Shroud : public client::CDOTA_Modifier_Invisible
    {
    public:
        client::ParticleIndex_t m_nFXIndex; // 0x1718        
        int32_t bonus_movement_speed; // 0x171c        
        float bonus_regen; // 0x1720        
    ...
    static_assert(sizeof(CDOTA_Modifier_Slark_Depth_Shroud) == 0x1728);
};
