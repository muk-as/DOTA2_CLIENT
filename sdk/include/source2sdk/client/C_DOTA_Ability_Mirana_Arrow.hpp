...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char hAlreadyHitList[0x30]; // 0x698            
            ...
            char hStarfallList[0x30]; // 0x6c8            
            std::int32_t m_nActiveArrow; // 0x6f8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Mirana_Arrow) == 0x700);
    };
};
