...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CSurvivorsPowerUpDefinition_Spirits : public source2sdk::client::CSurvivorsPowerUpDefinition
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CSurvivorsPowerUpDefinition_Spirits) == 0x860);
    };
};
