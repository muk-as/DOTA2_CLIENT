...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_pszQuestTitle[256]; // 0x560        
        // metadata: MNetworkEnable
        char m_pszQuestText[256]; // 0x660        
        // metadata: MNetworkEnable
        int32_t m_nQuestType; // 0x760        
        // metadata: MNetworkEnable
        ...
        char m_hSubquests[0x20]; // 0x764        
        // metadata: MNetworkEnable
        bool m_bHidden; // 0x784        
        // metadata: MNetworkEnable
        bool m_bCompleted; // 0x785        
        // metadata: MNetworkEnable
        bool m_bWinIfCompleted; // 0x786        
        // metadata: MNetworkEnable
        bool m_bLoseIfCompleted; // 0x787        
        // metadata: MNetworkEnable
        char m_pszGameEndText[256]; // 0x788        
        // metadata: MNetworkEnable
        int32_t m_pnTextReplaceValuesCDotaQuest[4]; // 0x888        
        // metadata: MNetworkEnable
        char m_pszTextReplaceString[64]; // 0x898        
        // metadata: MNetworkEnable
        int32_t m_nTextReplaceValueVersion; // 0x8d8        
        bool m_bWasCompleted; // 0x8dc        
        [[maybe_unused]] std::uint8_t pad_0x8dd[0x3];
    ...
    static_assert(sizeof(C_DotaQuest) == 0x8e0);
};
