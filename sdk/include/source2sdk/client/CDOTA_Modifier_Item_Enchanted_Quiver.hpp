...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Enchanted_Quiver : public client::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_attack_range; // 0x16e8        
        int32_t bonus_damage; // 0x16ec        
        int32_t active_bonus_attack_range; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Enchanted_Quiver) == 0x1710);
};
