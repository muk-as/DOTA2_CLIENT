...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nTPFXIndex; // 0x694            
            source2sdk::client::ParticleIndex_t m_nAoEFXIndex; // 0x698            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Dawnbreaker_Solar_Guardian) == 0x6a0);
    };
};
