...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hTeleportTarget[0x4]; // 0x5b8            
            source2sdk::client::ParticleIndex_t m_nTPFXIndex; // 0x5bc            
            source2sdk::client::ParticleIndex_t m_nAoEFXIndex; // 0x5c0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Dawnbreaker_Solar_Guardian) == 0x5c8);
    };
};
