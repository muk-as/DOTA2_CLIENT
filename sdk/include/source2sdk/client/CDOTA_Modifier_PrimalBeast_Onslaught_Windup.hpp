...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t max_distance; // 0x17f8            
            float max_charge_time; // 0x17fc            
            float turn_rate; // 0x1800            
            float base_power; // 0x1804            
            std::int32_t charge_speed; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PrimalBeast_Onslaught_Windup) == 0x1810);
    };
};
