...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Tidehunter_KrakenShell : public client::CDOTA_Buff
    {
    public:
        int32_t m_iDamageTaken; // 0x16e8        
        int32_t damage_reduction; // 0x16ec        
        int32_t bonus_reduction_per_kill; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Tidehunter_KrakenShell) == 0x16f8);
};
