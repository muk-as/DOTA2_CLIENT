...
namespace source2sdk::client
{
    ...
    {
    public:
        int32_t m_nDamageToHeroes; // 0x16e8        
        int32_t m_nHeroesKilled; // 0x16ec        
        int32_t m_nJumps; // 0x16f0        
        bool m_bFirstJump; // 0x16f4        
