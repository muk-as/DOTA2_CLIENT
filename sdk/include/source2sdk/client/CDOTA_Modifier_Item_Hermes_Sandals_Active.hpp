...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t phase_movement_speed; // 0x17f8            
            std::int32_t phase_movement_speed_range; // 0x17fc            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1800            
            bool m_bWasRooted; // 0x1804            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Hermes_Sandals_Active) == 0x1808);
    };
};
