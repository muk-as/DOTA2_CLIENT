...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t phase_movement_speed; // 0x_            
            std::int32_t phase_movement_speed_range; // 0x_            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x_            
            bool m_bWasRooted; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Hermes_Sandals_Active) == 0x_);
    };
};
