...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float reveal_radius; // 0x1888            
            float increase_health; // 0x188c            
            std::int32_t max_health; // 0x1890            
            float increase_armor; // 0x1894            
            float max_armor; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_ScoutBonuses) == 0x18a0);
    };
};
