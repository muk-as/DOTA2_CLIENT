...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t level; // 0x1878            
            std::int32_t armor; // 0x187c            
            std::int32_t mana; // 0x1880            
            float attack_range; // 0x1884            
            float armor_per_attack; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_ForgedSpirit_Stats) == 0x1890);
    };
};
