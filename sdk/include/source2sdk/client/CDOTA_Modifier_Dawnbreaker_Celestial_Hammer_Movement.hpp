...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t travel_speed_pct; // 0x_            
            std::int32_t m_nMaxRange; // 0x_            
            Vector m_vStartPoint; // 0x_            
            Vector m_vLastTrailThinkerLocation; // 0x_            
            Vector m_vEndPointShard; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Dawnbreaker_Celestial_Hammer_Movement) == 0x_);
    };
};
