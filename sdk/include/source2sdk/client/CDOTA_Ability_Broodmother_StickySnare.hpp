...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float width; // 0x5c0            
            bool m_bStolenSnareCheck; // 0x5c4            
            uint8_t _pad05c5[0x1b]; // 0x5c5
