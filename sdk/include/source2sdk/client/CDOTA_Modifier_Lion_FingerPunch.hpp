...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Lion_FingerPunch : public client::CDOTA_Buff
    {
    public:
        int32_t punch_attack_range; // 0x16e8        
        int32_t punch_bonus_damage_base; // 0x16ec        
        int32_t punch_bonus_damage_per_stack; // 0x16f0        
    ...
    static_assert(sizeof(CDOTA_Modifier_Lion_FingerPunch) == 0x1708);
};
