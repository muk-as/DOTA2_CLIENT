...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            Vector vLeashLocation; // 0x188c            
            bool m_bEscaped; // 0x1898            
            bool m_bFishBait; // 0x1899            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Slark_Pounce_Leash) == 0x18a0);
    };
};
