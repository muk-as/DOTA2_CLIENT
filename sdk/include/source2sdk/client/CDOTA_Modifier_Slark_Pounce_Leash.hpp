...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            Vector vLeashLocation; // 0x17fc            
            bool m_bEscaped; // 0x1808            
            bool m_bFishBait; // 0x1809            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Slark_Pounce_Leash) == 0x1810);
    };
};
