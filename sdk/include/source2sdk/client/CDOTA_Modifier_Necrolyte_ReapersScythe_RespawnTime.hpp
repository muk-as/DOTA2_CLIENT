...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float hp_per_kill; // 0x17f8            
            float mana_per_kill; // 0x17fc            
            float hp_regen; // 0x1800            
            float mp_regen; // 0x1804            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Necrolyte_ReapersScythe_RespawnTime) == 0x1808);
    };
};
