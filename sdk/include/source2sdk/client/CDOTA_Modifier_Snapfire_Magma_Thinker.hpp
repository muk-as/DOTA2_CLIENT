...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t impact_radius; // 0x16ec        
        int32_t move_slow_pct; // 0x16f0        
        float burn_linger_duration; // 0x16f4        
        client::ParticleIndex_t m_nPathEffectIndex; // 0x16f8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Snapfire_Magma_Thinker) == 0x1700);
};
