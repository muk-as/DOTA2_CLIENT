...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float burn_linger_duration; // 0x_            
            source2sdk::client::ParticleIndex_t m_nPathEffectIndex; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Snapfire_Magma_Thinker) == 0x_);
    };
};
