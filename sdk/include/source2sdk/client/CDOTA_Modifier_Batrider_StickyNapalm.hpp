...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float movement_speed_pct; // 0x_            
            std::int32_t turn_rate_pct; // 0x_            
            float damage; // 0x_            
            float application_damage; // 0x_            
            float building_damage_pct; // 0x_            
            float creep_damage_pct; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Batrider_StickyNapalm) == 0x_);
    };
};
