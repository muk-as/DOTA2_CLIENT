...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_LoneDruid_SpiritLink_BearFear : public source2sdk::client::CDOTA_Modifier_Fear
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_LoneDruid_SpiritLink_BearFear) == 0x1880);
    };
};
