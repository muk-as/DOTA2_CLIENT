...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Ability_Disruptor_KineticFence : public client::C_DOTABaseAbility
    {
    public:
        ...
        char m_hSourceAbility[0x4]; // 0x600        
    ...
    static_assert(sizeof(CDOTA_Ability_Disruptor_KineticFence) == 0x608);
};
