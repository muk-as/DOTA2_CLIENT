...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bash_chance; // 0x17f8            
            float bash_damage; // 0x17fc            
            float bash_duration; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lycan_SummonWolves_Bash) == 0x1808);
    };
};
