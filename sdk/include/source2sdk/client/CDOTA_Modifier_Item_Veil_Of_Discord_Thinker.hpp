...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float debuff_radius; // 0x17fc            
            float resist_debuff_duration; // 0x1800            
            std::int32_t m_nHeroesHit; // 0x1804            
            bool m_bHitInvisibleHero; // 0x1808            
            bool m_bFirstPulse; // 0x1809            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Veil_Of_Discord_Thinker) == 0x1810);
    };
};
