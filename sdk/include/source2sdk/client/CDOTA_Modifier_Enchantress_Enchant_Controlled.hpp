...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t enchant_health; // 0x_            
            std::int32_t enchant_armor; // 0x_            
            float enchant_damage; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enchantress_Enchant_Controlled) == 0x_);
    };
};
