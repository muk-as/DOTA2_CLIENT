...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t enchant_health; // 0x187c            
            std::int32_t enchant_armor; // 0x1880            
            float enchant_damage; // 0x1884            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enchantress_Enchant_Controlled) == 0x1890);
    };
};
