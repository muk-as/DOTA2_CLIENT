...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t enchant_health; // 0x170c        
        int32_t enchant_armor; // 0x1710        
        float enchant_damage; // 0x1714        
    ...
    static_assert(sizeof(CDOTA_Modifier_Enchantress_Enchant_Controlled) == 0x1720);
};
