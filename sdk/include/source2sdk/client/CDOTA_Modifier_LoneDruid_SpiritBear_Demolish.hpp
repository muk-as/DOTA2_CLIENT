...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t true_form_bonus_building_damage; // 0x17fc            
            std::int32_t spell_resistance; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_LoneDruid_SpiritBear_Demolish) == 0x1808);
    };
};
