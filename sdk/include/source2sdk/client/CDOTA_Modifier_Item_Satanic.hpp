...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Satanic : public client::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_damage; // 0x16e8        
        int32_t bonus_strength; // 0x16ec        
        int32_t lifesteal_percent; // 0x16f0        
        int32_t unholy_lifesteal_percent; // 0x16f4        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Satanic) == 0x1700);
};
