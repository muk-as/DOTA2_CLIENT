...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t lifesteal_percent; // 0x1880            
            std::int32_t unholy_lifesteal_percent; // 0x1884            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Satanic because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Satanic) == 0x1888);
    };
};
