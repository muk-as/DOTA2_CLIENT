...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Visage_Lurker_Linger : public client::CDOTA_Buff
    {
    public:
        float cooldown_speed_per_stack; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Visage_Lurker_Linger) == 0x16f8);
};
