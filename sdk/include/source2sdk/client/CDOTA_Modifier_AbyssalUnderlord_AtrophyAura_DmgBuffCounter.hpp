...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t cleave_damage_pct; // 0x1888            
            float cleave_starting_width; // 0x188c            
            std::int32_t cleave_angle; // 0x1890            
            float cleave_distance_base; // 0x1894            
            std::int32_t cleave_distance_per_stack; // 0x1898            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AbyssalUnderlord_AtrophyAura_DmgBuffCounter) == 0x18a0);
    };
};
