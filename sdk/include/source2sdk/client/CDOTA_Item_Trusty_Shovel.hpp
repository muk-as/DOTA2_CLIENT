...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            Vector m_vChannelPos; // 0x650            
            bool m_bIsUnderwater; // 0x65c            
            uint8_t _pad065d[0x3]; // 0x65d
            source2sdk::client::ParticleIndex_t m_nPhaseStartFXIndex; // 0x660            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Item_Trusty_Shovel) == 0x668);
    };
};
