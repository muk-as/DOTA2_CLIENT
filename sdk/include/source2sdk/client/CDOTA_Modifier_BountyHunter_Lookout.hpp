...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_BountyHunter_Lookout : public source2sdk::client::CDOTA_Modifier_Invisible
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_BountyHunter_Lookout) == 0x1890);
    };
};
