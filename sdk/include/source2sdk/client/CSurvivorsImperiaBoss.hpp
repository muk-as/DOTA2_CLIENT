...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x338[0x8c]; // 0x338
        ...
        int32_t m_nBurningGroundInstancesPerEnrageLevel; // 0x3e0        
        [[maybe_unused]] std::uint8_t pad_0x3e4[0x4]; // 0x3e4
        ...
        particleslib::CNewParticleEffect* m_pRadiateRaysBuffParticle; // 0x868        
        ...
        int32_t m_nMaxDemonPortalCount; // 0xa38        
        ...
        int32_t m_nNumMagicMissiles; // 0xa70        
    ...
    static_assert(sizeof(CSurvivorsImperiaBoss) == 0xd50);
};
