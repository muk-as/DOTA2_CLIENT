...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float base_damage; // 0x1888            
            float attack_factor; // 0x188c            
            float power_reduction; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PhantomAssassin_StiflingDagger_Caster) == 0x1898);
    };
};
