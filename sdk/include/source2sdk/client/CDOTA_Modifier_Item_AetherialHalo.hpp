...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_AetherialHalo : public client::CDOTA_Buff_Item
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_AetherialHalo) == 0x1708);
};
