...
namespace source2sdk::client
{
    ...
    {
    public:
        particleslib::CNewParticleEffect* m_pVisionRangeFX; // 0x16e8        
        int32_t vision_radius; // 0x16f0        
        bool m_bHasBeenMagnetized; // 0x16f4        
    ...
    static_assert(sizeof(CDOTA_Modifier_EarthSpirit_StoneThinker) == 0x1700);
};
