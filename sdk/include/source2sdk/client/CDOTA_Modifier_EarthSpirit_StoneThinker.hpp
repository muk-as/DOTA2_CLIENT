...
namespace source2sdk::client
{
    ...
    {
    public:
        particleslib::CNewParticleEffect* m_pVisionRangeFX; // 0x1708        
        int32_t vision_radius; // 0x1710        
        bool m_bHasBeenMagnetized; // 0x1714        
    ...
    static_assert(sizeof(CDOTA_Modifier_EarthSpirit_StoneThinker) == 0x1720);
};
