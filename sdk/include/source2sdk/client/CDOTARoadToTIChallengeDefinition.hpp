...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecQuestPattern[0x_]; // 0x_            
            // metadata: MPropertyDescription "Item def for Culling Blade item"
            source2sdk::client::item_definition_index_t m_unCullingBladeItemDef; // 0x_            
            // metadata: MPropertyDescription "Item def for Reroll Token item"
            source2sdk::client::item_definition_index_t m_unRerollItemDef; // 0x_            
        ...
        static_assert(offsetof(source2sdk::client::CDOTARoadToTIChallengeDefinition, m_eEvent) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTARoadToTIChallengeDefinition, m_unTotalQuestPeriods) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTARoadToTIChallengeDefinition, m_unHeroesPerQuest) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTARoadToTIChallengeDefinition, m_vecQuestPattern) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTARoadToTIChallengeDefinition, m_unCullingBladeItemDef) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTARoadToTIChallengeDefinition, m_unRerollItemDef) == 0x_);
        static_assert(offsetof(source2sdk::client::CDOTARoadToTIChallengeDefinition, m_vecQuests) == 0x_);
        
        static_assert(sizeof(source2sdk::client::CDOTARoadToTIChallengeDefinition) == 0x_);
    };
};
