...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float attrib_bonus; // 0x17fc            
            float hurt_attrib_bonus; // 0x1800            
            float hurt_percent; // 0x1804            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Huskar_Inner_Vitality because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Huskar_Inner_Vitality) == 0x1808);
    };
};
