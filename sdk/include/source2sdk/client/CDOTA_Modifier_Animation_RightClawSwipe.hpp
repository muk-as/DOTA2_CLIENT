...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Animation_RightClawSwipe : public source2sdk::client::CDOTA_Buff
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Animation_RightClawSwipe) == 0x18b0);
    };
};
