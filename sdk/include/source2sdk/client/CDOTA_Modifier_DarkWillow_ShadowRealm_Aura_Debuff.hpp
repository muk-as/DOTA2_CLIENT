...
namespace source2sdk::client
{
    ...
    {
    public:
        float max_damage_duration; // 0x1708        
        float aura_damage_pct; // 0x170c        
        float m_flDamageScale; // 0x1710        
    ...
    static_assert(sizeof(CDOTA_Modifier_DarkWillow_ShadowRealm_Aura_Debuff) == 0x1718);
};
