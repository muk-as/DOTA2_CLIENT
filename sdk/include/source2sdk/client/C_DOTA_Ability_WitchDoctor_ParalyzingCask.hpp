...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iBounces; // 0x688            
            std::int32_t bounces; // 0x68c            
            std::int32_t bounce_bonus_damage; // 0x690            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_WitchDoctor_ParalyzingCask) == 0x698);
    };
};
