...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iBounces; // 0x5b0            
            std::int32_t bounces; // 0x5b4            
            std::int32_t bounce_bonus_damage; // 0x5b8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_WitchDoctor_ParalyzingCask) == 0x5c0);
    };
};
