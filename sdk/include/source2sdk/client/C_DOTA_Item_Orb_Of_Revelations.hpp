...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::CountdownTimer m_ViewerTimer; // 0x650            
            std::int32_t m_iProjectile; // 0x668            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Item_Orb_Of_Revelations) == 0x670);
    };
};
