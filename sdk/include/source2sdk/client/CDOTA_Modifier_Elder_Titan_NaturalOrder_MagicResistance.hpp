...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t magic_resistance_pct; // 0x_            
            float magic_resistance_per_tick; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Elder_Titan_NaturalOrder_MagicResistance) == 0x_);
    };
};
