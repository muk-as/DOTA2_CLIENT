...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t shard_dps; // 0x1878            
            std::int32_t shard_move_slow_pct; // 0x187c            
            float shard_interval; // 0x1880            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Special_Mars_Spear_Burning_Trail_Burn) == 0x1888);
    };
};
