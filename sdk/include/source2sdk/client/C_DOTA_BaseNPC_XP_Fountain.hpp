...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFxRing; // 0x1a88            
            bool m_bActive; // 0x1a8c            
            bool m_bIsBeingGranted; // 0x1a8d            
            bool m_bWasBeingGranted; // 0x1a8e            
            uint8_t _pad1a8f[0x1]; // 0x1a8f
            std::int32_t m_nIntervals; // 0x1a90            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_XP_Fountain) == 0x1a98);
    };
};
