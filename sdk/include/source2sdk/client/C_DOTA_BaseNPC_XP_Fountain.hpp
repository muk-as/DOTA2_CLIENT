...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFxRing; // 0x_            
            bool m_bActive; // 0x_            
            bool m_bIsBeingGranted; // 0x_            
            bool m_bWasBeingGranted; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_BaseNPC_XP_Fountain) == 0x_);
    };
};
