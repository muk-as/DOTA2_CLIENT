...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class DOTAKeybindCommand_t : std::uint32_t
        {
            ...
            DOTA_KEYBIND_TOGGLE_BUYBACK_PROTECTION = 0x93,
            DOTA_KEYBIND_GRAB_STASH_ITEMS = 0x94,
            DOTA_KEYBIND_TOGGLE_AUTOATTACK = 0x95,
            DOTA_KEYBIND_TOGGLE_OVERLAYMAP = 0x96,
            DOTA_KEYBIND_OVERLAYMAP_INPUTKEY = 0x97,
            DOTA_KEYBIND_FILTER_ENEMY = 0x98,
            DOTA_KEYBIND_FILTER_ALLY = 0x99,
            DOTA_KEYBIND_FILTER_HERO = 0x9a,
            DOTA_KEYBIND_FILTER_NONHERO = 0x9b,
            DOTA_KEYBIND_TAUNT = 0x9c,
            DOTA_KEYBIND_SHOP_CONSUMABLES = 0x9d,
            DOTA_KEYBIND_SHOP_ATTRIBUTES = 0x9e,
            DOTA_KEYBIND_SHOP_ARMAMENTS = 0x9f,
            DOTA_KEYBIND_SHOP_ARCANE = 0xa0,
            DOTA_KEYBIND_SHOP_BASICS = 0xa1,
            DOTA_KEYBIND_SHOP_SUPPORT = 0xa2,
            DOTA_KEYBIND_SHOP_CASTER = 0xa3,
            DOTA_KEYBIND_SHOP_WEAPONS = 0xa4,
            DOTA_KEYBIND_SHOP_ARMOR = 0xa5,
            DOTA_KEYBIND_SHOP_ARTIFACTS = 0xa6,
            DOTA_KEYBIND_SHOP_SIDE_PAGE_1 = 0xa7,
            DOTA_KEYBIND_SHOP_SIDE_PAGE_2 = 0xa8,
            DOTA_KEYBIND_SHOP_SECRET = 0xa9,
            DOTA_KEYBIND_SHOP_SEARCHBOX = 0xaa,
            DOTA_KEYBIND_SHOP_SLOT_1 = 0xab,
            DOTA_KEYBIND_SHOP_SLOT_2 = 0xac,
            DOTA_KEYBIND_SHOP_SLOT_3 = 0xad,
            DOTA_KEYBIND_SHOP_SLOT_4 = 0xae,
            DOTA_KEYBIND_SHOP_SLOT_5 = 0xaf,
            DOTA_KEYBIND_SHOP_SLOT_6 = 0xb0,
            DOTA_KEYBIND_SHOP_SLOT_7 = 0xb1,
            DOTA_KEYBIND_SHOP_SLOT_8 = 0xb2,
            DOTA_KEYBIND_SHOP_SLOT_9 = 0xb3,
            DOTA_KEYBIND_SHOP_SLOT_10 = 0xb4,
            DOTA_KEYBIND_SHOP_SLOT_11 = 0xb5,
            DOTA_KEYBIND_SHOP_SLOT_12 = 0xb6,
            DOTA_KEYBIND_SHOP_SLOT_13 = 0xb7,
            DOTA_KEYBIND_SHOP_SLOT_14 = 0xb8,
            DOTA_KEYBIND_SPEC_CAMERA_UP = 0xb9,
            DOTA_KEYBIND_SPEC_CAMERA_DOWN = 0xba,
            DOTA_KEYBIND_SPEC_CAMERA_LEFT = 0xbb,
            DOTA_KEYBIND_SPEC_CAMERA_RIGHT = 0xbc,
            DOTA_KEYBIND_SPEC_CAMERA_GRIP = 0xbd,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_1 = 0xbe,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_2 = 0xbf,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_3 = 0xc0,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_4 = 0xc1,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_5 = 0xc2,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_6 = 0xc3,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_7 = 0xc4,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_8 = 0xc5,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_9 = 0xc6,
            DOTA_KEYBIND_SPEC_CAMERA_SAVED_POSITION_10 = 0xc7,
            DOTA_KEYBIND_SPEC_UNIT_SELECT = 0xc8,
            DOTA_KEYBIND_SPEC_HERO_SELECT = 0xc9,
            DOTA_KEYBIND_SPEC_PAUSE = 0xca,
            DOTA_KEYBIND_SPEC_CHAT = 0xcb,
            DOTA_KEYBIND_SPEC_SCOREBOARD = 0xcc,
            DOTA_KEYBIND_SPEC_INCREASE_REPLAY_SPEED = 0xcd,
            DOTA_KEYBIND_SPEC_DECREASE_REPLAY_SPEED = 0xce,
            DOTA_KEYBIND_SPEC_STATS_ITEM = 0xcf,
            DOTA_KEYBIND_SPEC_STATS_GOLD = 0xd0,
            DOTA_KEYBIND_SPEC_STATS_XP = 0xd1,
            DOTA_KEYBIND_SPEC_STATS_FANTASY = 0xd2,
            DOTA_KEYBIND_SPEC_STATS_WINCHANCE = 0xd3,
            DOTA_KEYBIND_SPEC_FOW_TOGGLEBOTH = 0xd4,
            DOTA_KEYBIND_SPEC_FOW_TOGGLERADIENT = 0xd5,
            DOTA_KEYBIND_SPEC_FOW_TOGGLEDIRE = 0xd6,
            DOTA_KEYBIND_SPEC_OPEN_BROADCASTER_MENU = 0xd7,
            DOTA_KEYBIND_SPEC_DROPDOWN_KDA = 0xd8,
            DOTA_KEYBIND_SPEC_DROPDOWN_LASTHITS_DENIES = 0xd9,
            DOTA_KEYBIND_SPEC_DROPDOWN_LEVEL = 0xda,
            DOTA_KEYBIND_SPEC_DROPDOWN_HEROFACET = 0xdb,
            DOTA_KEYBIND_SPEC_DROPDOWN_XP_PER_MIN = 0xdc,
            DOTA_KEYBIND_SPEC_DROPDOWN_GOLD = 0xdd,
            DOTA_KEYBIND_SPEC_DROPDOWN_TOTALGOLD = 0xde,
            DOTA_KEYBIND_SPEC_DROPDOWN_GOLD_PER_MIN = 0xdf,
            DOTA_KEYBIND_SPEC_DROPDOWN_BUYBACK = 0xe0,
            DOTA_KEYBIND_SPEC_DROPDOWN_NETWORTH = 0xe1,
            DOTA_KEYBIND_SPEC_DROPDOWN_FANTASY = 0xe2,
            DOTA_KEYBIND_SPEC_DROPDOWN_SORT = 0xe3,
            DOTA_KEYBIND_SPEC_DROPDOWN_CLOSE = 0xe4,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_1 = 0xe5,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_2 = 0xe6,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_3 = 0xe7,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_4 = 0xe8,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_5 = 0xe9,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_6 = 0xea,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_7 = 0xeb,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_8 = 0xec,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_9 = 0xed,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_10 = 0xee,
            DOTA_KEYBIND_SPEC_COACH_VIEWTOGGLE = 0xef,
            DOTA_KEYBIND_INSPECTHEROINWORLD = 0xf0,
            DOTA_KEYBIND_CAMERA_ZOOM_IN = 0xf1,
            DOTA_KEYBIND_CAMERA_ZOOM_OUT = 0xf2,
            DOTA_KEYBIND_CONTROL_GROUPCYCLEPREV = 0xf3,
            DOTA_KEYBIND_DOTA_ALT = 0xf4,
            DOTA_KEYBIND_DOTA_ALTERNATIVE_CAST_SWITCH = 0xf5,
            DOTA_KEYBIND_COUNT = 0xf6,
        };
    };
};
