...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class DOTAKeybindCommand_t : std::uint32_t
        {
            ...
            DOTA_KEYBIND_SPEC_DROPDOWN_HEROFACET = 0xe0,
            DOTA_KEYBIND_SPEC_DROPDOWN_XP_PER_MIN = 0xe1,
            DOTA_KEYBIND_SPEC_DROPDOWN_GOLD = 0xe2,
            DOTA_KEYBIND_SPEC_DROPDOWN_TOTALGOLD = 0xe3,
            DOTA_KEYBIND_SPEC_DROPDOWN_GOLD_PER_MIN = 0xe4,
            DOTA_KEYBIND_SPEC_DROPDOWN_BUYBACK = 0xe5,
            DOTA_KEYBIND_SPEC_DROPDOWN_NETWORTH = 0xe6,
            DOTA_KEYBIND_SPEC_DROPDOWN_FANTASY = 0xe7,
            DOTA_KEYBIND_SPEC_DROPDOWN_SORT = 0xe8,
            DOTA_KEYBIND_SPEC_DROPDOWN_CLOSE = 0xe9,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_1 = 0xea,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_2 = 0xeb,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_3 = 0xec,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_4 = 0xed,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_5 = 0xee,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_6 = 0xef,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_7 = 0xf0,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_8 = 0xf1,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_9 = 0xf2,
            DOTA_KEYBIND_SPEC_FOCUS_PLAYER_10 = 0xf3,
            DOTA_KEYBIND_SPEC_COACH_VIEWTOGGLE = 0xf4,
            DOTA_KEYBIND_INSPECTHEROINWORLD = 0xf5,
            DOTA_KEYBIND_CAMERA_ZOOM_IN = 0xf6,
            DOTA_KEYBIND_CAMERA_ZOOM_OUT = 0xf7,
            DOTA_KEYBIND_CONTROL_GROUPCYCLEPREV = 0xf8,
            DOTA_KEYBIND_DOTA_ALT = 0xf9,
            DOTA_KEYBIND_DOTA_ALTERNATIVE_CAST_SWITCH = 0xfa,
            DOTA_KEYBIND_COUNT = 0xfb,
        };
    };
};
