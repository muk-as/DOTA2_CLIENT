...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t damage_pct; // 0x18a4            
            bool m_bHitFirstUpdate; // 0x18a8            
            uint8_t _pad18a9[0x3]; // 0x18a9
            source2sdk::entity2::GameTime_t m_flHitEndTime; // 0x18ac            
            float hit_recover_time; // 0x18b0            
            source2sdk::entity2::GameTime_t m_flJumpEndTime; // 0x18b4            
            float jump_recover_time; // 0x18b8            
            float m_flTurnBoostProgress; // 0x18bc            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Pangolier_Gyroshell) == 0x1930);
    };
};
