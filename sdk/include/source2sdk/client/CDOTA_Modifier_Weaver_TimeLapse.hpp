...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            Vector m_PositionIndex[11]; // 0x_            
            float m_flLife[11]; // 0x_            
            float m_flMana[11]; // 0x_            
            bool m_bHasValidHistory; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Weaver_TimeLapse) == 0x_);
    };
};
