...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t ability_bonus_level; // 0x_            
            ...
            char m_vecAbilityDraftStolenAbilities[0x_]; // 0x_            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Ability_DoomBringer_Devour because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_DoomBringer_Devour) == 0x_);
    };
};
