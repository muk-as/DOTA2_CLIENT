...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float great_cleave_damage; // 0x_            
            std::int32_t strength_bonus; // 0x_            
            std::int16_t m_nLastCleaveRecord; // 0x_            
            uint8_t _pad_[0x_]; // 0x_
            std::int32_t m_nLastCleaveKills; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Sven_GreatCleave) == 0x_);
    };
};
