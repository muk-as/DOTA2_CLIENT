...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFXIndexAoE; // 0x188c            
            float effect_radius; // 0x1890            
            bool bActive; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Muerta_Ofrenda_Invulnerable) == 0x1898);
    };
};
