...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class C_DOTA_Ability_Lion_ManaDrain : public source2sdk::client::C_DOTABaseAbility
        {
        public:
