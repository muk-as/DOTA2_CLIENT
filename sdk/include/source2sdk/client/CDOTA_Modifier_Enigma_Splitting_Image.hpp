...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t damage_threshold; // 0x188c            
            float damage_reset_interval; // 0x1890            
            std::int32_t eidolon_spawns; // 0x1894            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enigma_Splitting_Image) == 0x18a0);
    };
};
