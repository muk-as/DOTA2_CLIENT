...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t eidolon_spawns; // 0x1884            
            std::int32_t m_nEidolonSpawnNum; // 0x1888            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enigma_Splitting_Image) == 0x1890);
    };
};
