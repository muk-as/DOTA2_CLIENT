...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Aghsfort_Reward_ArmorAura_Bonus : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Aghsfort_Reward_ArmorAura_Bonus) == 0x16f0);
};
