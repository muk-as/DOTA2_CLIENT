...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float decay_to_zero_seconds; // 0x1878            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Miniboss_Minion_Deflecting_Shield_Aura) == 0x1888);
    };
};
