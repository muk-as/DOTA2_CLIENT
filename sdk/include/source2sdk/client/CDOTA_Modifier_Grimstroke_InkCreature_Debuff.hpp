...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flCurrentArmorReduction; // 0x1878            
            ...
            char m_hLatchedCreature[0x4]; // 0x187c            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Grimstroke_InkCreature_Debuff) == 0x1888);
    };
};
