...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_ExplosiveBarrel) == 0x1898);
    };
};
