...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x1b8c[0x4]; // 0x1b8c
        CUtlString m_szResponseCriteria; // 0x1b90        
        // metadata: MNetworkEnable
        uint32_t m_nArcanaColor; // 0x1b98        
    ...
    static_assert(sizeof(C_DOTA_Unit_Hero_Terrorblade) == 0x1ba0);
};
