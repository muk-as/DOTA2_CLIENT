...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Chaos_Knight_Illusions_Damage_Reduction_Aura : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Chaos_Knight_Illusions_Damage_Reduction_Aura) == 0x16f0);
};
