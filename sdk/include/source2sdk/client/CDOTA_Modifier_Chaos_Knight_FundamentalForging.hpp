...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t trinket_options_current; // 0x1888            
            std::int32_t trinket_options_next; // 0x188c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Chaos_Knight_FundamentalForging) == 0x1890);
    };
};
