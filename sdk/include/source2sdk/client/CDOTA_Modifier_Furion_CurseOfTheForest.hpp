...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t damage_per_tree; // 0x17f8            
            std::int32_t slow_per_tree; // 0x17fc            
            std::int32_t m_nSlow; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Furion_CurseOfTheForest) == 0x1808);
    };
};
