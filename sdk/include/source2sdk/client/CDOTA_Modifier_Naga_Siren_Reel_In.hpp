...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float pull_strength; // 0x17f8            
            std::int32_t min_pull_distance; // 0x17fc            
            source2sdk::entity2::GameTime_t m_flLastThinkTime; // 0x1800            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Naga_Siren_Reel_In) == 0x1808);
    };
};
