...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Tenderizer_Weaken : public client::CDOTA_Modifier_Stacking_Base
    {
    public:
        int32_t weaken_per_hit; // 0x16e8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Tenderizer_Weaken) == 0x16f0);
};
