...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            bool m_bUntargetableAllies; // 0x17f8            
            bool m_bUntargetableEnemies; // 0x17f9            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Book_Of_Shadows_Buff) == 0x1800);
    };
};
