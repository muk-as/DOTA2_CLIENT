...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            bool m_bUntargetableAllies; // 0x1888            
            bool m_bUntargetableEnemies; // 0x1889            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Book_Of_Shadows_Buff) == 0x1890);
    };
};
