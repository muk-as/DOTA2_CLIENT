...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::TrackedStatNetworkData_t, unStatID) == 0x_);
        static_assert(offsetof(source2sdk::client::TrackedStatNetworkData_t, unStatValue) == 0x_);
        
        static_assert(sizeof(source2sdk::client::TrackedStatNetworkData_t) == 0x_);
    };
};
