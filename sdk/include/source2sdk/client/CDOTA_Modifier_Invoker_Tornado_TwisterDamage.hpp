...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t twister_damage; // 0x1878            
            float twister_tick_rate; // 0x187c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_Tornado_TwisterDamage) == 0x1880);
    };
};
