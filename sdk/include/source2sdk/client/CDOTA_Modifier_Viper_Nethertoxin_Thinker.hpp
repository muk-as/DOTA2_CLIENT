...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float radius_increase; // 0x1888            
            float m_flCurrentRadius; // 0x188c            
            ...
            char m_vParticleList[0x18]; // 0x1890            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Viper_Nethertoxin_Thinker because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Viper_Nethertoxin_Thinker) == 0x18a8);
    };
};
