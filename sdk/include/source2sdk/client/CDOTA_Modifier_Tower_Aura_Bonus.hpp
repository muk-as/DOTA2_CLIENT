...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bOverrideArmor; // 0x1880            
            bool m_bOverrideRegen; // 0x1881            
            bool m_bSentFirstRefresh; // 0x1882            
            uint8_t _pad1883[0x5];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Tower_Aura_Bonus because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tower_Aura_Bonus) == 0x1888);
    };
};
