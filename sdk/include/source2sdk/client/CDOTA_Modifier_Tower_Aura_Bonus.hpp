...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float hp_regen; // 0x_            
            bool m_bOverrideArmor; // 0x_            
            bool m_bOverrideRegen; // 0x_            
            bool m_bSentFirstRefresh; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tower_Aura_Bonus) == 0x_);
    };
};
