...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Obsidian_Destroyer_Equilibrium_Debuff : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_Obsidian_Destroyer_Equilibrium_Debuff) == 0x16f0);
};
