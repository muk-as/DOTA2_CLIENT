...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float shrapnel_damage; // 0x17fc            
            std::int32_t fast_tick; // 0x1800            
            std::int32_t m_nTracker; // 0x1804            
            bool bFirst; // 0x1808            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Sniper_Shrapnel_Slow) == 0x1810);
    };
};
