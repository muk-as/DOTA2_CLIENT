...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t toss_damage_bonus_pct; // 0x1820            
            std::int32_t m_damage; // 0x1824            
            std::int32_t m_nTicks; // 0x1828            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tiny_Avalanche) == 0x1830);
    };
};
