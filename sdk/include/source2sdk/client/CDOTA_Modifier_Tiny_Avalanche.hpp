...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_pHeroesHit[0x_]; // 0x_            
            float radius; // 0x_            
            float total_duration; // 0x_            
            float stun_duration; // 0x_            
            std::int32_t tick_count; // 0x_            
            std::int32_t toss_damage_bonus_pct; // 0x_            
            std::int32_t m_damage; // 0x_            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tiny_Avalanche) == 0x_);
    };
};
