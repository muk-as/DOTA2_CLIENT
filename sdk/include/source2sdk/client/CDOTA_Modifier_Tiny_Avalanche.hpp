...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t toss_damage_bonus_pct; // 0x18a0            
            std::int32_t m_damage; // 0x18a4            
            std::int32_t m_nTicks; // 0x18a8            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tiny_Avalanche) == 0x18b0);
    };
};
