...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_PolarFurbolgUrsaWarrior_ThunderClap : public client::CDOTA_Buff
    {
    public:
    ...
    static_assert(sizeof(CDOTA_Modifier_PolarFurbolgUrsaWarrior_ThunderClap) == 0x16f0);
};
