...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float health_restoration; // 0x1888            
            float bat_reduce; // 0x188c            
            float intelligence_pct; // 0x1890            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Enhancement_Crude) == 0x1898);
    };
};
