...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float health_restoration; // 0x_            
            float bat_reduce; // 0x_            
            float intelligence_pct; // 0x_            
            uint8_t _pad_[0x_];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Enhancement_Crude) == 0x_);
    };
};
