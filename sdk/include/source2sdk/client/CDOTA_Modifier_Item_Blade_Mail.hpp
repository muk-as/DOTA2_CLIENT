...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CDOTA_Modifier_Item_Blade_Mail : public client::CDOTA_Buff_Item
    {
    public:
        int32_t bonus_damage; // 0x16e8        
        int32_t bonus_armor; // 0x16ec        
        int32_t bonus_intellect; // 0x16f0        
        int32_t passive_reflection_constant; // 0x16f4        
        int32_t passive_reflection_pct; // 0x16f8        
    ...
    static_assert(sizeof(CDOTA_Modifier_Item_Blade_Mail) == 0x1700);
};
