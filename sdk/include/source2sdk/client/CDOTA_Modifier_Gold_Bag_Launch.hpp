...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CDOTA_Modifier_Gold_Bag_Launch : public client::CDOTA_Modifier_Knockback
    {
    public:
        int32_t gold_amount; // 0x1738        
    ...
    static_assert(sizeof(CDOTA_Modifier_Gold_Bag_Launch) == 0x1740);
};
