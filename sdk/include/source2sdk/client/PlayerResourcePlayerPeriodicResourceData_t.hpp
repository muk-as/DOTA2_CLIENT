...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::PlayerResourcePlayerPeriodicResourceData_t, m_unPeriodicResourceID) == 0x_);
        static_assert(offsetof(source2sdk::client::PlayerResourcePlayerPeriodicResourceData_t, m_unPeriodicResourceMax) == 0x_);
        static_assert(offsetof(source2sdk::client::PlayerResourcePlayerPeriodicResourceData_t, m_unPeriodicResourceRemaining) == 0x_);
        
        static_assert(sizeof(source2sdk::client::PlayerResourcePlayerPeriodicResourceData_t) == 0x_);
    };
};
