...
namespace source2sdk::client
{
    ...
    public:
        ...
        int32_t is_green_dragon; // 0x170c        
        int32_t is_red_dragon; // 0x1710        
        int32_t is_blue_dragon; // 0x1714        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CDOTA_Modifier_DragonKnight_DragonBlood_Aura) == 0x1718);
};
